...
class WebhookEventAttributes(BaseModel):
    ...
    """ # noqa: E501
    event_type: Optional[WebhookEventType] = Field(default=None, alias="eventType")
    payload: Optional[StrictStr] = None
    ping: Optional[StrictBool] = None
    created_date: Optional[datetime] = Field(default=None, alias="createdDate")
    __properties: ClassVar[List[str]] = ["eventType", "payload", "ping", "createdDate"]
