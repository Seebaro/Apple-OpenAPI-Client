...
class InAppPurchasePriceSchedule(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    relationships: Optional[InAppPurchasePriceScheduleRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "relationships": InAppPurchasePriceScheduleRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
