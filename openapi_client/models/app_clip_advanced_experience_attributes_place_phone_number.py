...
class AppClipAdvancedExperienceAttributesPlacePhoneNumber(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["number", "type", "intent"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['FAX', 'LANDLINE', 'MOBILE', 'TOLLFREE']):
            raise ValueError("must be one of enum values ('FAX', 'LANDLINE', 'MOBILE', 'TOLLFREE')")
        return value
