...
class CiScheduledStartCondition(BaseModel):
    ...
    schedule: Optional[CiScheduledStartConditionSchedule] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedule": CiScheduledStartConditionSchedule.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None
        })
        return _obj
