...
class GameCenterAchievementReleasesResponse(BaseModel):
    ...
    included: Optional[List[GameCenterAchievementReleasesResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GameCenterAchievementRelease.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [GameCenterAchievementReleasesResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
