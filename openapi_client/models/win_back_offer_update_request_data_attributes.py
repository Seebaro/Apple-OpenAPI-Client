...
class WinBackOfferUpdateRequestDataAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["customerEligibilityPaidSubscriptionDurationInMonths", "customerEligibilityTimeSinceLastSubscribedInMonths", "customerEligibilityWaitBetweenOffersInMonths", "startDate", "endDate", "priority", "promotionIntent"]
