...
class BuildBundle(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[BuildBundleAttributes] = None
    relationships: Optional[BuildBundleRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['buildBundles']):
            raise ValueError("must be one of enum values ('buildBundles')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": BuildBundleAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": BuildBundleRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
