...
class DeviceFamilyOsVersionFilter(BaseModel):
    ...
    minimum_os_inclusive: Optional[StrictStr] = Field(default=None, alias="minimumOsInclusive")
    maximum_os_inclusive: Optional[StrictStr] = Field(default=None, alias="maximumOsInclusive")
    __properties: ClassVar[List[str]] = ["deviceFamily", "minimumOsInclusive", "maximumOsInclusive"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minimumOsInclusive": obj.get("minimumOsInclusive"),
            "maximumOsInclusive": obj.get("maximumOsInclusive")
        })
        return _obj
