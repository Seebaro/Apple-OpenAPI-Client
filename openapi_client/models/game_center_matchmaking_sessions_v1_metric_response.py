...
class GameCenterMatchmakingSessionsV1MetricResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[GameCenterMatchmakingSessionsV1MetricResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GameCenterMatchmakingSessionsV1MetricResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
