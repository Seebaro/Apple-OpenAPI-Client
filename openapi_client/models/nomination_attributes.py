...
class NominationAttributes(BaseModel):
    """
    ...
    publish_start_date: Optional[datetime] = Field(default=None, alias="publishStartDate")
    ...
    __properties: ClassVar[List[str]] = ["name", "type", "description", "createdDate", "lastModifiedDate", "submittedDate", "state", "publishStartDate", "publishEndDate", "deviceFamilies", "locales", "supplementalMaterialsUris", "hasInAppEvents", "launchInSelectMarketsFirst", "notes", "preOrderEnabled"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['DRAFT', 'SUBMITTED', 'ARCHIVED']):
            raise ValueError("must be one of enum values ('DRAFT', 'SUBMITTED', 'ARCHIVED')")
        return value
