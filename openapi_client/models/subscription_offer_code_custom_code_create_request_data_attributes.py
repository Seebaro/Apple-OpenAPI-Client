...
class SubscriptionOfferCodeCustomCodeCreateRequestDataAttributes(BaseModel):
    """
    SubscriptionOfferCodeCustomCodeCreateRequestDataAttributes
    """ # noqa: E501
    custom_code: StrictStr = Field(alias="customCode")
    number_of_codes: StrictInt = Field(alias="numberOfCodes")
    expiration_date: Optional[date] = Field(default=None, alias="expirationDate")
    __properties: ClassVar[List[str]] = ["customCode", "numberOfCodes", "expirationDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "numberOfCodes": obj.get("numberOfCodes"),
