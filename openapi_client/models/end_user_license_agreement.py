...
class EndUserLicenseAgreement(BaseModel):
    ...
    relationships: Optional[EndUserLicenseAgreementRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": EndUserLicenseAgreementRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
