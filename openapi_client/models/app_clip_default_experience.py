...
class AppClipDefaultExperience(BaseModel):
    ...
    relationships: Optional[AppClipDefaultExperienceRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": AppClipDefaultExperienceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
