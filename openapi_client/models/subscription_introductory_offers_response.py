...
class SubscriptionIntroductoryOffersResponse(BaseModel):
    ...
    included: Optional[List[SubscriptionIntroductoryOffersResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SubscriptionIntroductoryOffer.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [SubscriptionIntroductoryOffersResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
