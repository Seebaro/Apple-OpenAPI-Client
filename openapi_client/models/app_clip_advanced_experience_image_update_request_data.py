...
class AppClipAdvancedExperienceImageUpdateRequestData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['appClipAdvancedExperienceImages']):
            raise ValueError("must be one of enum values ('appClipAdvancedExperienceImages')")
        return value
