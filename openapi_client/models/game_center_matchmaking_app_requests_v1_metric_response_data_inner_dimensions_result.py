...
class GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDimensionsResult(BaseModel):
    """
    GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDimensionsResult
    """ # noqa: E501
    links: Optional[GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDimensionsResultLinks] = None
    ...
    def data_validate_enum(cls, value):
        ...
        if value not in set(['MATCHED', 'CANCELED', 'EXPIRED']):
            raise ValueError("must be one of enum values ('MATCHED', 'CANCELED', 'EXPIRED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDimensionsResultLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "data": obj.get("data")
        })
        return _obj
