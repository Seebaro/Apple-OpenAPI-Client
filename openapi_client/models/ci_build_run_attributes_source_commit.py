...
class CiBuildRunAttributesSourceCommit(BaseModel):
    """
    CiBuildRunAttributesSourceCommit
    """ # noqa: E501
    commit_sha: Optional[StrictStr] = Field(default=None, alias="commitSha")
    ...
    __properties: ClassVar[List[str]] = ["commitSha", "message", "author", "committer", "webUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "author": CiGitUser.from_dict(obj["author"]) if obj.get("author") is not None else None,
            "committer": CiGitUser.from_dict(obj["committer"]) if obj.get("committer") is not None else None,
