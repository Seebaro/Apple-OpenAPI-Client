...
class BackgroundAssetVersionInternalBetaReleaseAttributes(BaseModel):
    """
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['READY_FOR_TESTING', 'SUPERSEDED']):
            raise ValueError("must be one of enum values ('READY_FOR_TESTING', 'SUPERSEDED')")
        return value
