...
class AppClipAdvancedExperienceAttributesPlaceMainAddressStructuredAddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["streetAddress", "floor", "neighborhood", "locality", "stateProvince", "postalCode", "countryCode"]
