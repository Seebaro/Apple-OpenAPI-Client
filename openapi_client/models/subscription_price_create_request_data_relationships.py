...
class SubscriptionPriceCreateRequestDataRelationships(BaseModel):
    """
    ...
    subscription_price_point: SubscriptionPriceCreateRequestDataRelationshipsSubscriptionPricePoint = Field(alias="subscriptionPricePoint")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptionPricePoint": SubscriptionPriceCreateRequestDataRelationshipsSubscriptionPricePoint.from_dict(obj["subscriptionPricePoint"]) if obj.get("subscriptionPricePoint") is not None else None
        })
        return _obj
