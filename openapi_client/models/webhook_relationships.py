...
class WebhookRelationships(BaseModel):
    ...
    deliveries: Optional[AnalyticsReportInstanceRelationshipsSegments] = None
    __properties: ClassVar[List[str]] = ["app", "deliveries"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of deliveries
        if self.deliveries:
            _dict['deliveries'] = self.deliveries.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deliveries": AnalyticsReportInstanceRelationshipsSegments.from_dict(obj["deliveries"]) if obj.get("deliveries") is not None else None
        })
        return _obj
