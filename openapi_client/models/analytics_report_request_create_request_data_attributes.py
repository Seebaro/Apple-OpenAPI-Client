...
class AnalyticsReportRequestCreateRequestDataAttributes(BaseModel):
    """
    AnalyticsReportRequestCreateRequestDataAttributes
    """ # noqa: E501
    access_type: StrictStr = Field(alias="accessType")
    __properties: ClassVar[List[str]] = ["accessType"]
