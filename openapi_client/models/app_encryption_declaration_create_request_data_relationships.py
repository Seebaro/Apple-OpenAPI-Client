...
class AppEncryptionDeclarationCreateRequestDataRelationships(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "app": AppEncryptionDeclarationCreateRequestDataRelationshipsApp.from_dict(obj["app"]) if obj.get("app") is not None else None
        })
        return _obj
