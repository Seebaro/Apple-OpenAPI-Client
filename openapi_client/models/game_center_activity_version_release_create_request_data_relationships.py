...
class GameCenterActivityVersionReleaseCreateRequestDataRelationships(BaseModel):
    """
    ...
    version: GameCenterActivityLocalizationCreateRequestDataRelationshipsVersion
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "version": GameCenterActivityLocalizationCreateRequestDataRelationshipsVersion.from_dict(obj["version"]) if obj.get("version") is not None else None
        })
        return _obj
