...
class PreviewFrameImage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["image", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": ImageAsset.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "state": AppMediaPreviewFrameImageState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
