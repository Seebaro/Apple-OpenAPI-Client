...
class InAppPurchaseAppStoreReviewScreenshotCreateRequestData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['inAppPurchaseAppStoreReviewScreenshots']):
            raise ValueError("must be one of enum values ('inAppPurchaseAppStoreReviewScreenshots')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": InAppPurchaseAppStoreReviewScreenshotCreateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
