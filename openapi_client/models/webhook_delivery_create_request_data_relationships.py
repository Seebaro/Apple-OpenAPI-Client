...
class WebhookDeliveryCreateRequestDataRelationships(BaseModel):
    """
    WebhookDeliveryCreateRequestDataRelationships
    """ # noqa: E501
    template: WebhookDeliveryCreateRequestDataRelationshipsTemplate
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "template": WebhookDeliveryCreateRequestDataRelationshipsTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None
        })
        return _obj
