...
class GameCenterChallenge(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[GameCenterChallengeAttributes] = None
    relationships: Optional[GameCenterChallengeRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": GameCenterChallengeAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": GameCenterChallengeRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
