...
class GameCenterLeaderboardSetCreateRequestDataRelationshipsGameCenterLeaderboards(BaseModel):
    """
    GameCenterLeaderboardSetCreateRequestDataRelationshipsGameCenterLeaderboards
    """ # noqa: E501
    data: Optional[List[GameCenterActivityRelationshipsLeaderboardsDataInner]] = None
