...
class CertificateCreateRequestData(BaseModel):
    """
    CertificateCreateRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: CertificateCreateRequestDataAttributes
    relationships: Optional[CertificateCreateRequestDataRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": CertificateCreateRequestDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": CertificateCreateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
