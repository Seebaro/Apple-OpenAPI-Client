...
class AppPreviewSet(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[AppPreviewSetAttributes] = None
    relationships: Optional[AppPreviewSetRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": AppPreviewSetAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": AppPreviewSetRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
