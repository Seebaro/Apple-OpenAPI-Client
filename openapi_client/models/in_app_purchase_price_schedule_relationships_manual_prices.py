...
class InAppPurchasePriceScheduleRelationshipsManualPrices(BaseModel):
    """
    ...
    data: Optional[List[InAppPurchasePriceScheduleRelationshipsManualPricesDataInner]] = None
