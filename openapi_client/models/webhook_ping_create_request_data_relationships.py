...
class WebhookPingCreateRequestDataRelationships(BaseModel):
    """
    WebhookPingCreateRequestDataRelationships
    """ # noqa: E501
    webhook: WebhookPingCreateRequestDataRelationshipsWebhook
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "webhook": WebhookPingCreateRequestDataRelationshipsWebhook.from_dict(obj["webhook"]) if obj.get("webhook") is not None else None
        })
        return _obj
