...
class EndUserLicenseAgreementCreateRequestDataRelationships(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "territories": EndUserLicenseAgreementCreateRequestDataRelationshipsTerritories.from_dict(obj["territories"]) if obj.get("territories") is not None else None
        })
        return _obj
