...
class AppMarketplaceSearchDetailLinkageResponse(BaseModel):
    ...
    """ # noqa: E501
    data: AppMarketplaceSearchDetailLinkageResponseData
    links: DocumentLinks
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppMarketplaceSearchDetailLinkageResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
