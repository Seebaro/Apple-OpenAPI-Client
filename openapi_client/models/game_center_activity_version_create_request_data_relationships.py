...
class GameCenterActivityVersionCreateRequestDataRelationships(BaseModel):
    """
    GameCenterActivityVersionCreateRequestDataRelationships
    """ # noqa: E501
    activity: GameCenterActivityVersionCreateRequestDataRelationshipsActivity
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": GameCenterActivityVersionCreateRequestDataRelationshipsActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None
        })
        return _obj
