...
class BetaRecruitmentCriterionOptionAttributesDeviceFamilyOsVersionsInner(BaseModel):
    """
    ...
    os_versions: Optional[List[StrictStr]] = Field(default=None, alias="osVersions")
    __properties: ClassVar[List[str]] = ["deviceFamily", "osVersions"]
