...
class AppPriceSchedule(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    relationships: Optional[AppPriceScheduleRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['appPriceSchedules']):
            raise ValueError("must be one of enum values ('appPriceSchedules')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "relationships": AppPriceScheduleRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
