...
class GameCenterChallengeVersionRelease(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    relationships: Optional[GameCenterChallengeVersionReleaseRelationships] = None
    links: Optional[ResourceLinks] = None
    __properties: ClassVar[List[str]] = ["type", "id", "relationships", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "relationships": GameCenterChallengeVersionReleaseRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
