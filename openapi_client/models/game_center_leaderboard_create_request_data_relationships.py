...
class GameCenterLeaderboardCreateRequestDataRelationships(BaseModel):
    """
    ...
    game_center_leaderboard_sets: Optional[GameCenterLeaderboardCreateRequestDataRelationshipsGameCenterLeaderboardSets] = Field(default=None, alias="gameCenterLeaderboardSets")
    __properties: ClassVar[List[str]] = ["gameCenterDetail", "gameCenterGroup", "gameCenterLeaderboardSets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gameCenterLeaderboardSets": GameCenterLeaderboardCreateRequestDataRelationshipsGameCenterLeaderboardSets.from_dict(obj["gameCenterLeaderboardSets"]) if obj.get("gameCenterLeaderboardSets") is not None else None
        })
        return _obj
