...
class GameCenterActivityVersionCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    data: GameCenterActivityVersionCreateRequestData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GameCenterActivityVersionCreateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
