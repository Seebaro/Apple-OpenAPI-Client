...
class GameCenterMatchmakingRuleSetTestCreateRequestData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['gameCenterMatchmakingRuleSetTests']):
            raise ValueError("must be one of enum values ('gameCenterMatchmakingRuleSetTests')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "relationships": GameCenterMatchmakingRuleSetTestCreateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
