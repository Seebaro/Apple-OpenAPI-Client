...
class CiXcodeVersion(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[CiXcodeVersionAttributes] = None
    relationships: Optional[CiXcodeVersionRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ciXcodeVersions']):
            raise ValueError("must be one of enum values ('ciXcodeVersions')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": CiXcodeVersionAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": CiXcodeVersionRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
