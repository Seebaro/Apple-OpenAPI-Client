...
class GameCenterChallengeVersionCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    data: GameCenterChallengeVersionCreateRequestData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GameCenterChallengeVersionCreateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
