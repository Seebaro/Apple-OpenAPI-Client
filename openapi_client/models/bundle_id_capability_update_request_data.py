...
class BundleIdCapabilityUpdateRequestData(BaseModel):
    """
    BundleIdCapabilityUpdateRequestData
    """ # noqa: E501
    type: StrictStr
    id: StrictStr
    attributes: Optional[BundleIdCapabilityAttributes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": BundleIdCapabilityAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
