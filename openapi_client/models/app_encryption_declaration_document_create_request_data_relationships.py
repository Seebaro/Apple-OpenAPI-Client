...
class AppEncryptionDeclarationDocumentCreateRequestDataRelationships(BaseModel):
    """
    AppEncryptionDeclarationDocumentCreateRequestDataRelationships
    """ # noqa: E501
    app_encryption_declaration: AppEncryptionDeclarationDocumentCreateRequestDataRelationshipsAppEncryptionDeclaration = Field(alias="appEncryptionDeclaration")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appEncryptionDeclaration": AppEncryptionDeclarationDocumentCreateRequestDataRelationshipsAppEncryptionDeclaration.from_dict(obj["appEncryptionDeclaration"]) if obj.get("appEncryptionDeclaration") is not None else None
        })
        return _obj
