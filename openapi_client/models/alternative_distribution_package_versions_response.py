...
class AlternativeDistributionPackageVersionsResponse(BaseModel):
    ...
    included: Optional[List[AlternativeDistributionPackageVersionsResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AlternativeDistributionPackageVersion.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [AlternativeDistributionPackageVersionsResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
