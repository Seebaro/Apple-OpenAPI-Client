...
class GameCenterDetailUpdateRequestDataRelationships(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["gameCenterGroup", "defaultLeaderboard", "defaultGroupLeaderboard"]
