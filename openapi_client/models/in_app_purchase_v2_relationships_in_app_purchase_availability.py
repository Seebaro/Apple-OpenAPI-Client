...
class InAppPurchaseV2RelationshipsInAppPurchaseAvailability(BaseModel):
    """
    InAppPurchaseV2RelationshipsInAppPurchaseAvailability
    """ # noqa: E501
    links: Optional[RelationshipLinks] = None
    data: Optional[InAppPurchaseV2RelationshipsInAppPurchaseAvailabilityData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": InAppPurchaseV2RelationshipsInAppPurchaseAvailabilityData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
