...
class ErrorResponseErrorsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "code", "title", "detail", "source", "links", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": ErrorLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "meta": obj.get("meta")
        })
        return _obj
