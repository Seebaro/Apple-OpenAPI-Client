...
class CiScheduledStartConditionSchedule(BaseModel):
    """
    CiScheduledStartConditionSchedule
    """ # noqa: E501
    frequency: Optional[StrictStr] = None
    days: Optional[List[StrictStr]] = None
    hour: Optional[StrictInt] = None
    minute: Optional[StrictInt] = None
    timezone: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["frequency", "days", "hour", "minute", "timezone"]
    ...
    def frequency_validate_enum(cls, value):
        ...
        if value not in set(['WEEKLY', 'DAILY', 'HOURLY']):
            raise ValueError("must be one of enum values ('WEEKLY', 'DAILY', 'HOURLY')")
        return value
