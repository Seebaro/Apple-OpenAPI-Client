...
class AppAlternativeDistributionKeyLinkageResponse(BaseModel):
    ...
    """ # noqa: E501
    data: AppAlternativeDistributionKeyLinkageResponseData
    links: DocumentLinks
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppAlternativeDistributionKeyLinkageResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
