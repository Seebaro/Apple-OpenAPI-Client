...
class GameCenterChallengeImageCreateRequestDataRelationships(BaseModel):
    """
    GameCenterChallengeImageCreateRequestDataRelationships
    """ # noqa: E501
    localization: Optional[GameCenterChallengeImageCreateRequestDataRelationshipsLocalization] = None
    version: Optional[GameCenterChallengeImageCreateRequestDataRelationshipsVersion] = None
    __properties: ClassVar[List[str]] = ["localization", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "localization": GameCenterChallengeImageCreateRequestDataRelationshipsLocalization.from_dict(obj["localization"]) if obj.get("localization") is not None else None,
            "version": GameCenterChallengeImageCreateRequestDataRelationshipsVersion.from_dict(obj["version"]) if obj.get("version") is not None else None
        })
        return _obj
