...
class WebhookDeliveryCreateRequestData(BaseModel):
    """
    WebhookDeliveryCreateRequestData
    """ # noqa: E501
    type: StrictStr
    relationships: WebhookDeliveryCreateRequestDataRelationships
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "relationships": WebhookDeliveryCreateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
