...
class BetaRecruitmentCriterionCompatibleBuildCheck(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[BetaRecruitmentCriterionCompatibleBuildCheckAttributes] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['betaRecruitmentCriterionCompatibleBuildChecks']):
            raise ValueError("must be one of enum values ('betaRecruitmentCriterionCompatibleBuildChecks')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": BetaRecruitmentCriterionCompatibleBuildCheckAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
