...
class EndUserLicenseAgreementRelationships(BaseModel):
    ...
    territories: Optional[EndUserLicenseAgreementRelationshipsTerritories] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "territories": EndUserLicenseAgreementRelationshipsTerritories.from_dict(obj["territories"]) if obj.get("territories") is not None else None
        })
        return _obj
