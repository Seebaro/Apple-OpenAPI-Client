...
class AppClipAdvancedExperienceCreateRequestDataRelationships(BaseModel):
    """
    ...
    header_image: AppClipAdvancedExperienceCreateRequestDataRelationshipsHeaderImage = Field(alias="headerImage")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "headerImage": AppClipAdvancedExperienceCreateRequestDataRelationshipsHeaderImage.from_dict(obj["headerImage"]) if obj.get("headerImage") is not None else None,
            "localizations": AppClipAdvancedExperienceCreateRequestDataRelationshipsLocalizations.from_dict(obj["localizations"]) if obj.get("localizations") is not None else None
        })
        return _obj
