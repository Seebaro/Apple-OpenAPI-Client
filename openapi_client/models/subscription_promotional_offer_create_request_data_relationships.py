...
class SubscriptionPromotionalOfferCreateRequestDataRelationships(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prices": SubscriptionPromotionalOfferCreateRequestDataRelationshipsPrices.from_dict(obj["prices"]) if obj.get("prices") is not None else None
        })
        return _obj
