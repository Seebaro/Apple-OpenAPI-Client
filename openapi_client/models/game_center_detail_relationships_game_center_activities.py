...
class GameCenterDetailRelationshipsGameCenterActivities(BaseModel):
    """
    ...
    data: Optional[List[GameCenterAchievementRelationshipsActivityData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GameCenterAchievementRelationshipsActivityData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
