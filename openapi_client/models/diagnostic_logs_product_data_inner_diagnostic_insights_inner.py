...
class DiagnosticLogsProductDataInnerDiagnosticInsightsInner(BaseModel):
    """
    DiagnosticLogsProductDataInnerDiagnosticInsightsInner
    """ # noqa: E501
    insights_url: Optional[StrictStr] = Field(default=None, alias="insightsURL")
    insights_category: Optional[StrictStr] = Field(default=None, alias="insightsCategory")
    insights_string: Optional[StrictStr] = Field(default=None, alias="insightsString")
    __properties: ClassVar[List[str]] = ["insightsURL", "insightsCategory", "insightsString"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "insightsURL": obj.get("insightsURL"),
            "insightsCategory": obj.get("insightsCategory"),
            "insightsString": obj.get("insightsString")
        })
        return _obj
