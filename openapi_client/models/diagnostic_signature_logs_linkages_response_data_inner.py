...
class DiagnosticSignatureLogsLinkagesResponseDataInner(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['diagnosticLogs']):
            raise ValueError("must be one of enum values ('diagnosticLogs')")
        return value
