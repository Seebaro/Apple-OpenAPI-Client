...
class CiArtifactAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["fileType", "fileName", "fileSize", "downloadUrl"]
    ...
    def file_type_validate_enum(cls, value):
        ...
        if value not in set(['ARCHIVE', 'ARCHIVE_EXPORT', 'LOG_BUNDLE', 'RESULT_BUNDLE', 'TEST_PRODUCTS', 'XCODEBUILD_PRODUCTS', 'STAPLED_NOTARIZED_ARCHIVE']):
            raise ValueError("must be one of enum values ('ARCHIVE', 'ARCHIVE_EXPORT', 'LOG_BUNDLE', 'RESULT_BUNDLE', 'TEST_PRODUCTS', 'XCODEBUILD_PRODUCTS', 'STAPLED_NOTARIZED_ARCHIVE')")
        return value
