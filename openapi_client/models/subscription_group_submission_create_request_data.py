...
class SubscriptionGroupSubmissionCreateRequestData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['subscriptionGroupSubmissions']):
            raise ValueError("must be one of enum values ('subscriptionGroupSubmissions')")
        return value
