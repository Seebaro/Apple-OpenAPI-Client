...
class GameCenterAchievementAttributes(BaseModel):
    """
    ...
    show_before_earned: Optional[StrictBool] = Field(default=None, alias="showBeforeEarned")
    ...
    __properties: ClassVar[List[str]] = ["referenceName", "vendorIdentifier", "points", "showBeforeEarned", "repeatable", "archived", "activityProperties"]
