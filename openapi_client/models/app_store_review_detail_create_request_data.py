...
class AppStoreReviewDetailCreateRequestData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['appStoreReviewDetails']):
            raise ValueError("must be one of enum values ('appStoreReviewDetails')")
        return value
