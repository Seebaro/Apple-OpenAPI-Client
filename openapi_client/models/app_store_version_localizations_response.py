...
class AppStoreVersionLocalizationsResponse(BaseModel):
    ...
    included: Optional[List[AppStoreVersionLocalizationsResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AppStoreVersionLocalization.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [AppStoreVersionLocalizationsResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
