...
class CertificateCreateRequestDataAttributes(BaseModel):
    """
    CertificateCreateRequestDataAttributes
    """ # noqa: E501
    csr_content: StrictStr = Field(alias="csrContent")
    certificate_type: CertificateType = Field(alias="certificateType")
    __properties: ClassVar[List[str]] = ["csrContent", "certificateType"]
