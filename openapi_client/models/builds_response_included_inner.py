...
BUILDSRESPONSEINCLUDEDINNER_ONE_OF_SCHEMAS = ["App", "AppEncryptionDeclaration", "AppStoreVersion", "BetaAppReviewSubmission", "BetaBuildLocalization", "BetaGroup", "BetaTester", "BuildBetaDetail", "BuildBundle", "BuildIcon", "PrereleaseVersion"]

class BuildsResponseIncludedInner(BaseModel):
    """
    ...
    oneof_schema_4_validator: Optional[BetaBuildLocalization] = None
    # data type: AppEncryptionDeclaration
    oneof_schema_5_validator: Optional[AppEncryptionDeclaration] = None
    # data type: BetaAppReviewSubmission
    oneof_schema_6_validator: Optional[BetaAppReviewSubmission] = None
    # data type: App
    oneof_schema_7_validator: Optional[App] = None
    # data type: BuildBetaDetail
    oneof_schema_8_validator: Optional[BuildBetaDetail] = None
    # data type: AppStoreVersion
    oneof_schema_9_validator: Optional[AppStoreVersion] = None
    # data type: BuildIcon
    oneof_schema_10_validator: Optional[BuildIcon] = None
    # data type: BuildBundle
    oneof_schema_11_validator: Optional[BuildBundle] = None
    actual_instance: Optional[Union[App, AppEncryptionDeclaration, AppStoreVersion, BetaAppReviewSubmission, BetaBuildLocalization, BetaGroup, BetaTester, BuildBetaDetail, BuildBundle, BuildIcon, PrereleaseVersion]] = None
    one_of_schemas: Set[str] = { "App", "AppEncryptionDeclaration", "AppStoreVersion", "BetaAppReviewSubmission", "BetaBuildLocalization", "BetaGroup", "BetaTester", "BuildBetaDetail", "BuildBundle", "BuildIcon", "PrereleaseVersion" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = BuildsResponseIncludedInner.model_construct()
        error_messages = []
        match = 0
        ...
        if not isinstance(v, BuildIcon):
            ...
            match += 1
        # validate data type: BuildBundle
        if not isinstance(v, BuildBundle):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BuildBundle`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in BuildsResponseIncludedInner with oneOf schemas: App, AppEncryptionDeclaration, AppStoreVersion, BetaAppReviewSubmission, BetaBuildLocalization, BetaGroup, BetaTester, BuildBetaDetail, BuildBundle, BuildIcon, PrereleaseVersion. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in BuildsResponseIncludedInner with oneOf schemas: App, AppEncryptionDeclaration, AppStoreVersion, BetaAppReviewSubmission, BetaBuildLocalization, BetaGroup, BetaTester, BuildBetaDetail, BuildBundle, BuildIcon, PrereleaseVersion. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into BuildBundle
        try:
            instance.actual_instance = BuildBundle.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], App, AppEncryptionDeclaration, AppStoreVersion, BetaAppReviewSubmission, BetaBuildLocalization, BetaGroup, BetaTester, BuildBetaDetail, BuildBundle, BuildIcon, PrereleaseVersion]]:
