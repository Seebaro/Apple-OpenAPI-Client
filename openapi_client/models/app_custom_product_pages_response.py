...
class AppCustomProductPagesResponse(BaseModel):
    ...
    included: Optional[List[AppCustomProductPagesResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AppCustomProductPage.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [AppCustomProductPagesResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
