...
class GameCenterPlayerAchievementSubmissionAttributes(BaseModel):
    """
    ...
    percentage_achieved: Optional[StrictInt] = Field(default=None, alias="percentageAchieved")
    scoped_player_id: Optional[StrictStr] = Field(default=None, alias="scopedPlayerId")
