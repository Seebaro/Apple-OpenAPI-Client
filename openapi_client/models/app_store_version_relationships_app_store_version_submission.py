...
class AppStoreVersionRelationshipsAppStoreVersionSubmission(BaseModel):
    """
    AppStoreVersionRelationshipsAppStoreVersionSubmission
    """ # noqa: E501
    links: Optional[RelationshipLinks] = None
    data: Optional[AppStoreVersionRelationshipsAppStoreVersionSubmissionData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": AppStoreVersionRelationshipsAppStoreVersionSubmissionData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
