...
class BetaTesterUsagesV1MetricResponseDataInnerDimensions(BaseModel):
    """
    BetaTesterUsagesV1MetricResponseDataInnerDimensions
    """ # noqa: E501
    apps: Optional[AppsBetaTesterUsagesV1MetricResponseDataInnerDimensionsBetaTesters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": AppsBetaTesterUsagesV1MetricResponseDataInnerDimensionsBetaTesters.from_dict(obj["apps"]) if obj.get("apps") is not None else None
        })
        return _obj
