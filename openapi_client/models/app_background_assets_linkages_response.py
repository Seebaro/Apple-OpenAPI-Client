...
class AppBackgroundAssetsLinkagesResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[BackgroundAssetVersionCreateRequestDataRelationshipsBackgroundAssetData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BackgroundAssetVersionCreateRequestDataRelationshipsBackgroundAssetData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
