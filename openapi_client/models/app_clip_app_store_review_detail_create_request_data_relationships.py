...
class AppClipAppStoreReviewDetailCreateRequestDataRelationships(BaseModel):
    """
    AppClipAppStoreReviewDetailCreateRequestDataRelationships
    """ # noqa: E501
    app_clip_default_experience: AppClipAppStoreReviewDetailCreateRequestDataRelationshipsAppClipDefaultExperience = Field(alias="appClipDefaultExperience")
    __properties: ClassVar[List[str]] = ["appClipDefaultExperience"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appClipDefaultExperience": AppClipAppStoreReviewDetailCreateRequestDataRelationshipsAppClipDefaultExperience.from_dict(obj["appClipDefaultExperience"]) if obj.get("appClipDefaultExperience") is not None else None
        })
        return _obj
