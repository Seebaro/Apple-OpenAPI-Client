...
class CustomerReviewResponseV1Relationships(BaseModel):
    """
    CustomerReviewResponseV1Relationships
    """ # noqa: E501
    review: Optional[CustomerReviewResponseV1RelationshipsReview] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "review": CustomerReviewResponseV1RelationshipsReview.from_dict(obj["review"]) if obj.get("review") is not None else None
        })
        return _obj
