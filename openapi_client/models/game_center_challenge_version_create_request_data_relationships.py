...
class GameCenterChallengeVersionCreateRequestDataRelationships(BaseModel):
    """
    GameCenterChallengeVersionCreateRequestDataRelationships
    """ # noqa: E501
    challenge: GameCenterChallengeVersionCreateRequestDataRelationshipsChallenge
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "challenge": GameCenterChallengeVersionCreateRequestDataRelationshipsChallenge.from_dict(obj["challenge"]) if obj.get("challenge") is not None else None
        })
        return _obj
