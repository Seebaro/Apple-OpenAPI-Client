...
class XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInnerFilterCriteria(BaseModel):
    """
    ...
    device_marketing_name: Optional[StrictStr] = Field(default=None, alias="deviceMarketingName")
    __properties: ClassVar[List[str]] = ["percentile", "device", "deviceMarketingName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deviceMarketingName": obj.get("deviceMarketingName")
        })
        return _obj
