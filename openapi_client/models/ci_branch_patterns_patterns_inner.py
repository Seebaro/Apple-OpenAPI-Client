...
class CiBranchPatternsPatternsInner(BaseModel):
    """
    CiBranchPatternsPatternsInner
    """ # noqa: E501
    pattern: Optional[StrictStr] = None
    is_prefix: Optional[StrictBool] = Field(default=None, alias="isPrefix")
    __properties: ClassVar[List[str]] = ["pattern", "isPrefix"]
