...
class GameCenterActivityRelationshipsVersions(BaseModel):
    """
    GameCenterActivityRelationshipsVersions
    """ # noqa: E501
    links: Optional[RelationshipLinks] = None
    meta: Optional[PagingInformation] = None
    data: Optional[List[GameCenterActivityRelationshipsVersionsDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GameCenterActivityRelationshipsVersionsDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
