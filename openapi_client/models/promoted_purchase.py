...
class PromotedPurchase(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[PromotedPurchaseAttributes] = None
    relationships: Optional[PromotedPurchaseRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['promotedPurchases']):
            raise ValueError("must be one of enum values ('promotedPurchases')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": PromotedPurchaseAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": PromotedPurchaseRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
