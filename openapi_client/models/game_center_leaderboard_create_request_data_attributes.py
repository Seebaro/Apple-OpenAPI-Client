...
class GameCenterLeaderboardCreateRequestDataAttributes(BaseModel):
    """
    GameCenterLeaderboardCreateRequestDataAttributes
    """ # noqa: E501
    default_formatter: GameCenterLeaderboardFormatter = Field(alias="defaultFormatter")
    reference_name: StrictStr = Field(alias="referenceName")
    vendor_identifier: StrictStr = Field(alias="vendorIdentifier")
    submission_type: StrictStr = Field(alias="submissionType")
    score_sort_type: StrictStr = Field(alias="scoreSortType")
    ...
    __properties: ClassVar[List[str]] = ["defaultFormatter", "referenceName", "vendorIdentifier", "submissionType", "scoreSortType", "scoreRangeStart", "scoreRangeEnd", "recurrenceStartDate", "recurrenceDuration", "recurrenceRule", "activityProperties", "visibility"]
