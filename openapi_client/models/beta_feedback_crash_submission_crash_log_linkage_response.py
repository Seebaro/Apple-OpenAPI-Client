...
class BetaFeedbackCrashSubmissionCrashLogLinkageResponse(BaseModel):
    ...
    """ # noqa: E501
    data: BetaFeedbackCrashSubmissionCrashLogLinkageResponseData
    links: DocumentLinks
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": BetaFeedbackCrashSubmissionCrashLogLinkageResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
