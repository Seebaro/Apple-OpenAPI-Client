...
class WebhookDeliveryAttributesResponse(BaseModel):
    """
    WebhookDeliveryAttributesResponse
    """ # noqa: E501
    http_status_code: Optional[StrictInt] = Field(default=None, alias="httpStatusCode")
    body: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["httpStatusCode", "body"]
