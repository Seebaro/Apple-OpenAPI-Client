...
class InAppPurchaseV2RelationshipsImages(BaseModel):
    """
    InAppPurchaseV2RelationshipsImages
    """ # noqa: E501
    links: Optional[RelationshipLinks] = None
    meta: Optional[PagingInformation] = None
    data: Optional[List[InAppPurchaseV2RelationshipsImagesDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [InAppPurchaseV2RelationshipsImagesDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
