...
class WebhookCreateRequestData(BaseModel):
    """
    WebhookCreateRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: WebhookCreateRequestDataAttributes
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": WebhookCreateRequestDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
