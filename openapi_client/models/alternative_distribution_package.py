...
class AlternativeDistributionPackage(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    relationships: Optional[AlternativeDistributionPackageRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['alternativeDistributionPackages']):
            raise ValueError("must be one of enum values ('alternativeDistributionPackages')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "relationships": AlternativeDistributionPackageRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
