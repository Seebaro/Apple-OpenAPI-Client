...
class CustomerReviewResponseV1Attributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["responseBody", "lastModifiedDate", "state"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['PUBLISHED', 'PENDING_PUBLISH']):
            raise ValueError("must be one of enum values ('PUBLISHED', 'PENDING_PUBLISH')")
        return value
