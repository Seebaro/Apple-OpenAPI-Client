...
class GameCenterMatchmakingBooleanRuleResultsV1MetricResponseDataInnerDataPoints(BaseModel):
    """
    GameCenterMatchmakingBooleanRuleResultsV1MetricResponseDataInnerDataPoints
    """ # noqa: E501
    start: Optional[datetime] = None
    end: Optional[datetime] = None
    values: Optional[GameCenterMatchmakingBooleanRuleResultsV1MetricResponseDataInnerDataPointsValues] = None
    __properties: ClassVar[List[str]] = ["start", "end", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "start": obj.get("start"),
            "end": obj.get("end"),
            "values": GameCenterMatchmakingBooleanRuleResultsV1MetricResponseDataInnerDataPointsValues.from_dict(obj["values"]) if obj.get("values") is not None else None
        })
        return _obj
