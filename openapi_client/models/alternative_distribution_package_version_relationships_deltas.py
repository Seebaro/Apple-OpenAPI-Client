...
class AlternativeDistributionPackageVersionRelationshipsDeltas(BaseModel):
    """
    ...
    data: Optional[List[AlternativeDistributionPackageVersionRelationshipsDeltasDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [AlternativeDistributionPackageVersionRelationshipsDeltasDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
