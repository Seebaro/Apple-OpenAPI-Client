...
class GameCenterChallengeVersionCreateRequestData(BaseModel):
    """
    GameCenterChallengeVersionCreateRequestData
    """ # noqa: E501
    type: StrictStr
    relationships: GameCenterChallengeVersionCreateRequestDataRelationships
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "relationships": GameCenterChallengeVersionCreateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
