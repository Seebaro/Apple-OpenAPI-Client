...
class AppAvailabilityV2(BaseModel):
    ...
    relationships: Optional[AppAvailabilityV2Relationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['appAvailabilities']):
            raise ValueError("must be one of enum values ('appAvailabilities')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": AppAvailabilityV2Relationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
