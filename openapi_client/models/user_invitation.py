...
class UserInvitation(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[UserInvitationAttributes] = None
    relationships: Optional[UserInvitationRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": UserInvitationAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": UserInvitationRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
