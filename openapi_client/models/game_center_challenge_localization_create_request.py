...
class GameCenterChallengeLocalizationCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    data: GameCenterChallengeLocalizationCreateRequestData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GameCenterChallengeLocalizationCreateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
