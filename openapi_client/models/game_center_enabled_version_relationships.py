...
class GameCenterEnabledVersionRelationships(BaseModel):
    """
    GameCenterEnabledVersionRelationships
    """ # noqa: E501
    compatible_versions: Optional[AppRelationshipsGameCenterEnabledVersions] = Field(default=None, alias="compatibleVersions")
    app: Optional[AlternativeDistributionKeyCreateRequestDataRelationshipsApp] = None
    __properties: ClassVar[List[str]] = ["compatibleVersions", "app"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of compatible_versions
        if self.compatible_versions:
            _dict['compatibleVersions'] = self.compatible_versions.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "compatibleVersions": AppRelationshipsGameCenterEnabledVersions.from_dict(obj["compatibleVersions"]) if obj.get("compatibleVersions") is not None else None,
