...
class AppPriceV2Relationships(BaseModel):
    """
    AppPriceV2Relationships
    """ # noqa: E501
    app_price_point: Optional[AppPriceV2RelationshipsAppPricePoint] = Field(default=None, alias="appPricePoint")
    territory: Optional[AppPricePointV3RelationshipsTerritory] = None
    __properties: ClassVar[List[str]] = ["appPricePoint", "territory"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of app_price_point
        if self.app_price_point:
            _dict['appPricePoint'] = self.app_price_point.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appPricePoint": AppPriceV2RelationshipsAppPricePoint.from_dict(obj["appPricePoint"]) if obj.get("appPricePoint") is not None else None,
