...
class InAppPurchaseAvailability(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[AppAvailabilityV2Attributes] = None
    relationships: Optional[InAppPurchaseAvailabilityRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['inAppPurchaseAvailabilities']):
            raise ValueError("must be one of enum values ('inAppPurchaseAvailabilities')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": AppAvailabilityV2Attributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": InAppPurchaseAvailabilityRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
