...
class AppCustomProductPageLocalization(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[AppCustomProductPageLocalizationAttributes] = None
    relationships: Optional[AppCustomProductPageLocalizationRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['appCustomProductPageLocalizations']):
            raise ValueError("must be one of enum values ('appCustomProductPageLocalizations')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": AppCustomProductPageLocalizationAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": AppCustomProductPageLocalizationRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
