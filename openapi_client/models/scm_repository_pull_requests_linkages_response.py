...
class ScmRepositoryPullRequestsLinkagesResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[CiBuildRunRelationshipsPullRequestData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CiBuildRunRelationshipsPullRequestData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
