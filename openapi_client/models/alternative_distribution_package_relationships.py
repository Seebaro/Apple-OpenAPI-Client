...
class AlternativeDistributionPackageRelationships(BaseModel):
    """
    AlternativeDistributionPackageRelationships
    """ # noqa: E501
    versions: Optional[AlternativeDistributionPackageRelationshipsVersions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "versions": AlternativeDistributionPackageRelationshipsVersions.from_dict(obj["versions"]) if obj.get("versions") is not None else None
        })
        return _obj
