...
class AppStoreVersionExperimentV2CreateRequestDataAttributes(BaseModel):
    """
    AppStoreVersionExperimentV2CreateRequestDataAttributes
    """ # noqa: E501
    name: StrictStr
    platform: Platform
    traffic_proportion: StrictInt = Field(alias="trafficProportion")
    __properties: ClassVar[List[str]] = ["name", "platform", "trafficProportion"]
