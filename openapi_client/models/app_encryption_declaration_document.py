...
class AppEncryptionDeclarationDocument(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[AppEncryptionDeclarationDocumentAttributes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": AppEncryptionDeclarationDocumentAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
