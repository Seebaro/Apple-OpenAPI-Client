...
class AppPricePointV3EqualizationsLinkagesResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[AppPriceV2RelationshipsAppPricePointData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AppPriceV2RelationshipsAppPricePointData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
