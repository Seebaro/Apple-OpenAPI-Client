...
class AnalyticsReportInstanceRelationships(BaseModel):
    """
    AnalyticsReportInstanceRelationships
    """ # noqa: E501
    segments: Optional[AnalyticsReportInstanceRelationshipsSegments] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "segments": AnalyticsReportInstanceRelationshipsSegments.from_dict(obj["segments"]) if obj.get("segments") is not None else None
        })
        return _obj
