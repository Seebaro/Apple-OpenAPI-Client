...
class BackgroundAsset(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[BackgroundAssetAttributes] = None
    relationships: Optional[BackgroundAssetRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": BackgroundAssetAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": BackgroundAssetRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
