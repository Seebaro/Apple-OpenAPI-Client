...
class SubscriptionPromotionalOfferRelationships(BaseModel):
    """
    SubscriptionPromotionalOfferRelationships
    """ # noqa: E501
    subscription: Optional[PromotedPurchaseRelationshipsSubscription] = None
    prices: Optional[SubscriptionPromotionalOfferRelationshipsPrices] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prices": SubscriptionPromotionalOfferRelationshipsPrices.from_dict(obj["prices"]) if obj.get("prices") is not None else None
        })
        return _obj
