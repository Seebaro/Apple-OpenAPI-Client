...
class SubscriptionPromotionalOfferUpdateRequestData(BaseModel):
    """
    SubscriptionPromotionalOfferUpdateRequestData
    """ # noqa: E501
    type: StrictStr
    id: StrictStr
    relationships: Optional[SubscriptionPromotionalOfferUpdateRequestDataRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "relationships": SubscriptionPromotionalOfferUpdateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
