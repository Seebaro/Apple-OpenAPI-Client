...
class AppStoreReviewDetailAttributes(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contactFirstName", "contactLastName", "contactPhone", "contactEmail", "demoAccountName", "demoAccountPassword", "demoAccountRequired", "notes"]
