...
class BackgroundAssetVersionRelationshipsInternalBetaRelease(BaseModel):
    """
    BackgroundAssetVersionRelationshipsInternalBetaRelease
    """ # noqa: E501
    data: Optional[BackgroundAssetVersionRelationshipsInternalBetaReleaseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": BackgroundAssetVersionRelationshipsInternalBetaReleaseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
