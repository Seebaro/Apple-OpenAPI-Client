...
class AppClipAdvancedExperienceUpdateRequestDataAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action", "isPoweredBy", "place", "businessCategory", "defaultLanguage", "removed"]
