...
class GameCenterLeaderboardEntrySubmissionCreateRequestDataAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bundleId", "challengeIds", "context", "scopedPlayerId", "score", "submittedDate", "vendorIdentifier"]
