...
class GameCenterLeaderboardSetImage(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[GameCenterAchievementImageAttributes] = None
    relationships: Optional[GameCenterLeaderboardSetImageRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['gameCenterLeaderboardSetImages']):
            raise ValueError("must be one of enum values ('gameCenterLeaderboardSetImages')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": GameCenterAchievementImageAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": GameCenterLeaderboardSetImageRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
