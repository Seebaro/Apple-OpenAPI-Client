...
class CiFilesAndFoldersRule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["mode", "matchers"]
    ...
    def mode_validate_enum(cls, value):
        ...
        if value not in set(['START_IF_ANY_FILE_MATCHES', 'DO_NOT_START_IF_ALL_FILES_MATCH']):
            raise ValueError("must be one of enum values ('START_IF_ANY_FILE_MATCHES', 'DO_NOT_START_IF_ALL_FILES_MATCH')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mode": obj.get("mode"),
            "matchers": [CiStartConditionFileMatcher.from_dict(_item) for _item in obj["matchers"]] if obj.get("matchers") is not None else None
        })
        return _obj
