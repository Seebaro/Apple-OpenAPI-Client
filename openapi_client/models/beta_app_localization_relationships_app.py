...
class BetaAppLocalizationRelationshipsApp(BaseModel):
    """
    BetaAppLocalizationRelationshipsApp
    """ # noqa: E501
    links: Optional[RelationshipLinks] = None
    data: Optional[AccessibilityDeclarationCreateRequestDataRelationshipsAppData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": AccessibilityDeclarationCreateRequestDataRelationshipsAppData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
