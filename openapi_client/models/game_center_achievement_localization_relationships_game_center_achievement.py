...
class GameCenterAchievementLocalizationRelationshipsGameCenterAchievement(BaseModel):
    """
    GameCenterAchievementLocalizationRelationshipsGameCenterAchievement
    """ # noqa: E501
    links: Optional[RelationshipLinks] = None
    data: Optional[GameCenterAchievementLocalizationRelationshipsGameCenterAchievementData] = None
