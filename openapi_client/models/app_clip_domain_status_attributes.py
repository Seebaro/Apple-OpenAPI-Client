...
class AppClipDomainStatusAttributes(BaseModel):
    """
    AppClipDomainStatusAttributes
    """ # noqa: E501
    domains: Optional[List[AppClipDomainStatusAttributesDomainsInner]] = None
    last_updated_date: Optional[datetime] = Field(default=None, alias="lastUpdatedDate")
    __properties: ClassVar[List[str]] = ["domains", "lastUpdatedDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "domains": [AppClipDomainStatusAttributesDomainsInner.from_dict(_item) for _item in obj["domains"]] if obj.get("domains") is not None else None,
