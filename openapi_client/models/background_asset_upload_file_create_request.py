...
class BackgroundAssetUploadFileCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    data: BackgroundAssetUploadFileCreateRequestData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": BackgroundAssetUploadFileCreateRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
