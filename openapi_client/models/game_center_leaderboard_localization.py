...
class GameCenterLeaderboardLocalization(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[GameCenterLeaderboardLocalizationAttributes] = None
    relationships: Optional[GameCenterLeaderboardLocalizationRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['gameCenterLeaderboardLocalizations']):
            raise ValueError("must be one of enum values ('gameCenterLeaderboardLocalizations')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": GameCenterLeaderboardLocalizationAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": GameCenterLeaderboardLocalizationRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
