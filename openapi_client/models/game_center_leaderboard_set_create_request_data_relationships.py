...
class GameCenterLeaderboardSetCreateRequestDataRelationships(BaseModel):
    """
    ...
    game_center_leaderboards: Optional[GameCenterLeaderboardSetCreateRequestDataRelationshipsGameCenterLeaderboards] = Field(default=None, alias="gameCenterLeaderboards")
    __properties: ClassVar[List[str]] = ["gameCenterDetail", "gameCenterGroup", "gameCenterLeaderboards"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gameCenterLeaderboards": GameCenterLeaderboardSetCreateRequestDataRelationshipsGameCenterLeaderboards.from_dict(obj["gameCenterLeaderboards"]) if obj.get("gameCenterLeaderboards") is not None else None
        })
        return _obj
