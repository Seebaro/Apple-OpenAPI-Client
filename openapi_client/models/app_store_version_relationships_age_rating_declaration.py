...
class AppStoreVersionRelationshipsAgeRatingDeclaration(BaseModel):
    """
    AppStoreVersionRelationshipsAgeRatingDeclaration
    """ # noqa: E501
    links: Optional[RelationshipLinks] = None
    data: Optional[AppInfoRelationshipsAgeRatingDeclarationData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": AppInfoRelationshipsAgeRatingDeclarationData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
