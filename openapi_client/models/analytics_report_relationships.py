...
class AnalyticsReportRelationships(BaseModel):
    """
    AnalyticsReportRelationships
    """ # noqa: E501
    instances: Optional[AnalyticsReportInstanceRelationshipsSegments] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instances": AnalyticsReportInstanceRelationshipsSegments.from_dict(obj["instances"]) if obj.get("instances") is not None else None
        })
        return _obj
