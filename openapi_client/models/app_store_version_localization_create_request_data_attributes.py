...
class AppStoreVersionLocalizationCreateRequestDataAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "locale", "keywords", "marketingUrl", "promotionalText", "supportUrl", "whatsNew"]
