...
class GameCenterChallengeLocalizationRelationships(BaseModel):
    """
    ...
    image: Optional[GameCenterChallengeLocalizationRelationshipsImage] = None
    __properties: ClassVar[List[str]] = ["version", "image"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image": GameCenterChallengeLocalizationRelationshipsImage.from_dict(obj["image"]) if obj.get("image") is not None else None
        })
        return _obj
