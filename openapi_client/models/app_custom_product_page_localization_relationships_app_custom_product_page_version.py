...
class AppCustomProductPageLocalizationRelationshipsAppCustomProductPageVersion(BaseModel):
    """
    AppCustomProductPageLocalizationRelationshipsAppCustomProductPageVersion
    """ # noqa: E501
    data: Optional[AppCustomProductPageLocalizationRelationshipsAppCustomProductPageVersionData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppCustomProductPageLocalizationRelationshipsAppCustomProductPageVersionData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
