...
class SubscriptionOfferCodeOneTimeUseCodeValuesLinkageResponse(BaseModel):
    ...
    """ # noqa: E501
    data: SubscriptionOfferCodeOneTimeUseCodeValuesLinkageResponseData
    links: DocumentLinks
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SubscriptionOfferCodeOneTimeUseCodeValuesLinkageResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
