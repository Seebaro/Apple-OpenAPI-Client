...
class WinBackOfferCreateRequestDataAttributes(BaseModel):
    """
    ...
    period_count: StrictInt = Field(alias="periodCount")
    customer_eligibility_paid_subscription_duration_in_months: StrictInt = Field(alias="customerEligibilityPaidSubscriptionDurationInMonths")
    customer_eligibility_time_since_last_subscribed_in_months: IntegerRange = Field(alias="customerEligibilityTimeSinceLastSubscribedInMonths")
