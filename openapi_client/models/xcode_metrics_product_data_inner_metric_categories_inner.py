...
class XcodeMetricsProductDataInnerMetricCategoriesInner(BaseModel):
    """
    XcodeMetricsProductDataInnerMetricCategoriesInner
    """ # noqa: E501
    identifier: Optional[MetricCategory] = None
    metrics: Optional[List[XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInner]] = None
    __properties: ClassVar[List[str]] = ["identifier", "metrics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": [XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInner.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None
        })
        return _obj
