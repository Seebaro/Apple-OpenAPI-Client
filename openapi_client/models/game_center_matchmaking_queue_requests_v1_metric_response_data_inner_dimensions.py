...
class GameCenterMatchmakingQueueRequestsV1MetricResponseDataInnerDimensions(BaseModel):
    """
    GameCenterMatchmakingQueueRequestsV1MetricResponseDataInnerDimensions
    """ # noqa: E501
    result: Optional[GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDimensionsResult] = None
    game_center_detail: Optional[AppsBetaTesterUsagesV1MetricResponseDataInnerDimensionsBetaTesters] = Field(default=None, alias="gameCenterDetail")
    __properties: ClassVar[List[str]] = ["result", "gameCenterDetail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDimensionsResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "gameCenterDetail": AppsBetaTesterUsagesV1MetricResponseDataInnerDimensionsBetaTesters.from_dict(obj["gameCenterDetail"]) if obj.get("gameCenterDetail") is not None else None
        })
        return _obj
