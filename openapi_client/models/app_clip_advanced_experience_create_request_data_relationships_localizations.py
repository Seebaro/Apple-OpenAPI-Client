...
class AppClipAdvancedExperienceCreateRequestDataRelationshipsLocalizations(BaseModel):
    """
    AppClipAdvancedExperienceCreateRequestDataRelationshipsLocalizations
    """ # noqa: E501
    data: List[AppClipAdvancedExperienceRelationshipsLocalizationsDataInner]
