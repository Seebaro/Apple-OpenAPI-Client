...
class CustomerReviewResponseV1RelationshipsReview(BaseModel):
    """
    CustomerReviewResponseV1RelationshipsReview
    """ # noqa: E501
    data: Optional[CustomerReviewResponseV1RelationshipsReviewData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CustomerReviewResponseV1RelationshipsReviewData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
