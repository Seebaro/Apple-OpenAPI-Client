...
class ProfilesResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[Profile]
    included: Optional[List[ProfilesResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "included": [ProfilesResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
