...
class GameCenterMatchmakingRuleSetCreateRequestDataAttributes(BaseModel):
    """
    GameCenterMatchmakingRuleSetCreateRequestDataAttributes
    """ # noqa: E501
    reference_name: StrictStr = Field(alias="referenceName")
    rule_language_version: StrictInt = Field(alias="ruleLanguageVersion")
    min_players: StrictInt = Field(alias="minPlayers")
    max_players: StrictInt = Field(alias="maxPlayers")
    __properties: ClassVar[List[str]] = ["referenceName", "ruleLanguageVersion", "minPlayers", "maxPlayers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ruleLanguageVersion": obj.get("ruleLanguageVersion"),
