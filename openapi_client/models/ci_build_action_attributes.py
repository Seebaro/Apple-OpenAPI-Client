...
class CiBuildActionAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "actionType", "startedDate", "finishedDate", "issueCounts", "executionProgress", "completionStatus", "isRequiredToPass"]
