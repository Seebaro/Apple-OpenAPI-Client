...
class GameCenterAchievementRelease(BaseModel):
    ...
    relationships: Optional[GameCenterAchievementReleaseRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['gameCenterAchievementReleases']):
            raise ValueError("must be one of enum values ('gameCenterAchievementReleases')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": GameCenterAchievementReleaseRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
