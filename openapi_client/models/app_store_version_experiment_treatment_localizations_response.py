...
class AppStoreVersionExperimentTreatmentLocalizationsResponse(BaseModel):
    ...
    included: Optional[List[AppStoreVersionExperimentTreatmentLocalizationsResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AppStoreVersionExperimentTreatmentLocalization.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [AppStoreVersionExperimentTreatmentLocalizationsResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
