...
class AppStoreVersionResponse(BaseModel):
    ...
    included: Optional[List[AppStoreVersionsResponseIncludedInner]] = None
    links: DocumentLinks
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppStoreVersion.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "included": [AppStoreVersionsResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
