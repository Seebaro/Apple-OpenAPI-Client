...
class GameCenterAchievementReleaseRelationships(BaseModel):
    """
    ...
    game_center_achievement: Optional[GameCenterAchievementReleaseRelationshipsGameCenterAchievement] = Field(default=None, alias="gameCenterAchievement")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gameCenterAchievement": GameCenterAchievementReleaseRelationshipsGameCenterAchievement.from_dict(obj["gameCenterAchievement"]) if obj.get("gameCenterAchievement") is not None else None
        })
        return _obj
