...
class DiagnosticSignatureAttributes(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["diagnosticType", "signature", "weight", "insight"]
    ...
    def diagnostic_type_validate_enum(cls, value):
        ...
        if value not in set(['DISK_WRITES', 'HANGS', 'LAUNCHES']):
            raise ValueError("must be one of enum values ('DISK_WRITES', 'HANGS', 'LAUNCHES')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "insight": DiagnosticInsight.from_dict(obj["insight"]) if obj.get("insight") is not None else None
        })
        return _obj
