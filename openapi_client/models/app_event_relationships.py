...
class AppEventRelationships(BaseModel):
    """
    AppEventRelationships
    """ # noqa: E501
    localizations: Optional[AppEventRelationshipsLocalizations] = None
    __properties: ClassVar[List[str]] = ["localizations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "localizations": AppEventRelationshipsLocalizations.from_dict(obj["localizations"]) if obj.get("localizations") is not None else None
        })
        return _obj
