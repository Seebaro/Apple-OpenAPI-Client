...
class MarketplaceWebhook(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[MarketplaceWebhookAttributes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": MarketplaceWebhookAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
