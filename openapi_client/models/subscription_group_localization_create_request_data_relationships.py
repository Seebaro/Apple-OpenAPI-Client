...
class SubscriptionGroupLocalizationCreateRequestDataRelationships(BaseModel):
    """
    SubscriptionGroupLocalizationCreateRequestDataRelationships
    """ # noqa: E501
    subscription_group: SubscriptionGroupLocalizationCreateRequestDataRelationshipsSubscriptionGroup = Field(alias="subscriptionGroup")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptionGroup": SubscriptionGroupLocalizationCreateRequestDataRelationshipsSubscriptionGroup.from_dict(obj["subscriptionGroup"]) if obj.get("subscriptionGroup") is not None else None
        })
        return _obj
