...
class GameCenterDetailCreateRequestData(BaseModel):
    """
    GameCenterDetailCreateRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: Optional[GameCenterDetailCreateRequestDataAttributes] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['gameCenterDetails']):
            raise ValueError("must be one of enum values ('gameCenterDetails')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": GameCenterDetailCreateRequestDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
