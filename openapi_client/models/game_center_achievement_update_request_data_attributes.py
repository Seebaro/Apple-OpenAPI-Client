...
class GameCenterAchievementUpdateRequestDataAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["referenceName", "points", "showBeforeEarned", "repeatable", "archived", "activityProperties"]
