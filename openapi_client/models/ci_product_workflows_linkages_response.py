...
class CiProductWorkflowsLinkagesResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[CiBuildRunRelationshipsWorkflowData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CiBuildRunRelationshipsWorkflowData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
