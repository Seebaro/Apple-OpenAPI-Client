...
class ActorAttributes(BaseModel):
    ...
    ActorAttributes
    """ # noqa: E501
    actor_type: Optional[StrictStr] = Field(default=None, alias="actorType")
    user_first_name: Optional[StrictStr] = Field(default=None, alias="userFirstName")
    user_last_name: Optional[StrictStr] = Field(default=None, alias="userLastName")
    ...
    __properties: ClassVar[List[str]] = ["actorType", "userFirstName", "userLastName", "userEmail", "apiKeyId"]
    ...
    def actor_type_validate_enum(cls, value):
        ...
        if value not in set(['USER', 'API_KEY', 'XCODE_CLOUD', 'APPLE']):
            raise ValueError("must be one of enum values ('USER', 'API_KEY', 'XCODE_CLOUD', 'APPLE')")
        return value
