...
class GameCenterActivityVersionRelationships(BaseModel):
    """
    GameCenterActivityVersionRelationships
    """ # noqa: E501
    activity: Optional[GameCenterActivityVersionRelationshipsActivity] = None
    localizations: Optional[GameCenterActivityVersionRelationshipsLocalizations] = None
    default_image: Optional[GameCenterActivityLocalizationRelationshipsImage] = Field(default=None, alias="defaultImage")
    releases: Optional[GameCenterActivityVersionRelationshipsReleases] = None
    __properties: ClassVar[List[str]] = ["activity", "localizations", "defaultImage", "releases"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": GameCenterActivityVersionRelationshipsActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "localizations": GameCenterActivityVersionRelationshipsLocalizations.from_dict(obj["localizations"]) if obj.get("localizations") is not None else None,
            "defaultImage": GameCenterActivityLocalizationRelationshipsImage.from_dict(obj["defaultImage"]) if obj.get("defaultImage") is not None else None,
            "releases": GameCenterActivityVersionRelationshipsReleases.from_dict(obj["releases"]) if obj.get("releases") is not None else None
        })
        return _obj
