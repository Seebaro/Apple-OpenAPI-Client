...
class AppScreenshotRelationshipsAppScreenshotSet(BaseModel):
    """
    AppScreenshotRelationshipsAppScreenshotSet
    """ # noqa: E501
    data: Optional[AppCustomProductPageLocalizationRelationshipsAppScreenshotSetsDataInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppCustomProductPageLocalizationRelationshipsAppScreenshotSetsDataInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
