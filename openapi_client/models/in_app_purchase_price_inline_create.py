...
class InAppPurchasePriceInlineCreate(BaseModel):
    ...
    attributes: Optional[InAppPurchasePriceInlineCreateAttributes] = None
    relationships: Optional[InAppPurchasePriceInlineCreateRelationships] = None
    __properties: ClassVar[List[str]] = ["type", "id", "attributes", "relationships"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['inAppPurchasePrices']):
            raise ValueError("must be one of enum values ('inAppPurchasePrices')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": InAppPurchasePriceInlineCreateAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": InAppPurchasePriceInlineCreateRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
