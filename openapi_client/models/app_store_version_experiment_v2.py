...
class AppStoreVersionExperimentV2(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[AppStoreVersionExperimentV2Attributes] = None
    relationships: Optional[AppStoreVersionExperimentV2Relationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": AppStoreVersionExperimentV2Attributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": AppStoreVersionExperimentV2Relationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
