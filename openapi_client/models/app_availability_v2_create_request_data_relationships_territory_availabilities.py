...
class AppAvailabilityV2CreateRequestDataRelationshipsTerritoryAvailabilities(BaseModel):
    """
    AppAvailabilityV2CreateRequestDataRelationshipsTerritoryAvailabilities
    """ # noqa: E501
    data: List[AppAvailabilityV2RelationshipsTerritoryAvailabilitiesDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AppAvailabilityV2RelationshipsTerritoryAvailabilitiesDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
