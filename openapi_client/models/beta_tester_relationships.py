...
class BetaTesterRelationships(BaseModel):
    """
    BetaTesterRelationships
    """ # noqa: E501
    apps: Optional[BetaTesterRelationshipsApps] = None
    ...
    __properties: ClassVar[List[str]] = ["apps", "betaGroups", "builds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": BetaTesterRelationshipsApps.from_dict(obj["apps"]) if obj.get("apps") is not None else None,
