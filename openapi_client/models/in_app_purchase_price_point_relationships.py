...
class InAppPurchasePricePointRelationships(BaseModel):
    """
    InAppPurchasePricePointRelationships
    """ # noqa: E501
    territory: Optional[AppPricePointV3RelationshipsTerritory] = None
    equalizations: Optional[AnalyticsReportInstanceRelationshipsSegments] = None
    __properties: ClassVar[List[str]] = ["territory", "equalizations"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of equalizations
        if self.equalizations:
            _dict['equalizations'] = self.equalizations.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "equalizations": AnalyticsReportInstanceRelationshipsSegments.from_dict(obj["equalizations"]) if obj.get("equalizations") is not None else None
        })
        return _obj
