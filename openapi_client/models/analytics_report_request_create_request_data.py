...
class AnalyticsReportRequestCreateRequestData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['analyticsReportRequests']):
            raise ValueError("must be one of enum values ('analyticsReportRequests')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": AnalyticsReportRequestCreateRequestDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
