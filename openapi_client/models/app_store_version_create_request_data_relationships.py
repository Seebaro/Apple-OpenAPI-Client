...
class AppStoreVersionCreateRequestDataRelationships(BaseModel):
    """
    AppStoreVersionCreateRequestDataRelationships
    """ # noqa: E501
    app: AccessibilityDeclarationCreateRequestDataRelationshipsApp
    app_store_version_localizations: Optional[AppStoreVersionCreateRequestDataRelationshipsAppStoreVersionLocalizations] = Field(default=None, alias="appStoreVersionLocalizations")
    build: Optional[AppStoreVersionCreateRequestDataRelationshipsBuild] = None
    __properties: ClassVar[List[str]] = ["app", "appStoreVersionLocalizations", "build"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "appStoreVersionLocalizations": AppStoreVersionCreateRequestDataRelationshipsAppStoreVersionLocalizations.from_dict(obj["appStoreVersionLocalizations"]) if obj.get("appStoreVersionLocalizations") is not None else None,
