...
class BetaAppClipInvocationRelationshipsBetaAppClipInvocationLocalizations(BaseModel):
    """
    BetaAppClipInvocationRelationshipsBetaAppClipInvocationLocalizations
    """ # noqa: E501
    meta: Optional[PagingInformation] = None
    data: Optional[List[BetaAppClipInvocationRelationshipsBetaAppClipInvocationLocalizationsDataInner]] = None
