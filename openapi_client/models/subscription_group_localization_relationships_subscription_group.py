...
class SubscriptionGroupLocalizationRelationshipsSubscriptionGroup(BaseModel):
    """
    SubscriptionGroupLocalizationRelationshipsSubscriptionGroup
    """ # noqa: E501
    data: Optional[AppRelationshipsSubscriptionGroupsDataInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppRelationshipsSubscriptionGroupsDataInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
