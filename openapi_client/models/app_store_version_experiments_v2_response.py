...
class AppStoreVersionExperimentsV2Response(BaseModel):
    ...
    included: Optional[List[AppStoreVersionExperimentsV2ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AppStoreVersionExperimentV2.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [AppStoreVersionExperimentsV2ResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
