...
class CiProductAttributes(BaseModel):
    """
    CiProductAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "createdDate", "productType"]
    ...
    def product_type_validate_enum(cls, value):
        ...
        if value not in set(['APP', 'FRAMEWORK']):
            raise ValueError("must be one of enum values ('APP', 'FRAMEWORK')")
        return value
