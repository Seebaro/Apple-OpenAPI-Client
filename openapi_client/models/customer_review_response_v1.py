...
class CustomerReviewResponseV1(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[CustomerReviewResponseV1Attributes] = None
    relationships: Optional[CustomerReviewResponseV1Relationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['customerReviewResponses']):
            raise ValueError("must be one of enum values ('customerReviewResponses')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": CustomerReviewResponseV1Attributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": CustomerReviewResponseV1Relationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
