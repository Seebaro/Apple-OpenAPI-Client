...
class SubscriptionPromotionalOfferInlineCreate(BaseModel):
    ...
    relationships: Optional[SubscriptionPromotionalOfferInlineCreateRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": SubscriptionPromotionalOfferInlineCreateAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": SubscriptionPromotionalOfferInlineCreateRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
