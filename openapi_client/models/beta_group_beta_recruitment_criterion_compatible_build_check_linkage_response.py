...
class BetaGroupBetaRecruitmentCriterionCompatibleBuildCheckLinkageResponse(BaseModel):
    ...
    """ # noqa: E501
    data: BetaGroupBetaRecruitmentCriterionCompatibleBuildCheckLinkageResponseData
    links: DocumentLinks
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": BetaGroupBetaRecruitmentCriterionCompatibleBuildCheckLinkageResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
