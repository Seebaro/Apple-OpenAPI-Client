...
class BetaPublicLinkUsagesV1MetricResponseDataInnerDataPoints(BaseModel):
    """
    BetaPublicLinkUsagesV1MetricResponseDataInnerDataPoints
    """ # noqa: E501
    start: Optional[datetime] = None
    end: Optional[datetime] = None
    values: Optional[BetaPublicLinkUsagesV1MetricResponseDataInnerDataPointsValues] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "start": obj.get("start"),
            "end": obj.get("end"),
            "values": BetaPublicLinkUsagesV1MetricResponseDataInnerDataPointsValues.from_dict(obj["values"]) if obj.get("values") is not None else None
        })
        return _obj
