...
class WebhookDeliveryRelationships(BaseModel):
    """
    WebhookDeliveryRelationships
    """ # noqa: E501
    event: Optional[WebhookDeliveryRelationshipsEvent] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event": WebhookDeliveryRelationshipsEvent.from_dict(obj["event"]) if obj.get("event") is not None else None
        })
        return _obj
