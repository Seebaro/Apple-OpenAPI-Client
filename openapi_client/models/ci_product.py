...
class CiProduct(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[CiProductAttributes] = None
    relationships: Optional[CiProductRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ciProducts']):
            raise ValueError("must be one of enum values ('ciProducts')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": CiProductAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": CiProductRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
