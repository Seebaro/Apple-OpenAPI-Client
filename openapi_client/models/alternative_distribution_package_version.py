...
class AlternativeDistributionPackageVersion(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[AlternativeDistributionPackageVersionAttributes] = None
    relationships: Optional[AlternativeDistributionPackageVersionRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['alternativeDistributionPackageVersions']):
            raise ValueError("must be one of enum values ('alternativeDistributionPackageVersions')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": AlternativeDistributionPackageVersionAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": AlternativeDistributionPackageVersionRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
