...
class BetaRecruitmentCriterionOption(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[BetaRecruitmentCriterionOptionAttributes] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['betaRecruitmentCriterionOptions']):
            raise ValueError("must be one of enum values ('betaRecruitmentCriterionOptions')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": BetaRecruitmentCriterionOptionAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
