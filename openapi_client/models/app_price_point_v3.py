...
class AppPricePointV3(BaseModel):
    ...
    relationships: Optional[AppPricePointV3Relationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": AppPricePointV3Relationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
