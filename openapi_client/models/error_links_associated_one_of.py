...
class ErrorLinksAssociatedOneOf(BaseModel):
    """
    ErrorLinksAssociatedOneOf
    """ # noqa: E501
    href: Optional[StrictStr] = None
    meta: Optional[ErrorLinksAssociatedOneOfMeta] = None
    __properties: ClassVar[List[str]] = ["href", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "href": obj.get("href"),
            "meta": ErrorLinksAssociatedOneOfMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
