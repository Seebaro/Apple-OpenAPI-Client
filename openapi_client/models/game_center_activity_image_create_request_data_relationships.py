...
class GameCenterActivityImageCreateRequestDataRelationships(BaseModel):
    """
    GameCenterActivityImageCreateRequestDataRelationships
    """ # noqa: E501
    localization: Optional[GameCenterActivityImageCreateRequestDataRelationshipsLocalization] = None
    version: Optional[GameCenterActivityImageCreateRequestDataRelationshipsVersion] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "localization": GameCenterActivityImageCreateRequestDataRelationshipsLocalization.from_dict(obj["localization"]) if obj.get("localization") is not None else None,
            "version": GameCenterActivityImageCreateRequestDataRelationshipsVersion.from_dict(obj["version"]) if obj.get("version") is not None else None
        })
        return _obj
