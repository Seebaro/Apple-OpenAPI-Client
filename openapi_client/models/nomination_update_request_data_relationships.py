...
class NominationUpdateRequestDataRelationships(BaseModel):
    """
    NominationUpdateRequestDataRelationships
    """ # noqa: E501
    related_apps: Optional[NominationUpdateRequestDataRelationshipsRelatedApps] = Field(default=None, alias="relatedApps")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "relatedApps": NominationUpdateRequestDataRelationshipsRelatedApps.from_dict(obj["relatedApps"]) if obj.get("relatedApps") is not None else None,
