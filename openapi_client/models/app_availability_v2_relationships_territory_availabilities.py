...
class AppAvailabilityV2RelationshipsTerritoryAvailabilities(BaseModel):
    """
    ...
    data: Optional[List[AppAvailabilityV2RelationshipsTerritoryAvailabilitiesDataInner]] = None
