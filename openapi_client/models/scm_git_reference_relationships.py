...
class ScmGitReferenceRelationships(BaseModel):
    """
    ScmGitReferenceRelationships
    """ # noqa: E501
    repository: Optional[ScmGitReferenceRelationshipsRepository] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "repository": ScmGitReferenceRelationshipsRepository.from_dict(obj["repository"]) if obj.get("repository") is not None else None
        })
        return _obj
