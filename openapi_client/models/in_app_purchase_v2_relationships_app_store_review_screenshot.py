...
class InAppPurchaseV2RelationshipsAppStoreReviewScreenshot(BaseModel):
    """
    InAppPurchaseV2RelationshipsAppStoreReviewScreenshot
    """ # noqa: E501
    links: Optional[RelationshipLinks] = None
    data: Optional[InAppPurchaseV2RelationshipsAppStoreReviewScreenshotData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": InAppPurchaseV2RelationshipsAppStoreReviewScreenshotData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
