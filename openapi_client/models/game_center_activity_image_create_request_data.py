...
class GameCenterActivityImageCreateRequestData(BaseModel):
    """
    GameCenterActivityImageCreateRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: AppClipAdvancedExperienceImageCreateRequestDataAttributes
    relationships: Optional[GameCenterActivityImageCreateRequestDataRelationships] = None
    __properties: ClassVar[List[str]] = ["type", "attributes", "relationships"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['gameCenterActivityImages']):
            raise ValueError("must be one of enum values ('gameCenterActivityImages')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": GameCenterActivityImageCreateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
