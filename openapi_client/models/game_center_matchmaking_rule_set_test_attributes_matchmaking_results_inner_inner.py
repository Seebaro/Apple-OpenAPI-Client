...
class GameCenterMatchmakingRuleSetTestAttributesMatchmakingResultsInnerInner(BaseModel):
    """
    GameCenterMatchmakingRuleSetTestAttributesMatchmakingResultsInnerInner
    """ # noqa: E501
    request_name: Optional[StrictStr] = Field(default=None, alias="requestName")
    team_assignments: Optional[List[GameCenterMatchmakingTeamAssignment]] = Field(default=None, alias="teamAssignments")
    __properties: ClassVar[List[str]] = ["requestName", "teamAssignments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "teamAssignments": [GameCenterMatchmakingTeamAssignment.from_dict(_item) for _item in obj["teamAssignments"]] if obj.get("teamAssignments") is not None else None
        })
        return _obj
