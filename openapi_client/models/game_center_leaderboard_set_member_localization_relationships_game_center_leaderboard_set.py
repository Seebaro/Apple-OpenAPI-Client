...
class GameCenterLeaderboardSetMemberLocalizationRelationshipsGameCenterLeaderboardSet(BaseModel):
    """
    GameCenterLeaderboardSetMemberLocalizationRelationshipsGameCenterLeaderboardSet
    """ # noqa: E501
    links: Optional[RelationshipLinks] = None
    data: Optional[GameCenterDetailRelationshipsGameCenterLeaderboardSetsDataInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GameCenterDetailRelationshipsGameCenterLeaderboardSetsDataInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
