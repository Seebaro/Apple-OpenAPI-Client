...
class BetaFeedbackScreenshotSubmissionsResponse(BaseModel):
    ...
    included: Optional[List[BetaFeedbackCrashSubmissionsResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BetaFeedbackScreenshotSubmission.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [BetaFeedbackCrashSubmissionsResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
