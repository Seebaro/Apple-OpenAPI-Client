...
class BackgroundAssetVersionCreateRequestData(BaseModel):
    """
    BackgroundAssetVersionCreateRequestData
    """ # noqa: E501
    type: StrictStr
    relationships: BackgroundAssetVersionCreateRequestDataRelationships
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "relationships": BackgroundAssetVersionCreateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
