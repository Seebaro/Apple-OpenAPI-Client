...
class AppCustomProductPageLocalizationRelationshipsAppPreviewSets(BaseModel):
    """
    ...
    data: Optional[List[AppCustomProductPageLocalizationRelationshipsAppPreviewSetsDataInner]] = None
