...
class AppStoreVersionExperimentTreatmentRelationshipsAppStoreVersionExperimentTreatmentLocalizations(BaseModel):
    """
    ...
    data: Optional[List[AppPreviewSetRelationshipsAppStoreVersionExperimentTreatmentLocalizationData]] = None
