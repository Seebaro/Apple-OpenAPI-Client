...
class BuildBundleFileSizeAttributes(BaseModel):
    """
    ...
    download_bytes: Optional[StrictInt] = Field(default=None, alias="downloadBytes")
    install_bytes: Optional[StrictInt] = Field(default=None, alias="installBytes")
    __properties: ClassVar[List[str]] = ["deviceModel", "osVersion", "downloadBytes", "installBytes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "installBytes": obj.get("installBytes")
        })
        return _obj
