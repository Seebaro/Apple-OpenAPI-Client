...
class AppPriceV2(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[AppPriceV2Attributes] = None
    relationships: Optional[AppPriceV2Relationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['appPrices']):
            raise ValueError("must be one of enum values ('appPrices')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": AppPriceV2Attributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": AppPriceV2Relationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
