...
class InAppPurchaseAppStoreReviewScreenshotRelationshipsInAppPurchaseV2(BaseModel):
    """
    InAppPurchaseAppStoreReviewScreenshotRelationshipsInAppPurchaseV2
    """ # noqa: E501
    data: Optional[AppRelationshipsInAppPurchasesDataInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppRelationshipsInAppPurchasesDataInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
