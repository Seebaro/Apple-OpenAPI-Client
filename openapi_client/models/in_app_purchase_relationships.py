...
class InAppPurchaseRelationships(BaseModel):
    """
    InAppPurchaseRelationships
    """ # noqa: E501
    apps: Optional[InAppPurchaseRelationshipsApps] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": InAppPurchaseRelationshipsApps.from_dict(obj["apps"]) if obj.get("apps") is not None else None
        })
        return _obj
