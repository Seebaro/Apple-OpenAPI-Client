...
class SubscriptionPromotionalOfferInlineCreateAttributes(BaseModel):
    """
    ...
    offer_code: StrictStr = Field(alias="offerCode")
    offer_mode: SubscriptionOfferMode = Field(alias="offerMode")
    __properties: ClassVar[List[str]] = ["duration", "name", "numberOfPeriods", "offerCode", "offerMode"]
