...
class AppClipAppStoreReviewDetailCreateRequestData(BaseModel):
    """
    AppClipAppStoreReviewDetailCreateRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: Optional[AppClipAppStoreReviewDetailAttributes] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['appClipAppStoreReviewDetails']):
            raise ValueError("must be one of enum values ('appClipAppStoreReviewDetails')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": AppClipAppStoreReviewDetailAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": AppClipAppStoreReviewDetailCreateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
