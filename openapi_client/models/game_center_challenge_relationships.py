...
class GameCenterChallengeRelationships(BaseModel):
    """
    ...
    versions: Optional[GameCenterChallengeRelationshipsVersions] = None
    leaderboard: Optional[GameCenterChallengeRelationshipsLeaderboard] = None
    __properties: ClassVar[List[str]] = ["gameCenterDetail", "gameCenterGroup", "versions", "leaderboard"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": GameCenterChallengeRelationshipsVersions.from_dict(obj["versions"]) if obj.get("versions") is not None else None,
            "leaderboard": GameCenterChallengeRelationshipsLeaderboard.from_dict(obj["leaderboard"]) if obj.get("leaderboard") is not None else None
        })
        return _obj
