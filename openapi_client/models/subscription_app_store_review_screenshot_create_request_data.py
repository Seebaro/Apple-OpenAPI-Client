...
class SubscriptionAppStoreReviewScreenshotCreateRequestData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['subscriptionAppStoreReviewScreenshots']):
            raise ValueError("must be one of enum values ('subscriptionAppStoreReviewScreenshots')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": SubscriptionAppStoreReviewScreenshotCreateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
