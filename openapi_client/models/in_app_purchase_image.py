...
class InAppPurchaseImage(BaseModel):
    ...
    relationships: Optional[InAppPurchaseImageRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['inAppPurchaseImages']):
            raise ValueError("must be one of enum values ('inAppPurchaseImages')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": InAppPurchaseImageRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
