...
class AnalyticsReportRequestRelationships(BaseModel):
    """
    AnalyticsReportRequestRelationships
    """ # noqa: E501
    reports: Optional[AnalyticsReportRequestRelationshipsReports] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reports": AnalyticsReportRequestRelationshipsReports.from_dict(obj["reports"]) if obj.get("reports") is not None else None
        })
        return _obj
