...
class GameCenterChallengeCreateRequestData(BaseModel):
    """
    GameCenterChallengeCreateRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: GameCenterChallengeCreateRequestDataAttributes
    relationships: Optional[GameCenterChallengeCreateRequestDataRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": GameCenterChallengeCreateRequestDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": GameCenterChallengeCreateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
