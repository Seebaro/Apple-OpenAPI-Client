...
class GameCenterChallengeVersionReleaseCreateRequestDataRelationships(BaseModel):
    """
    ...
    version: GameCenterChallengeLocalizationCreateRequestDataRelationshipsVersion
    __properties: ClassVar[List[str]] = ["gameCenterDetail", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "version": GameCenterChallengeLocalizationCreateRequestDataRelationshipsVersion.from_dict(obj["version"]) if obj.get("version") is not None else None
        })
        return _obj
