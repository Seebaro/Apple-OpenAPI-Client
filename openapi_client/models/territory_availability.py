...
class TerritoryAvailability(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[TerritoryAvailabilityAttributes] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['territoryAvailabilities']):
            raise ValueError("must be one of enum values ('territoryAvailabilities')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": TerritoryAvailabilityAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
