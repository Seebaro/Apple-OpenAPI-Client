...
class SandboxTesterV2(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[SandboxTesterV2Attributes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": SandboxTesterV2Attributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
