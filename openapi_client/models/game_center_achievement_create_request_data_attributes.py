...
class GameCenterAchievementCreateRequestDataAttributes(BaseModel):
    """
    ...
    points: StrictInt
    show_before_earned: StrictBool = Field(alias="showBeforeEarned")
    repeatable: StrictBool
    activity_properties: Optional[Dict[str, StrictStr]] = Field(default=None, alias="activityProperties")
    __properties: ClassVar[List[str]] = ["referenceName", "vendorIdentifier", "points", "showBeforeEarned", "repeatable", "activityProperties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "showBeforeEarned": obj.get("showBeforeEarned"),
