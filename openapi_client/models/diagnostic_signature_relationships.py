...
class DiagnosticSignatureRelationships(BaseModel):
    """
    DiagnosticSignatureRelationships
    """ # noqa: E501
    logs: Optional[AnalyticsReportInstanceRelationshipsSegments] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": AnalyticsReportInstanceRelationshipsSegments.from_dict(obj["logs"]) if obj.get("logs") is not None else None
        })
        return _obj
