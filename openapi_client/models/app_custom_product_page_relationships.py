...
class AppCustomProductPageRelationships(BaseModel):
    """
    AppCustomProductPageRelationships
    """ # noqa: E501
    app: Optional[AlternativeDistributionKeyCreateRequestDataRelationshipsApp] = None
    app_custom_product_page_versions: Optional[AppCustomProductPageRelationshipsAppCustomProductPageVersions] = Field(default=None, alias="appCustomProductPageVersions")
    __properties: ClassVar[List[str]] = ["app", "appCustomProductPageVersions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "appCustomProductPageVersions": AppCustomProductPageRelationshipsAppCustomProductPageVersions.from_dict(obj["appCustomProductPageVersions"]) if obj.get("appCustomProductPageVersions") is not None else None
        })
        return _obj
