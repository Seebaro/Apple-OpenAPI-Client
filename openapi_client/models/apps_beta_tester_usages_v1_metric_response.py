...
class AppsBetaTesterUsagesV1MetricResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[AppsBetaTesterUsagesV1MetricResponseDataInner]
    links: PagedDocumentLinks
    meta: Optional[PagingInformation] = None
    included: Optional[List[BetaTester]] = None
    __properties: ClassVar[List[str]] = ["data", "links", "meta", "included"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AppsBetaTesterUsagesV1MetricResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            ...
            "included": [BetaTester.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None
        })
        return _obj
