...
class AppStoreVersionExperimentTreatment(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[AppStoreVersionExperimentTreatmentAttributes] = None
    relationships: Optional[AppStoreVersionExperimentTreatmentRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": AppStoreVersionExperimentTreatmentAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": AppStoreVersionExperimentTreatmentRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
