...
class AppCustomProductPageLocalizationRelationshipsAppScreenshotSets(BaseModel):
    """
    ...
    data: Optional[List[AppCustomProductPageLocalizationRelationshipsAppScreenshotSetsDataInner]] = None
