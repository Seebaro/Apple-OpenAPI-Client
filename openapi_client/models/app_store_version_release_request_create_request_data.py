...
class AppStoreVersionReleaseRequestCreateRequestData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['appStoreVersionReleaseRequests']):
            raise ValueError("must be one of enum values ('appStoreVersionReleaseRequests')")
        return value
