...
class MarketplaceWebhookUpdateRequestData(BaseModel):
    """
    MarketplaceWebhookUpdateRequestData
    """ # noqa: E501
    type: StrictStr
    id: StrictStr
    attributes: Optional[MarketplaceWebhookUpdateRequestDataAttributes] = None
    __properties: ClassVar[List[str]] = ["type", "id", "attributes"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['marketplaceWebhooks']):
            raise ValueError("must be one of enum values ('marketplaceWebhooks')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": MarketplaceWebhookUpdateRequestDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
