...
class SubscriptionOfferCodeCustomCodeAttributes(BaseModel):
    """
    SubscriptionOfferCodeCustomCodeAttributes
    """ # noqa: E501
    custom_code: Optional[StrictStr] = Field(default=None, alias="customCode")
    number_of_codes: Optional[StrictInt] = Field(default=None, alias="numberOfCodes")
    created_date: Optional[datetime] = Field(default=None, alias="createdDate")
    expiration_date: Optional[date] = Field(default=None, alias="expirationDate")
    active: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["customCode", "numberOfCodes", "createdDate", "expirationDate", "active"]
