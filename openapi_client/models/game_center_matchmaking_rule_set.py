...
class GameCenterMatchmakingRuleSet(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[GameCenterMatchmakingRuleSetAttributes] = None
    relationships: Optional[GameCenterMatchmakingRuleSetRelationships] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['gameCenterMatchmakingRuleSets']):
            raise ValueError("must be one of enum values ('gameCenterMatchmakingRuleSets')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": GameCenterMatchmakingRuleSetAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": GameCenterMatchmakingRuleSetRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
