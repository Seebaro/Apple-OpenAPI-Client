...
class GameCenterChallengeCreateRequestDataRelationships(BaseModel):
    """
    ...
    leaderboard: Optional[GameCenterChallengeCreateRequestDataRelationshipsLeaderboard] = None
    __properties: ClassVar[List[str]] = ["gameCenterDetail", "gameCenterGroup", "leaderboard"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "leaderboard": GameCenterChallengeCreateRequestDataRelationshipsLeaderboard.from_dict(obj["leaderboard"]) if obj.get("leaderboard") is not None else None
        })
        return _obj
