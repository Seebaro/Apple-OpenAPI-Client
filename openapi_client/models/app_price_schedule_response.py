...
class AppPriceScheduleResponse(BaseModel):
    ...
    included: Optional[List[AppPriceScheduleResponseIncludedInner]] = None
    links: DocumentLinks
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppPriceSchedule.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "included": [AppPriceScheduleResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
