...
class AppsBetaTesterUsagesV1MetricResponseDataInnerDimensionsBetaTesters(BaseModel):
    """
    AppsBetaTesterUsagesV1MetricResponseDataInnerDimensionsBetaTesters
    """ # noqa: E501
    links: Optional[AppsBetaTesterUsagesV1MetricResponseDataInnerDimensionsBetaTestersLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": AppsBetaTesterUsagesV1MetricResponseDataInnerDimensionsBetaTestersLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "data": obj.get("data")
        })
        return _obj
