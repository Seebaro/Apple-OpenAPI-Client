...
class GameCenterMatchmakingRuleSetUpdateRequestData(BaseModel):
    """
    GameCenterMatchmakingRuleSetUpdateRequestData
    """ # noqa: E501
    type: StrictStr
    id: StrictStr
    attributes: Optional[GameCenterMatchmakingRuleSetUpdateRequestDataAttributes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": GameCenterMatchmakingRuleSetUpdateRequestDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
