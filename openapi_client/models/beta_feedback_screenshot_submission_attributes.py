...
class BetaFeedbackScreenshotSubmissionAttributes(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "screenshots": [BetaFeedbackScreenshotImage.from_dict(_item) for _item in obj["screenshots"]] if obj.get("screenshots") is not None else None
        })
        return _obj
