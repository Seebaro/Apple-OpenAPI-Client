...
class BundleIdCreateRequestDataAttributes(BaseModel):
    """
    ...
    seed_id: Optional[StrictStr] = Field(default=None, alias="seedId")
    __properties: ClassVar[List[str]] = ["name", "platform", "identifier", "seedId"]
