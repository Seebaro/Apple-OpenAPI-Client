...
class GameCenterActivityLocalizationCreateRequestData(BaseModel):
    """
    GameCenterActivityLocalizationCreateRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: GameCenterActivityLocalizationCreateRequestDataAttributes
    relationships: GameCenterActivityLocalizationCreateRequestDataRelationships
    __properties: ClassVar[List[str]] = ["type", "attributes", "relationships"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['gameCenterActivityLocalizations']):
            raise ValueError("must be one of enum values ('gameCenterActivityLocalizations')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": GameCenterActivityLocalizationCreateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
