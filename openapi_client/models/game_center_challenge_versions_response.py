...
class GameCenterChallengeVersionsResponse(BaseModel):
    ...
    included: Optional[List[GameCenterChallengeVersionsResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GameCenterChallengeVersion.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [GameCenterChallengeVersionsResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
