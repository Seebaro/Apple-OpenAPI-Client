...
class WebhookPingCreateRequestDataRelationshipsWebhook(BaseModel):
    """
    WebhookPingCreateRequestDataRelationshipsWebhook
    """ # noqa: E501
    data: WebhookPingCreateRequestDataRelationshipsWebhookData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": WebhookPingCreateRequestDataRelationshipsWebhookData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
