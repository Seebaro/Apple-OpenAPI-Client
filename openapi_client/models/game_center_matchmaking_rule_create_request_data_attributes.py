...
class GameCenterMatchmakingRuleCreateRequestDataAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["referenceName", "description", "type", "expression", "weight"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['COMPATIBLE', 'DISTANCE', 'MATCH', 'TEAM']):
            raise ValueError("must be one of enum values ('COMPATIBLE', 'DISTANCE', 'MATCH', 'TEAM')")
        return value
