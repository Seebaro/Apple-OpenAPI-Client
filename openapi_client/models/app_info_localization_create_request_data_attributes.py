...
class AppInfoLocalizationCreateRequestDataAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["locale", "name", "subtitle", "privacyPolicyUrl", "privacyChoicesUrl", "privacyPolicyText"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "privacyChoicesUrl": obj.get("privacyChoicesUrl"),
