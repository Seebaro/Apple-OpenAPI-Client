...
class AppUpdateRequestDataAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accessibilityUrl", "bundleId", "primaryLocale", "subscriptionStatusUrl", "subscriptionStatusUrlVersion", "subscriptionStatusUrlForSandbox", "subscriptionStatusUrlVersionForSandbox", "contentRightsDeclaration", "streamlinedPurchasingEnabled"]
