...
class AppStoreVersionCustomerReviewsLinkagesResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[CustomerReviewResponseV1RelationshipsReviewData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CustomerReviewResponseV1RelationshipsReviewData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
