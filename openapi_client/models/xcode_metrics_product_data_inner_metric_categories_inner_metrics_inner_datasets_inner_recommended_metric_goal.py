...
class XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInnerRecommendedMetricGoal(BaseModel):
    """
    XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInnerRecommendedMetricGoal
    """ # noqa: E501
    value: Optional[Union[StrictFloat, StrictInt]] = None
    detail: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["value", "detail"]
