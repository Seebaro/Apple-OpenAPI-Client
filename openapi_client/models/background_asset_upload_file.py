...
class BackgroundAssetUploadFile(BaseModel):
    ...
    type: StrictStr
    id: StrictStr
    attributes: Optional[BackgroundAssetUploadFileAttributes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": BackgroundAssetUploadFileAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
