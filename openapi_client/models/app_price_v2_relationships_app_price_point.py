...
class AppPriceV2RelationshipsAppPricePoint(BaseModel):
    """
    AppPriceV2RelationshipsAppPricePoint
    """ # noqa: E501
    data: Optional[AppPriceV2RelationshipsAppPricePointData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppPriceV2RelationshipsAppPricePointData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
