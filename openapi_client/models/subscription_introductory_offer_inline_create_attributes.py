...
class SubscriptionIntroductoryOfferInlineCreateAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["startDate", "endDate", "duration", "offerMode", "numberOfPeriods"]
