...
class GameCenterActivityLocalizationRelationships(BaseModel):
    """
    ...
    image: Optional[GameCenterActivityLocalizationRelationshipsImage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image": GameCenterActivityLocalizationRelationshipsImage.from_dict(obj["image"]) if obj.get("image") is not None else None
        })
        return _obj
