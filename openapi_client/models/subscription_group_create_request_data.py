...
class SubscriptionGroupCreateRequestData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['subscriptionGroups']):
            raise ValueError("must be one of enum values ('subscriptionGroups')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": SubscriptionGroupCreateRequestDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
