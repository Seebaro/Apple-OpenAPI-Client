...
class DiagnosticSignaturesApi:
    ...
    def diagnostic_signatures_logs_get_to_many_related(
        ...
        _param = self._diagnostic_signatures_logs_get_to_many_related_serialize(
            id=id,
            limit=limit,
    ...
    @validate_call
    def diagnostic_signatures_logs_get_to_many_related_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def diagnostic_signatures_logs_get_to_many_related_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
    ...
    def _diagnostic_signatures_logs_get_to_many_related_serialize(
        self,
        id,
        limit,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/diagnosticSignatures/{id}/logs',
