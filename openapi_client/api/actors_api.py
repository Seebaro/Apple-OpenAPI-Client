...
class ActorsApi:
    ...
    @validate_call
    def actors_get_collection(
        self,
        filter_id: Annotated[List[StrictStr], Field(description="filter by id(s)")],
        ...
        :param filter_id: filter by id(s) (required)
        ...
        _param = self._actors_get_collection_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def actors_get_collection_with_http_info(
        self,
        filter_id: Annotated[List[StrictStr], Field(description="filter by id(s)")],
        fields_actors: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type actors")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
    ...
    @validate_call
    def actors_get_collection_without_preload_content(
        self,
        filter_id: Annotated[List[StrictStr], Field(description="filter by id(s)")],
        fields_actors: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type actors")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
    ...
    def _actors_get_collection_serialize(
        self,
        filter_id,
        fields_actors,
        limit,
    ...
    def actors_get_instance(
        ...
        _param = self._actors_get_instance_serialize(
            id=id,
            fields_actors=fields_actors,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def actors_get_instance_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_actors: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type actors")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def actors_get_instance_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_actors: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type actors")] = None,
        _request_timeout: Union[
    ...
    def _actors_get_instance_serialize(
        self,
        id,
        fields_actors,
        _request_auth,
