...
class PreReleaseVersionsApi:
    ...
    @validate_call
    def pre_release_versions_app_get_to_one_relationship(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._pre_release_versions_app_get_to_one_relationship_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def pre_release_versions_app_get_to_one_relationship_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrereleaseVersionAppLinkageResponse]:
        """pre_release_versions_app_get_to_one_relationship
    ...
    @validate_call
    def pre_release_versions_app_get_to_one_relationship_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        _request_timeout: Union[
            None,
    ...
    def _pre_release_versions_app_get_to_one_relationship_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/preReleaseVersions/{id}/relationships/app',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def pre_release_versions_builds_get_to_many_relationship(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
        ...
        _param = self._pre_release_versions_builds_get_to_many_relationship_serialize(
            id=id,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "ErrorResponse",
            '404': "ErrorResponse",
            '200': "PrereleaseVersionBuildsLinkagesResponse",
            '429': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def pre_release_versions_builds_get_to_many_relationship_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrereleaseVersionBuildsLinkagesResponse]:
        """pre_release_versions_builds_get_to_many_relationship
    ...
    @validate_call
    def pre_release_versions_builds_get_to_many_relationship_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
    ...
    def _pre_release_versions_builds_get_to_many_relationship_serialize(
        self,
        id,
        limit,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/preReleaseVersions/{id}/relationships/builds',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def pre_release_versions_get_collection(
        self,
        filter_builds_build_audience_type: Annotated[Optional[List[StrictStr]], Field(description="filter by attribute 'builds.buildAudienceType'")] = None,
        ...
        filter_builds_version: Annotated[Optional[List[StrictStr]], Field(description="filter by attribute 'builds.version'")] = None,
        ...
        :param filter_builds_build_audience_type: filter by attribute 'builds.buildAudienceType'
        :type filter_builds_build_audience_type: List[str]
        ...
        :param filter_builds_version: filter by attribute 'builds.version'
        :type filter_builds_version: List[str]
        ...
        _param = self._pre_release_versions_get_collection_serialize(
            ...
            filter_builds_version=filter_builds_version,
    ...
    def _pre_release_versions_get_collection_serialize(
        self,
        filter_builds_build_audience_type,
        filter_builds_expired,
        filter_builds_processing_state,
        filter_builds_version,
        filter_platform,
        filter_version,
        filter_app,
        filter_builds,
        ...
        _collection_formats: Dict[str, str] = {
            'filter[builds.buildAudienceType]': 'csv',
            'filter[builds.expired]': 'csv',
            'filter[builds.processingState]': 'csv',
            'filter[builds.version]': 'csv',
            'filter[platform]': 'csv',
            'filter[version]': 'csv',
            'filter[app]': 'csv',
            'filter[builds]': 'csv',
        ...
        # process the path parameters
        # process the query parameters
        if filter_builds_build_audience_type is not None:
            
            _query_params.append(('filter[builds.buildAudienceType]', filter_builds_build_audience_type))
        ...
        if filter_builds_version is not None:
            ...
            _query_params.append(('filter[builds.version]', filter_builds_version))
