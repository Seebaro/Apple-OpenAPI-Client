...
class TerritoriesApi:
    ...
    def territories_get_collection(
        ...
        _param = self._territories_get_collection_serialize(
    ...
    @validate_call
    def territories_get_collection_with_http_info(
        self,
        fields_territories: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type territories")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def territories_get_collection_without_preload_content(
        self,
        fields_territories: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type territories")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
    ...
    def _territories_get_collection_serialize(
        self,
        fields_territories,
        limit,
        _request_auth,
