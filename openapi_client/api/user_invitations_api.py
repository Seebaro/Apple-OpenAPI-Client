...
class UserInvitationsApi:
    ...
    @validate_call
    def user_invitations_visible_apps_get_to_many_relationship(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
        ...
        _param = self._user_invitations_visible_apps_get_to_many_relationship_serialize(
            id=id,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "ErrorResponse",
            '404': "ErrorResponse",
            '200': "UserInvitationVisibleAppsLinkagesResponse",
            '429': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def user_invitations_visible_apps_get_to_many_relationship_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserInvitationVisibleAppsLinkagesResponse]:
        """user_invitations_visible_apps_get_to_many_relationship
    ...
    @validate_call
    def user_invitations_visible_apps_get_to_many_relationship_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
    ...
    def _user_invitations_visible_apps_get_to_many_relationship_serialize(
        self,
        id,
        limit,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/userInvitations/{id}/relationships/visibleApps',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
