...
class SubscriptionAvailabilitiesApi:
    ...
    @validate_call
    def subscription_availabilities_available_territories_get_to_many_related(
        self,
        ...
        _param = self._subscription_availabilities_available_territories_get_to_many_related_serialize(
            id=id,
    ...
    @validate_call
    def subscription_availabilities_available_territories_get_to_many_related_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_territories: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type territories")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
    ...
    @validate_call
    def subscription_availabilities_available_territories_get_to_many_related_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_territories: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type territories")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
    ...
    def _subscription_availabilities_available_territories_get_to_many_related_serialize(
        self,
        id,
        fields_territories,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/subscriptionAvailabilities/{id}/availableTerritories',
    ...
    @validate_call
    def subscription_availabilities_available_territories_get_to_many_relationship(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
        ...
        _param = self._subscription_availabilities_available_territories_get_to_many_relationship_serialize(
            id=id,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "ErrorResponse",
            '404': "ErrorResponse",
            '200': "SubscriptionAvailabilityAvailableTerritoriesLinkagesResponse",
            '429': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def subscription_availabilities_available_territories_get_to_many_relationship_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SubscriptionAvailabilityAvailableTerritoriesLinkagesResponse]:
        """subscription_availabilities_available_territories_get_to_many_relationship
    ...
    @validate_call
    def subscription_availabilities_available_territories_get_to_many_relationship_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
    ...
    def _subscription_availabilities_available_territories_get_to_many_relationship_serialize(
        self,
        id,
        limit,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/subscriptionAvailabilities/{id}/relationships/availableTerritories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def subscription_availabilities_create_instance(
        self,
        subscription_availability_create_request: Annotated[SubscriptionAvailabilityCreateRequest, Field(description="SubscriptionAvailability representation")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param subscription_availability_create_request: SubscriptionAvailability representation (required)
        :type subscription_availability_create_request: SubscriptionAvailabilityCreateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._subscription_availabilities_create_instance_serialize(
            subscription_availability_create_request=subscription_availability_create_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def subscription_availabilities_create_instance_with_http_info(
        self,
        subscription_availability_create_request: Annotated[SubscriptionAvailabilityCreateRequest, Field(description="SubscriptionAvailability representation")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def subscription_availabilities_create_instance_without_preload_content(
        self,
        subscription_availability_create_request: Annotated[SubscriptionAvailabilityCreateRequest, Field(description="SubscriptionAvailability representation")],
        _request_timeout: Union[
            None,
    ...
    def _subscription_availabilities_create_instance_serialize(
        self,
        subscription_availability_create_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if subscription_availability_create_request is not None:
            _body_params = subscription_availability_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/subscriptionAvailabilities',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def subscription_availabilities_get_instance(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        ...
        _param = self._subscription_availabilities_get_instance_serialize(
            id=id,
    ...
    @validate_call
    def subscription_availabilities_get_instance_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_subscription_availabilities: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type subscriptionAvailabilities")] = None,
        fields_territories: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type territories")] = None,
    ...
    @validate_call
    def subscription_availabilities_get_instance_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_subscription_availabilities: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type subscriptionAvailabilities")] = None,
        fields_territories: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type territories")] = None,
    ...
    def _subscription_availabilities_get_instance_serialize(
        self,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/subscriptionAvailabilities/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
