...
class InAppPurchaseContentsApi:
    ...
    @validate_call
    def in_app_purchase_contents_get_instance(
        self,
        ...
        _param = self._in_app_purchase_contents_get_instance_serialize(
            id=id,
    ...
    @validate_call
    def in_app_purchase_contents_get_instance_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_in_app_purchase_contents: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type inAppPurchaseContents")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
    ...
    @validate_call
    def in_app_purchase_contents_get_instance_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_in_app_purchase_contents: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type inAppPurchaseContents")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
    ...
    def _in_app_purchase_contents_get_instance_serialize(
        self,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/inAppPurchaseContents/{id}',
