...
class ScmPullRequestsApi:
    ...
    @validate_call
    def scm_pull_requests_get_instance(
        self,
        ...
        _param = self._scm_pull_requests_get_instance_serialize(
            id=id,
    ...
    @validate_call
    def scm_pull_requests_get_instance_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_scm_pull_requests: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type scmPullRequests")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ScmPullRequestResponse]:
        """scm_pull_requests_get_instance
    ...
    @validate_call
    def scm_pull_requests_get_instance_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_scm_pull_requests: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type scmPullRequests")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
    ...
    def _scm_pull_requests_get_instance_serialize(
        self,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/scmPullRequests/{id}',
