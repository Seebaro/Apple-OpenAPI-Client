...
class SubscriptionPricePointsApi:
    ...
    @validate_call
    def subscription_price_points_equalizations_get_to_many_related(
        self,
        ...
        filter_subscription: Annotated[Optional[List[StrictStr]], Field(description="filter by id(s) of related 'subscription'")] = None,
        ...
        :param filter_subscription: filter by id(s) of related 'subscription'
        :type filter_subscription: List[str]
        ...
        _param = self._subscription_price_points_equalizations_get_to_many_related_serialize(
            id=id,
    ...
    @validate_call
    def subscription_price_points_equalizations_get_to_many_related_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        filter_territory: Annotated[Optional[List[StrictStr]], Field(description="filter by id(s) of related 'territory'")] = None,
        filter_subscription: Annotated[Optional[List[StrictStr]], Field(description="filter by id(s) of related 'subscription'")] = None,
    ...
    @validate_call
    def subscription_price_points_equalizations_get_to_many_related_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        filter_territory: Annotated[Optional[List[StrictStr]], Field(description="filter by id(s) of related 'territory'")] = None,
        filter_subscription: Annotated[Optional[List[StrictStr]], Field(description="filter by id(s) of related 'subscription'")] = None,
    ...
    def _subscription_price_points_equalizations_get_to_many_related_serialize(
        self,
        id,
        filter_territory,
        filter_subscription,
        ...
        if filter_subscription is not None:
            ...
            _query_params.append(('filter[subscription]', filter_subscription))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/subscriptionPricePoints/{id}/equalizations',
    ...
    @validate_call
    def subscription_price_points_equalizations_get_to_many_relationship(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=8000, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
        ...
        _param = self._subscription_price_points_equalizations_get_to_many_relationship_serialize(
            id=id,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "ErrorResponse",
            '404': "ErrorResponse",
            '200': "SubscriptionPricePointEqualizationsLinkagesResponse",
            '429': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def subscription_price_points_equalizations_get_to_many_relationship_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=8000, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SubscriptionPricePointEqualizationsLinkagesResponse]:
        """subscription_price_points_equalizations_get_to_many_relationship
    ...
    @validate_call
    def subscription_price_points_equalizations_get_to_many_relationship_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=8000, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
    ...
    def _subscription_price_points_equalizations_get_to_many_relationship_serialize(
        self,
        id,
        limit,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/subscriptionPricePoints/{id}/relationships/equalizations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def subscription_price_points_get_instance(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_subscription_price_points: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type subscriptionPricePoints")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
        ...
        _param = self._subscription_price_points_get_instance_serialize(
            id=id,
            fields_subscription_price_points=fields_subscription_price_points,
            include=include,
            _request_auth=_request_auth,
    ...
    @validate_call
    def subscription_price_points_get_instance_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_subscription_price_points: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type subscriptionPricePoints")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SubscriptionPricePointResponse]:
        """subscription_price_points_get_instance
    ...
    @validate_call
    def subscription_price_points_get_instance_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_subscription_price_points: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type subscriptionPricePoints")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
    ...
    def _subscription_price_points_get_instance_serialize(
        self,
        id,
        fields_subscription_price_points,
        include,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/subscriptionPricePoints/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
