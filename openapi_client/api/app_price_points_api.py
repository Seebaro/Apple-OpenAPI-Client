...
class AppPricePointsApi:
    ...
    @validate_call
    def app_price_points_v3_equalizations_get_to_many_related(
        self,
        ...
        _param = self._app_price_points_v3_equalizations_get_to_many_related_serialize(
            id=id,
    ...
    @validate_call
    def app_price_points_v3_equalizations_get_to_many_related_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        filter_territory: Annotated[Optional[List[StrictStr]], Field(description="filter by id(s) of related 'territory'")] = None,
        fields_app_price_points: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type appPricePoints")] = None,
    ...
    @validate_call
    def app_price_points_v3_equalizations_get_to_many_related_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        filter_territory: Annotated[Optional[List[StrictStr]], Field(description="filter by id(s) of related 'territory'")] = None,
        fields_app_price_points: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type appPricePoints")] = None,
    ...
    def _app_price_points_v3_equalizations_get_to_many_related_serialize(
        self,
        id,
        filter_territory,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/appPricePoints/{id}/equalizations',
    ...
    @validate_call
    def app_price_points_v3_equalizations_get_to_many_relationship(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
        ...
        _param = self._app_price_points_v3_equalizations_get_to_many_relationship_serialize(
            id=id,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "ErrorResponse",
            '404': "ErrorResponse",
            '200': "AppPricePointV3EqualizationsLinkagesResponse",
            '429': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def app_price_points_v3_equalizations_get_to_many_relationship_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AppPricePointV3EqualizationsLinkagesResponse]:
        """app_price_points_v3_equalizations_get_to_many_relationship
    ...
    @validate_call
    def app_price_points_v3_equalizations_get_to_many_relationship_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="maximum resources per page")] = None,
        _request_timeout: Union[
    ...
    def _app_price_points_v3_equalizations_get_to_many_relationship_serialize(
        self,
        id,
        limit,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/appPricePoints/{id}/relationships/equalizations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def app_price_points_v3_get_instance(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_app_price_points: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type appPricePoints")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
        ...
        _param = self._app_price_points_v3_get_instance_serialize(
            id=id,
            fields_app_price_points=fields_app_price_points,
            include=include,
            _request_auth=_request_auth,
    ...
    @validate_call
    def app_price_points_v3_get_instance_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_app_price_points: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type appPricePoints")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AppPricePointV3Response]:
        """app_price_points_v3_get_instance
    ...
    @validate_call
    def app_price_points_v3_get_instance_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_app_price_points: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type appPricePoints")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
    ...
    def _app_price_points_v3_get_instance_serialize(
        self,
        id,
        fields_app_price_points,
        include,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/appPricePoints/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
