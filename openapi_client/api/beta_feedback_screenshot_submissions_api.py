...
class BetaFeedbackScreenshotSubmissionsApi:
    ...
    @validate_call
    def beta_feedback_screenshot_submissions_delete_instance(
        self,
        ...
        _param = self._beta_feedback_screenshot_submissions_delete_instance_serialize(
            id=id,
    ...
    @validate_call
    def beta_feedback_screenshot_submissions_delete_instance_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def beta_feedback_screenshot_submissions_delete_instance_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        _request_timeout: Union[
            None,
    ...
    def _beta_feedback_screenshot_submissions_delete_instance_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/betaFeedbackScreenshotSubmissions/{id}',
    ...
    @validate_call
    def beta_feedback_screenshot_submissions_get_instance(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        ...
        _param = self._beta_feedback_screenshot_submissions_get_instance_serialize(
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "ErrorResponse",
            '404': "ErrorResponse",
            '200': "BetaFeedbackScreenshotSubmissionResponse",
            '429': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def beta_feedback_screenshot_submissions_get_instance_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_beta_feedback_screenshot_submissions: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type betaFeedbackScreenshotSubmissions")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BetaFeedbackScreenshotSubmissionResponse]:
        """beta_feedback_screenshot_submissions_get_instance
    ...
    @validate_call
    def beta_feedback_screenshot_submissions_get_instance_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_beta_feedback_screenshot_submissions: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type betaFeedbackScreenshotSubmissions")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="comma-separated list of relationships to include")] = None,
    ...
    def _beta_feedback_screenshot_submissions_get_instance_serialize(
        self,
        id,
