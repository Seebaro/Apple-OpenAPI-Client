...
class CustomerReviewsApi:
    ...
    @validate_call
    def customer_reviews_get_instance(
        self,
        ...
        _param = self._customer_reviews_get_instance_serialize(
            id=id,
    ...
    @validate_call
    def customer_reviews_get_instance_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_customer_reviews: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type customerReviews")] = None,
        fields_customer_review_responses: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type customerReviewResponses")] = None,
    ...
    @validate_call
    def customer_reviews_get_instance_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_customer_reviews: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type customerReviews")] = None,
        fields_customer_review_responses: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type customerReviewResponses")] = None,
    ...
    def _customer_reviews_get_instance_serialize(
        self,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/customerReviews/{id}',
    ...
    @validate_call
    def customer_reviews_response_get_to_one_related(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_customer_review_responses: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type customerReviewResponses")] = None,
        fields_customer_reviews: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type customerReviews")] = None,
        ...
        _param = self._customer_reviews_response_get_to_one_related_serialize(
            id=id,
            fields_customer_review_responses=fields_customer_review_responses,
            fields_customer_reviews=fields_customer_reviews,
            include=include,
    ...
    @validate_call
    def customer_reviews_response_get_to_one_related_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_customer_review_responses: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type customerReviewResponses")] = None,
        fields_customer_reviews: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type customerReviews")] = None,
    ...
    @validate_call
    def customer_reviews_response_get_to_one_related_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        fields_customer_review_responses: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type customerReviewResponses")] = None,
        fields_customer_reviews: Annotated[Optional[List[StrictStr]], Field(description="the fields to include for returned resources of type customerReviews")] = None,
    ...
    def _customer_reviews_response_get_to_one_related_serialize(
        self,
        id,
        fields_customer_review_responses,
        fields_customer_reviews,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/customerReviews/{id}/response',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def customer_reviews_response_get_to_one_relationship(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._customer_reviews_response_get_to_one_relationship_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "ErrorResponse",
            '404': "ErrorResponse",
            '200': "CustomerReviewResponseLinkageResponse",
            '429': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def customer_reviews_response_get_to_one_relationship_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomerReviewResponseLinkageResponse]:
        """customer_reviews_response_get_to_one_relationship
    ...
    @validate_call
    def customer_reviews_response_get_to_one_relationship_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="the id of the requested resource")],
        _request_timeout: Union[
            None,
    ...
    def _customer_reviews_response_get_to_one_relationship_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/customerReviews/{id}/relationships/response',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
