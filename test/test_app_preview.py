...
class TestAppPreview(unittest.TestCase):
    """AppPreview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPreview:
        """Test AppPreview
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPreview`
        """
        model = AppPreview()
        if include_optional:
            return AppPreview(
