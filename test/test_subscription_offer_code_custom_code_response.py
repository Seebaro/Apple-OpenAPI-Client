...
class TestSubscriptionOfferCodeCustomCodeResponse(unittest.TestCase):
    """SubscriptionOfferCodeCustomCodeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionOfferCodeCustomCodeResponse:
        """Test SubscriptionOfferCodeCustomCodeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionOfferCodeCustomCodeResponse`
        """
        model = SubscriptionOfferCodeCustomCodeResponse()
        if include_optional:
            return SubscriptionOfferCodeCustomCodeResponse(
                data = openapi_client.models.subscription_offer_code_custom_code.SubscriptionOfferCodeCustomCode(
    ...
    def testSubscriptionOfferCodeCustomCodeResponse(self):
        """Test SubscriptionOfferCodeCustomCodeResponse"""
