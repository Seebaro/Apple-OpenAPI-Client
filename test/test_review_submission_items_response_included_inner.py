...
class TestReviewSubmissionItemsResponseIncludedInner(unittest.TestCase):
    """ReviewSubmissionItemsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewSubmissionItemsResponseIncludedInner:
        """Test ReviewSubmissionItemsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewSubmissionItemsResponseIncludedInner`
        """
        model = ReviewSubmissionItemsResponseIncludedInner()
        if include_optional:
    ...
    def testReviewSubmissionItemsResponseIncludedInner(self):
        """Test ReviewSubmissionItemsResponseIncludedInner"""
