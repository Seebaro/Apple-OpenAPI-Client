...
class TestBetaTesterCreateRequestData(unittest.TestCase):
    """BetaTesterCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaTesterCreateRequestData:
        """Test BetaTesterCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaTesterCreateRequestData`
        """
        model = BetaTesterCreateRequestData()
        if include_optional:
            return BetaTesterCreateRequestData(
                type = 'betaTesters',
    ...
    def testBetaTesterCreateRequestData(self):
        """Test BetaTesterCreateRequestData"""
