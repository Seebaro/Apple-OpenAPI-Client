...
class TestAppInfoResponse(unittest.TestCase):
    """AppInfoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppInfoResponse:
        """Test AppInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppInfoResponse`
        """
        model = AppInfoResponse()
        if include_optional:
            return AppInfoResponse(
                data = openapi_client.models.app_info.AppInfo(
                    type = 'appInfos', 
                    id = '', 
