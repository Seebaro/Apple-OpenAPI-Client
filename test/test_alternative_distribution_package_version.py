...
class TestAlternativeDistributionPackageVersion(unittest.TestCase):
    """AlternativeDistributionPackageVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlternativeDistributionPackageVersion:
        """Test AlternativeDistributionPackageVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlternativeDistributionPackageVersion`
        """
        model = AlternativeDistributionPackageVersion()
        if include_optional:
            return AlternativeDistributionPackageVersion(
    ...
    def testAlternativeDistributionPackageVersion(self):
        """Test AlternativeDistributionPackageVersion"""
