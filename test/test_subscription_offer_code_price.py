...
class TestSubscriptionOfferCodePrice(unittest.TestCase):
    """SubscriptionOfferCodePrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionOfferCodePrice:
        """Test SubscriptionOfferCodePrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionOfferCodePrice`
        """
        model = SubscriptionOfferCodePrice()
        if include_optional:
            return SubscriptionOfferCodePrice(
    ...
    def testSubscriptionOfferCodePrice(self):
        """Test SubscriptionOfferCodePrice"""
