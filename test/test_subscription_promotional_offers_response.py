...
class TestSubscriptionPromotionalOffersResponse(unittest.TestCase):
    """SubscriptionPromotionalOffersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionPromotionalOffersResponse:
        """Test SubscriptionPromotionalOffersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionPromotionalOffersResponse`
        """
        model = SubscriptionPromotionalOffersResponse()
        if include_optional:
            return SubscriptionPromotionalOffersResponse(
                data = [
                    openapi_client.models.subscription_promotional_offer.SubscriptionPromotionalOffer(
    ...
    def testSubscriptionPromotionalOffersResponse(self):
        """Test SubscriptionPromotionalOffersResponse"""
