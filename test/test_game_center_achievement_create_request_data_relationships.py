...
class TestGameCenterAchievementCreateRequestDataRelationships(unittest.TestCase):
    """GameCenterAchievementCreateRequestDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterAchievementCreateRequestDataRelationships:
        """Test GameCenterAchievementCreateRequestDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterAchievementCreateRequestDataRelationships`
        """
        model = GameCenterAchievementCreateRequestDataRelationships()
        if include_optional:
            return GameCenterAchievementCreateRequestDataRelationships(
    ...
    def testGameCenterAchievementCreateRequestDataRelationships(self):
        """Test GameCenterAchievementCreateRequestDataRelationships"""
