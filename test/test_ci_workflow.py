...
class TestCiWorkflow(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CiWorkflow:
        """Test CiWorkflow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiWorkflow`
        """
        model = CiWorkflow()
        if include_optional:
            return CiWorkflow(
