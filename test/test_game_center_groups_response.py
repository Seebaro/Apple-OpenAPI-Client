...
class TestGameCenterGroupsResponse(unittest.TestCase):
    """GameCenterGroupsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterGroupsResponse:
        """Test GameCenterGroupsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterGroupsResponse`
        """
        model = GameCenterGroupsResponse()
        if include_optional:
            return GameCenterGroupsResponse(
                data = [
                    openapi_client.models.game_center_group.GameCenterGroup(
    ...
    def testGameCenterGroupsResponse(self):
        """Test GameCenterGroupsResponse"""
