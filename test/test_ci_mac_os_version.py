...
class TestCiMacOsVersion(unittest.TestCase):
    """CiMacOsVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiMacOsVersion:
        """Test CiMacOsVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiMacOsVersion`
        """
        model = CiMacOsVersion()
        if include_optional:
            return CiMacOsVersion(
