...
class TestAppStoreVersionLocalizationsResponseIncludedInner(unittest.TestCase):
    """AppStoreVersionLocalizationsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppStoreVersionLocalizationsResponseIncludedInner:
        """Test AppStoreVersionLocalizationsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppStoreVersionLocalizationsResponseIncludedInner`
        """
        model = AppStoreVersionLocalizationsResponseIncludedInner()
        if include_optional:
    ...
    def testAppStoreVersionLocalizationsResponseIncludedInner(self):
        """Test AppStoreVersionLocalizationsResponseIncludedInner"""
