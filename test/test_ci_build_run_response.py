...
class TestCiBuildRunResponse(unittest.TestCase):
    """CiBuildRunResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiBuildRunResponse:
        """Test CiBuildRunResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiBuildRunResponse`
        """
        model = CiBuildRunResponse()
        if include_optional:
            return CiBuildRunResponse(
                data = openapi_client.models.ci_build_run.CiBuildRun(
                    type = 'ciBuildRuns', 
                    id = '', 
    ...
    def testCiBuildRunResponse(self):
        """Test CiBuildRunResponse"""
