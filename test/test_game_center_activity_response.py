...
class TestGameCenterActivityResponse(unittest.TestCase):
    """GameCenterActivityResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterActivityResponse:
        """Test GameCenterActivityResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterActivityResponse`
        """
        model = GameCenterActivityResponse()
        if include_optional:
            return GameCenterActivityResponse(
                data = openapi_client.models.game_center_activity.GameCenterActivity(
    ...
    def testGameCenterActivityResponse(self):
        """Test GameCenterActivityResponse"""
