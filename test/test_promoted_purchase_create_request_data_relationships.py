...
class TestPromotedPurchaseCreateRequestDataRelationships(unittest.TestCase):
    """PromotedPurchaseCreateRequestDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromotedPurchaseCreateRequestDataRelationships:
        """Test PromotedPurchaseCreateRequestDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromotedPurchaseCreateRequestDataRelationships`
        """
        model = PromotedPurchaseCreateRequestDataRelationships()
        if include_optional:
            return PromotedPurchaseCreateRequestDataRelationships(
    ...
    def testPromotedPurchaseCreateRequestDataRelationships(self):
        """Test PromotedPurchaseCreateRequestDataRelationships"""
