...
class TestCiWorkflowCreateRequest(unittest.TestCase):
    """CiWorkflowCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiWorkflowCreateRequest:
        """Test CiWorkflowCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiWorkflowCreateRequest`
        """
        model = CiWorkflowCreateRequest()
        if include_optional:
            return CiWorkflowCreateRequest(
                data = openapi_client.models.ci_workflow_create_request_data.CiWorkflowCreateRequest_data(
                    type = 'ciWorkflows', 
    ...
    def testCiWorkflowCreateRequest(self):
        """Test CiWorkflowCreateRequest"""
