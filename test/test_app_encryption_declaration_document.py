...
class TestAppEncryptionDeclarationDocument(unittest.TestCase):
    """AppEncryptionDeclarationDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEncryptionDeclarationDocument:
        """Test AppEncryptionDeclarationDocument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEncryptionDeclarationDocument`
        """
        model = AppEncryptionDeclarationDocument()
        if include_optional:
    ...
    def testAppEncryptionDeclarationDocument(self):
        """Test AppEncryptionDeclarationDocument"""
