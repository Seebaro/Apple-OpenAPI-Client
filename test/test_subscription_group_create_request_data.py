...
class TestSubscriptionGroupCreateRequestData(unittest.TestCase):
    """SubscriptionGroupCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionGroupCreateRequestData:
        """Test SubscriptionGroupCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionGroupCreateRequestData`
        """
        model = SubscriptionGroupCreateRequestData()
        if include_optional:
            return SubscriptionGroupCreateRequestData(
    ...
    def testSubscriptionGroupCreateRequestData(self):
        """Test SubscriptionGroupCreateRequestData"""
