...
class TestGameCenterMatchmakingQueuesResponse(unittest.TestCase):
    """GameCenterMatchmakingQueuesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterMatchmakingQueuesResponse:
        """Test GameCenterMatchmakingQueuesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterMatchmakingQueuesResponse`
        """
        model = GameCenterMatchmakingQueuesResponse()
        if include_optional:
            return GameCenterMatchmakingQueuesResponse(
                data = [
                    openapi_client.models.game_center_matchmaking_queue.GameCenterMatchmakingQueue(
    ...
    def testGameCenterMatchmakingQueuesResponse(self):
        """Test GameCenterMatchmakingQueuesResponse"""
