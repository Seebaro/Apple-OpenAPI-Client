...
class TestInAppPurchaseImage(unittest.TestCase):
    """InAppPurchaseImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InAppPurchaseImage:
        """Test InAppPurchaseImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InAppPurchaseImage`
        """
        model = InAppPurchaseImage()
        if include_optional:
    ...
    def testInAppPurchaseImage(self):
        """Test InAppPurchaseImage"""
