...
class TestSubscriptionIntroductoryOfferResponse(unittest.TestCase):
    """SubscriptionIntroductoryOfferResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionIntroductoryOfferResponse:
        """Test SubscriptionIntroductoryOfferResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionIntroductoryOfferResponse`
        """
        model = SubscriptionIntroductoryOfferResponse()
        if include_optional:
            return SubscriptionIntroductoryOfferResponse(
                data = openapi_client.models.subscription_introductory_offer.SubscriptionIntroductoryOffer(
    ...
    def testSubscriptionIntroductoryOfferResponse(self):
        """Test SubscriptionIntroductoryOfferResponse"""
