...
class TestSubscriptionGroupResponse(unittest.TestCase):
    """SubscriptionGroupResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionGroupResponse:
        """Test SubscriptionGroupResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionGroupResponse`
        """
        model = SubscriptionGroupResponse()
        if include_optional:
            return SubscriptionGroupResponse(
                data = openapi_client.models.subscription_group.SubscriptionGroup(
    ...
    def testSubscriptionGroupResponse(self):
        """Test SubscriptionGroupResponse"""
