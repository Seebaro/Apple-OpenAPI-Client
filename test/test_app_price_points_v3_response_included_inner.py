...
class TestAppPricePointsV3ResponseIncludedInner(unittest.TestCase):
    """AppPricePointsV3ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPricePointsV3ResponseIncludedInner:
        """Test AppPricePointsV3ResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPricePointsV3ResponseIncludedInner`
        """
        model = AppPricePointsV3ResponseIncludedInner()
        if include_optional:
            return AppPricePointsV3ResponseIncludedInner(
                type = 'apps',
                id = '',
    ...
    def testAppPricePointsV3ResponseIncludedInner(self):
        """Test AppPricePointsV3ResponseIncludedInner"""
