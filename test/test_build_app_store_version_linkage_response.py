...
class TestBuildAppStoreVersionLinkageResponse(unittest.TestCase):
    """BuildAppStoreVersionLinkageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuildAppStoreVersionLinkageResponse:
        """Test BuildAppStoreVersionLinkageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildAppStoreVersionLinkageResponse`
        """
        model = BuildAppStoreVersionLinkageResponse()
        if include_optional:
    ...
    def testBuildAppStoreVersionLinkageResponse(self):
        """Test BuildAppStoreVersionLinkageResponse"""
