...
class TestAppStoreVersionExperimentTreatmentLocalizationsResponseIncludedInner(unittest.TestCase):
    """AppStoreVersionExperimentTreatmentLocalizationsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppStoreVersionExperimentTreatmentLocalizationsResponseIncludedInner:
        """Test AppStoreVersionExperimentTreatmentLocalizationsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppStoreVersionExperimentTreatmentLocalizationsResponseIncludedInner`
        """
        model = AppStoreVersionExperimentTreatmentLocalizationsResponseIncludedInner()
        if include_optional:
    ...
    def testAppStoreVersionExperimentTreatmentLocalizationsResponseIncludedInner(self):
        """Test AppStoreVersionExperimentTreatmentLocalizationsResponseIncludedInner"""
