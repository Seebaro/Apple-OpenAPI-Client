...
class TestAppPreviewSetCreateRequest(unittest.TestCase):
    """AppPreviewSetCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPreviewSetCreateRequest:
        """Test AppPreviewSetCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPreviewSetCreateRequest`
        """
        model = AppPreviewSetCreateRequest()
        if include_optional:
            return AppPreviewSetCreateRequest(
                data = openapi_client.models.app_preview_set_create_request_data.AppPreviewSetCreateRequest_data(
                    type = 'appPreviewSets', 
    ...
    def testAppPreviewSetCreateRequest(self):
        """Test AppPreviewSetCreateRequest"""
