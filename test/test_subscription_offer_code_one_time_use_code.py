...
class TestSubscriptionOfferCodeOneTimeUseCode(unittest.TestCase):
    """SubscriptionOfferCodeOneTimeUseCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionOfferCodeOneTimeUseCode:
        """Test SubscriptionOfferCodeOneTimeUseCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionOfferCodeOneTimeUseCode`
        """
        model = SubscriptionOfferCodeOneTimeUseCode()
        if include_optional:
    ...
    def testSubscriptionOfferCodeOneTimeUseCode(self):
        """Test SubscriptionOfferCodeOneTimeUseCode"""
