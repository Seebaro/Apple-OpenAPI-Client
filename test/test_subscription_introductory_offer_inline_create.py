...
class TestSubscriptionIntroductoryOfferInlineCreate(unittest.TestCase):
    """SubscriptionIntroductoryOfferInlineCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionIntroductoryOfferInlineCreate:
        """Test SubscriptionIntroductoryOfferInlineCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionIntroductoryOfferInlineCreate`
        """
        model = SubscriptionIntroductoryOfferInlineCreate()
        if include_optional:
    ...
    def testSubscriptionIntroductoryOfferInlineCreate(self):
        """Test SubscriptionIntroductoryOfferInlineCreate"""
