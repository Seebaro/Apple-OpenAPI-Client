...
class TestAgeRatingDeclarationWithoutIncludesResponse(unittest.TestCase):
    """AgeRatingDeclarationWithoutIncludesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgeRatingDeclarationWithoutIncludesResponse:
        """Test AgeRatingDeclarationWithoutIncludesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgeRatingDeclarationWithoutIncludesResponse`
        """
        model = AgeRatingDeclarationWithoutIncludesResponse()
        if include_optional:
            return AgeRatingDeclarationWithoutIncludesResponse(
                data = openapi_client.models.age_rating_declaration.AgeRatingDeclaration(
    ...
    def testAgeRatingDeclarationWithoutIncludesResponse(self):
        """Test AgeRatingDeclarationWithoutIncludesResponse"""
