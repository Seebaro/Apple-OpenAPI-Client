...
class TestAppEventCreateRequest(unittest.TestCase):
    """AppEventCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEventCreateRequest:
        """Test AppEventCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEventCreateRequest`
        """
        model = AppEventCreateRequest()
        if include_optional:
            return AppEventCreateRequest(
                data = openapi_client.models.app_event_create_request_data.AppEventCreateRequest_data(
                    type = 'appEvents', 
    ...
    def testAppEventCreateRequest(self):
        """Test AppEventCreateRequest"""
