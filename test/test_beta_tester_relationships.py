...
class TestBetaTesterRelationships(unittest.TestCase):
    """BetaTesterRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaTesterRelationships:
        """Test BetaTesterRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaTesterRelationships`
        """
        model = BetaTesterRelationships()
        if include_optional:
            return BetaTesterRelationships(
    ...
    def testBetaTesterRelationships(self):
        """Test BetaTesterRelationships"""
