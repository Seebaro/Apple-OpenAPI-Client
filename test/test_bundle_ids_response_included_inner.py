...
class TestBundleIdsResponseIncludedInner(unittest.TestCase):
    """BundleIdsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BundleIdsResponseIncludedInner:
        """Test BundleIdsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BundleIdsResponseIncludedInner`
        """
        model = BundleIdsResponseIncludedInner()
        if include_optional:
    ...
    def testBundleIdsResponseIncludedInner(self):
        """Test BundleIdsResponseIncludedInner"""
