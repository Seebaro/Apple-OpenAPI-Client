...
class TestInAppPurchasePricePointsResponse(unittest.TestCase):
    """InAppPurchasePricePointsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InAppPurchasePricePointsResponse:
        """Test InAppPurchasePricePointsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InAppPurchasePricePointsResponse`
        """
        model = InAppPurchasePricePointsResponse()
        if include_optional:
            return InAppPurchasePricePointsResponse(
                data = [
                    openapi_client.models.in_app_purchase_price_point.InAppPurchasePricePoint(
    ...
    def testInAppPurchasePricePointsResponse(self):
        """Test InAppPurchasePricePointsResponse"""
