...
class TestAppWithoutIncludesResponse(unittest.TestCase):
    """AppWithoutIncludesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppWithoutIncludesResponse:
        """Test AppWithoutIncludesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppWithoutIncludesResponse`
        """
        model = AppWithoutIncludesResponse()
        if include_optional:
    ...
    def testAppWithoutIncludesResponse(self):
        """Test AppWithoutIncludesResponse"""
