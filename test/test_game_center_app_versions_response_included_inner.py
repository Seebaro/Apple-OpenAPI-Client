...
class TestGameCenterAppVersionsResponseIncludedInner(unittest.TestCase):
    """GameCenterAppVersionsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterAppVersionsResponseIncludedInner:
        """Test GameCenterAppVersionsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterAppVersionsResponseIncludedInner`
        """
        model = GameCenterAppVersionsResponseIncludedInner()
        if include_optional:
    ...
    def testGameCenterAppVersionsResponseIncludedInner(self):
        """Test GameCenterAppVersionsResponseIncludedInner"""
