...
class TestRoutingAppCoverageResponse(unittest.TestCase):
    """RoutingAppCoverageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingAppCoverageResponse:
        """Test RoutingAppCoverageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingAppCoverageResponse`
        """
        model = RoutingAppCoverageResponse()
        if include_optional:
    ...
    def testRoutingAppCoverageResponse(self):
        """Test RoutingAppCoverageResponse"""
