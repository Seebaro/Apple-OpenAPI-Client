...
class TestBetaGroupResponse(unittest.TestCase):
    """BetaGroupResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaGroupResponse:
        """Test BetaGroupResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaGroupResponse`
        """
        model = BetaGroupResponse()
        if include_optional:
            return BetaGroupResponse(
                data = openapi_client.models.beta_group.BetaGroup(
                    type = 'betaGroups', 
                    id = '', 
    ...
    def testBetaGroupResponse(self):
        """Test BetaGroupResponse"""
