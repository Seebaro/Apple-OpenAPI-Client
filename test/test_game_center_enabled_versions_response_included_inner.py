...
class TestGameCenterEnabledVersionsResponseIncludedInner(unittest.TestCase):
    """GameCenterEnabledVersionsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterEnabledVersionsResponseIncludedInner:
        """Test GameCenterEnabledVersionsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterEnabledVersionsResponseIncludedInner`
        """
        model = GameCenterEnabledVersionsResponseIncludedInner()
        if include_optional:
    ...
    def testGameCenterEnabledVersionsResponseIncludedInner(self):
        """Test GameCenterEnabledVersionsResponseIncludedInner"""
