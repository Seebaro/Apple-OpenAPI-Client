...
class TestInAppPurchaseV2(unittest.TestCase):
    """InAppPurchaseV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InAppPurchaseV2:
        """Test InAppPurchaseV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InAppPurchaseV2`
        """
        model = InAppPurchaseV2()
        if include_optional:
