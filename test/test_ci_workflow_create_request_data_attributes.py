...
class TestCiWorkflowCreateRequestDataAttributes(unittest.TestCase):
    """CiWorkflowCreateRequestDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiWorkflowCreateRequestDataAttributes:
        """Test CiWorkflowCreateRequestDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiWorkflowCreateRequestDataAttributes`
        """
        model = CiWorkflowCreateRequestDataAttributes()
        if include_optional:
            return CiWorkflowCreateRequestDataAttributes(
                name = '',
                description = '',
    ...
    def testCiWorkflowCreateRequestDataAttributes(self):
        """Test CiWorkflowCreateRequestDataAttributes"""
