...
class TestBackgroundAssetCreateRequestData(unittest.TestCase):
    """BackgroundAssetCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackgroundAssetCreateRequestData:
        """Test BackgroundAssetCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackgroundAssetCreateRequestData`
        """
        model = BackgroundAssetCreateRequestData()
        if include_optional:
            return BackgroundAssetCreateRequestData(
    ...
    def testBackgroundAssetCreateRequestData(self):
        """Test BackgroundAssetCreateRequestData"""
