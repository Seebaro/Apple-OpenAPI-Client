...
class TestAppClipAdvancedExperienceUpdateRequestDataAttributes(unittest.TestCase):
    """AppClipAdvancedExperienceUpdateRequestDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppClipAdvancedExperienceUpdateRequestDataAttributes:
        """Test AppClipAdvancedExperienceUpdateRequestDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppClipAdvancedExperienceUpdateRequestDataAttributes`
        """
        model = AppClipAdvancedExperienceUpdateRequestDataAttributes()
        if include_optional:
            return AppClipAdvancedExperienceUpdateRequestDataAttributes(
                action = 'OPEN',
                is_powered_by = True,
    ...
    def testAppClipAdvancedExperienceUpdateRequestDataAttributes(self):
        """Test AppClipAdvancedExperienceUpdateRequestDataAttributes"""
