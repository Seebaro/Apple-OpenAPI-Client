...
class TestAppsResponse(unittest.TestCase):
    """AppsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppsResponse:
        """Test AppsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppsResponse`
        """
        model = AppsResponse()
        if include_optional:
            return AppsResponse(
