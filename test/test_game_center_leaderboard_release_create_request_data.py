...
class TestGameCenterLeaderboardReleaseCreateRequestData(unittest.TestCase):
    """GameCenterLeaderboardReleaseCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterLeaderboardReleaseCreateRequestData:
        """Test GameCenterLeaderboardReleaseCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterLeaderboardReleaseCreateRequestData`
        """
        model = GameCenterLeaderboardReleaseCreateRequestData()
        if include_optional:
            return GameCenterLeaderboardReleaseCreateRequestData(
    ...
    def testGameCenterLeaderboardReleaseCreateRequestData(self):
        """Test GameCenterLeaderboardReleaseCreateRequestData"""
