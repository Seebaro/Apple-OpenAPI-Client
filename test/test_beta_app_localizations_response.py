...
class TestBetaAppLocalizationsResponse(unittest.TestCase):
    """BetaAppLocalizationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaAppLocalizationsResponse:
        """Test BetaAppLocalizationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaAppLocalizationsResponse`
        """
        model = BetaAppLocalizationsResponse()
        if include_optional:
    ...
    def testBetaAppLocalizationsResponse(self):
        """Test BetaAppLocalizationsResponse"""
