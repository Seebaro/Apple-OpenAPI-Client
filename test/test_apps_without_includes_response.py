...
class TestAppsWithoutIncludesResponse(unittest.TestCase):
    """AppsWithoutIncludesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppsWithoutIncludesResponse:
        """Test AppsWithoutIncludesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppsWithoutIncludesResponse`
        """
        model = AppsWithoutIncludesResponse()
        if include_optional:
    ...
    def testAppsWithoutIncludesResponse(self):
        """Test AppsWithoutIncludesResponse"""
