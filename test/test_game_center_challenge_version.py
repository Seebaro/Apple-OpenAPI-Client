...
class TestGameCenterChallengeVersion(unittest.TestCase):
    """GameCenterChallengeVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterChallengeVersion:
        """Test GameCenterChallengeVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterChallengeVersion`
        """
        model = GameCenterChallengeVersion()
        if include_optional:
    ...
    def testGameCenterChallengeVersion(self):
        """Test GameCenterChallengeVersion"""
