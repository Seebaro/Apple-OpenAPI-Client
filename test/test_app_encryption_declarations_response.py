...
class TestAppEncryptionDeclarationsResponse(unittest.TestCase):
    """AppEncryptionDeclarationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEncryptionDeclarationsResponse:
        """Test AppEncryptionDeclarationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEncryptionDeclarationsResponse`
        """
        model = AppEncryptionDeclarationsResponse()
        if include_optional:
            return AppEncryptionDeclarationsResponse(
                data = [
                    openapi_client.models.app_encryption_declaration.AppEncryptionDeclaration(
    ...
    def testAppEncryptionDeclarationsResponse(self):
        """Test AppEncryptionDeclarationsResponse"""
