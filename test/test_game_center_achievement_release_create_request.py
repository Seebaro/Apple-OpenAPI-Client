...
class TestGameCenterAchievementReleaseCreateRequest(unittest.TestCase):
    """GameCenterAchievementReleaseCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterAchievementReleaseCreateRequest:
        """Test GameCenterAchievementReleaseCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterAchievementReleaseCreateRequest`
        """
        model = GameCenterAchievementReleaseCreateRequest()
        if include_optional:
            return GameCenterAchievementReleaseCreateRequest(
                data = openapi_client.models.game_center_achievement_release_create_request_data.GameCenterAchievementReleaseCreateRequest_data(
                    type = 'gameCenterAchievementReleases', 
                    relationships = openapi_client.models.game_center_achievement_release_create_request_data_relationships.GameCenterAchievementReleaseCreateRequest_data_relationships(
    ...
    def testGameCenterAchievementReleaseCreateRequest(self):
        """Test GameCenterAchievementReleaseCreateRequest"""
