...
class TestCiWorkflowUpdateRequestData(unittest.TestCase):
    """CiWorkflowUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiWorkflowUpdateRequestData:
        """Test CiWorkflowUpdateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiWorkflowUpdateRequestData`
        """
        model = CiWorkflowUpdateRequestData()
        if include_optional:
            return CiWorkflowUpdateRequestData(
                type = 'ciWorkflows',
                id = '',
    ...
    def testCiWorkflowUpdateRequestData(self):
        """Test CiWorkflowUpdateRequestData"""
