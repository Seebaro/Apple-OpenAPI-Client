...
class TestCiWorkflowResponse(unittest.TestCase):
    """CiWorkflowResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiWorkflowResponse:
        """Test CiWorkflowResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiWorkflowResponse`
        """
        model = CiWorkflowResponse()
        if include_optional:
            return CiWorkflowResponse(
                data = openapi_client.models.ci_workflow.CiWorkflow(
                    type = 'ciWorkflows', 
                    id = '', 
    ...
    def testCiWorkflowResponse(self):
        """Test CiWorkflowResponse"""
