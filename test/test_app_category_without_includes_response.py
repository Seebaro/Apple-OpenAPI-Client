...
class TestAppCategoryWithoutIncludesResponse(unittest.TestCase):
    """AppCategoryWithoutIncludesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppCategoryWithoutIncludesResponse:
        """Test AppCategoryWithoutIncludesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppCategoryWithoutIncludesResponse`
        """
        model = AppCategoryWithoutIncludesResponse()
        if include_optional:
    ...
    def testAppCategoryWithoutIncludesResponse(self):
        """Test AppCategoryWithoutIncludesResponse"""
