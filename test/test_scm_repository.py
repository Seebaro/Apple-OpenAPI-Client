...
class TestScmRepository(unittest.TestCase):
    """ScmRepository unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScmRepository:
        """Test ScmRepository
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScmRepository`
        """
        model = ScmRepository()
        if include_optional:
