...
class TestGameCenterAchievementLocalizationsResponseIncludedInner(unittest.TestCase):
    """GameCenterAchievementLocalizationsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterAchievementLocalizationsResponseIncludedInner:
        """Test GameCenterAchievementLocalizationsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterAchievementLocalizationsResponseIncludedInner`
        """
        model = GameCenterAchievementLocalizationsResponseIncludedInner()
        if include_optional:
    ...
    def testGameCenterAchievementLocalizationsResponseIncludedInner(self):
        """Test GameCenterAchievementLocalizationsResponseIncludedInner"""
