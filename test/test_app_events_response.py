...
class TestAppEventsResponse(unittest.TestCase):
    """AppEventsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEventsResponse:
        """Test AppEventsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEventsResponse`
        """
        model = AppEventsResponse()
        if include_optional:
            return AppEventsResponse(
                data = [
                    openapi_client.models.app_event.AppEvent(
                        type = 'appEvents', 
                        id = '', 
    ...
    def testAppEventsResponse(self):
        """Test AppEventsResponse"""
