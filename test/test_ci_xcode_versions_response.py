...
class TestCiXcodeVersionsResponse(unittest.TestCase):
    """CiXcodeVersionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiXcodeVersionsResponse:
        """Test CiXcodeVersionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiXcodeVersionsResponse`
        """
        model = CiXcodeVersionsResponse()
        if include_optional:
    ...
    def testCiXcodeVersionsResponse(self):
        """Test CiXcodeVersionsResponse"""
