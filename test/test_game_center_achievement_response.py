...
class TestGameCenterAchievementResponse(unittest.TestCase):
    """GameCenterAchievementResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterAchievementResponse:
        """Test GameCenterAchievementResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterAchievementResponse`
        """
        model = GameCenterAchievementResponse()
        if include_optional:
            return GameCenterAchievementResponse(
                data = openapi_client.models.game_center_achievement.GameCenterAchievement(
    ...
    def testGameCenterAchievementResponse(self):
        """Test GameCenterAchievementResponse"""
