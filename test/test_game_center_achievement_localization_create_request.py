...
class TestGameCenterAchievementLocalizationCreateRequest(unittest.TestCase):
    """GameCenterAchievementLocalizationCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterAchievementLocalizationCreateRequest:
        """Test GameCenterAchievementLocalizationCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterAchievementLocalizationCreateRequest`
        """
        model = GameCenterAchievementLocalizationCreateRequest()
        if include_optional:
            return GameCenterAchievementLocalizationCreateRequest(
                data = openapi_client.models.game_center_achievement_localization_create_request_data.GameCenterAchievementLocalizationCreateRequest_data(
    ...
    def testGameCenterAchievementLocalizationCreateRequest(self):
        """Test GameCenterAchievementLocalizationCreateRequest"""
