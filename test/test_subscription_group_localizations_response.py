...
class TestSubscriptionGroupLocalizationsResponse(unittest.TestCase):
    """SubscriptionGroupLocalizationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionGroupLocalizationsResponse:
        """Test SubscriptionGroupLocalizationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionGroupLocalizationsResponse`
        """
        model = SubscriptionGroupLocalizationsResponse()
        if include_optional:
            return SubscriptionGroupLocalizationsResponse(
                data = [
                    openapi_client.models.subscription_group_localization.SubscriptionGroupLocalization(
    ...
    def testSubscriptionGroupLocalizationsResponse(self):
        """Test SubscriptionGroupLocalizationsResponse"""
