...
class TestGameCenterDetailResponse(unittest.TestCase):
    """GameCenterDetailResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterDetailResponse:
        """Test GameCenterDetailResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterDetailResponse`
        """
        model = GameCenterDetailResponse()
        if include_optional:
            return GameCenterDetailResponse(
                data = openapi_client.models.game_center_detail.GameCenterDetail(
    ...
    def testGameCenterDetailResponse(self):
        """Test GameCenterDetailResponse"""
