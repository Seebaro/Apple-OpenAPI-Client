...
class TestSubscriptionSubmissionResponse(unittest.TestCase):
    """SubscriptionSubmissionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionSubmissionResponse:
        """Test SubscriptionSubmissionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionSubmissionResponse`
        """
        model = SubscriptionSubmissionResponse()
        if include_optional:
            return SubscriptionSubmissionResponse(
                data = openapi_client.models.subscription_submission.SubscriptionSubmission(
    ...
    def testSubscriptionSubmissionResponse(self):
        """Test SubscriptionSubmissionResponse"""
