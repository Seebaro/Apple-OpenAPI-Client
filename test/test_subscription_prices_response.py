...
class TestSubscriptionPricesResponse(unittest.TestCase):
    """SubscriptionPricesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionPricesResponse:
        """Test SubscriptionPricesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionPricesResponse`
        """
        model = SubscriptionPricesResponse()
        if include_optional:
            return SubscriptionPricesResponse(
                data = [
                    openapi_client.models.subscription_price.SubscriptionPrice(
                        type = 'subscriptionPrices', 
                        id = '', 
                        attributes = openapi_client.models.subscription_price_attributes.SubscriptionPrice_attributes(
    ...
    def testSubscriptionPricesResponse(self):
        """Test SubscriptionPricesResponse"""
