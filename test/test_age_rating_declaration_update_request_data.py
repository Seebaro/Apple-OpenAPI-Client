...
class TestAgeRatingDeclarationUpdateRequestData(unittest.TestCase):
    """AgeRatingDeclarationUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgeRatingDeclarationUpdateRequestData:
        """Test AgeRatingDeclarationUpdateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgeRatingDeclarationUpdateRequestData`
        """
        model = AgeRatingDeclarationUpdateRequestData()
        if include_optional:
            return AgeRatingDeclarationUpdateRequestData(
    ...
    def testAgeRatingDeclarationUpdateRequestData(self):
        """Test AgeRatingDeclarationUpdateRequestData"""
