...
class TestCiWorkflowsResponse(unittest.TestCase):
    """CiWorkflowsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiWorkflowsResponse:
        """Test CiWorkflowsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiWorkflowsResponse`
        """
        model = CiWorkflowsResponse()
        if include_optional:
            return CiWorkflowsResponse(
                data = [
                    openapi_client.models.ci_workflow.CiWorkflow(
                        type = 'ciWorkflows', 
                        id = '', 
                        attributes = openapi_client.models.ci_workflow_attributes.CiWorkflow_attributes(
                            name = '', 
                            description = '', 
                        ...
                        relationships = openapi_client.models.ci_workflow_relationships.CiWorkflow_relationships(
    ...
    def testCiWorkflowsResponse(self):
        """Test CiWorkflowsResponse"""
