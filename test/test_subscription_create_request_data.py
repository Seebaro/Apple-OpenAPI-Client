...
class TestSubscriptionCreateRequestData(unittest.TestCase):
    """SubscriptionCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionCreateRequestData:
        """Test SubscriptionCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionCreateRequestData`
        """
        model = SubscriptionCreateRequestData()
        if include_optional:
    ...
    def testSubscriptionCreateRequestData(self):
        """Test SubscriptionCreateRequestData"""
