...
class TestGameCenterAchievementsResponseIncludedInner(unittest.TestCase):
    """GameCenterAchievementsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterAchievementsResponseIncludedInner:
        """Test GameCenterAchievementsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterAchievementsResponseIncludedInner`
        """
        model = GameCenterAchievementsResponseIncludedInner()
        if include_optional:
    ...
    def testGameCenterAchievementsResponseIncludedInner(self):
        """Test GameCenterAchievementsResponseIncludedInner"""
