...
class TestScmRepositoriesResponse(unittest.TestCase):
    """ScmRepositoriesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScmRepositoriesResponse:
        """Test ScmRepositoriesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScmRepositoriesResponse`
        """
        model = ScmRepositoriesResponse()
        if include_optional:
    ...
    def testScmRepositoriesResponse(self):
        """Test ScmRepositoriesResponse"""
