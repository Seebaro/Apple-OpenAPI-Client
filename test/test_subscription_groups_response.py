...
class TestSubscriptionGroupsResponse(unittest.TestCase):
    """SubscriptionGroupsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionGroupsResponse:
        """Test SubscriptionGroupsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionGroupsResponse`
        """
        model = SubscriptionGroupsResponse()
        if include_optional:
    ...
    def testSubscriptionGroupsResponse(self):
        """Test SubscriptionGroupsResponse"""
