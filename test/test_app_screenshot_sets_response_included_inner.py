...
class TestAppScreenshotSetsResponseIncludedInner(unittest.TestCase):
    """AppScreenshotSetsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppScreenshotSetsResponseIncludedInner:
        """Test AppScreenshotSetsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppScreenshotSetsResponseIncludedInner`
        """
        model = AppScreenshotSetsResponseIncludedInner()
        if include_optional:
    ...
    def testAppScreenshotSetsResponseIncludedInner(self):
        """Test AppScreenshotSetsResponseIncludedInner"""
