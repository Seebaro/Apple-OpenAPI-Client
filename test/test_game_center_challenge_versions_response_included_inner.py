...
class TestGameCenterChallengeVersionsResponseIncludedInner(unittest.TestCase):
    """GameCenterChallengeVersionsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterChallengeVersionsResponseIncludedInner:
        """Test GameCenterChallengeVersionsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterChallengeVersionsResponseIncludedInner`
        """
        model = GameCenterChallengeVersionsResponseIncludedInner()
        if include_optional:
            return GameCenterChallengeVersionsResponseIncludedInner(
    ...
    def testGameCenterChallengeVersionsResponseIncludedInner(self):
        """Test GameCenterChallengeVersionsResponseIncludedInner"""
