...
class TestGameCenterDetailsResponse(unittest.TestCase):
    """GameCenterDetailsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterDetailsResponse:
        """Test GameCenterDetailsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterDetailsResponse`
        """
        model = GameCenterDetailsResponse()
        if include_optional:
            return GameCenterDetailsResponse(
                data = [
                    openapi_client.models.game_center_detail.GameCenterDetail(
    ...
    def testGameCenterDetailsResponse(self):
        """Test GameCenterDetailsResponse"""
