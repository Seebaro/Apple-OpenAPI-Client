...
class TestGameCenterActivityImageResponse(unittest.TestCase):
    """GameCenterActivityImageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterActivityImageResponse:
        """Test GameCenterActivityImageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterActivityImageResponse`
        """
        model = GameCenterActivityImageResponse()
        if include_optional:
            return GameCenterActivityImageResponse(
                data = openapi_client.models.game_center_activity_image.GameCenterActivityImage(
    ...
    def testGameCenterActivityImageResponse(self):
        """Test GameCenterActivityImageResponse"""
