...
class TestGameCenterMatchmakingQueueUpdateRequestData(unittest.TestCase):
    """GameCenterMatchmakingQueueUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterMatchmakingQueueUpdateRequestData:
        """Test GameCenterMatchmakingQueueUpdateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterMatchmakingQueueUpdateRequestData`
        """
        model = GameCenterMatchmakingQueueUpdateRequestData()
        if include_optional:
            return GameCenterMatchmakingQueueUpdateRequestData(
    ...
    def testGameCenterMatchmakingQueueUpdateRequestData(self):
        """Test GameCenterMatchmakingQueueUpdateRequestData"""
