...
class TestAgeRatingDeclarationAttributes(unittest.TestCase):
    """AgeRatingDeclarationAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgeRatingDeclarationAttributes:
        """Test AgeRatingDeclarationAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgeRatingDeclarationAttributes`
        """
        model = AgeRatingDeclarationAttributes()
        if include_optional:
            return AgeRatingDeclarationAttributes(
    ...
    def testAgeRatingDeclarationAttributes(self):
        """Test AgeRatingDeclarationAttributes"""
