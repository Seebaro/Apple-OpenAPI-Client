...
class TestSubscriptionIntroductoryOffersResponse(unittest.TestCase):
    """SubscriptionIntroductoryOffersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionIntroductoryOffersResponse:
        """Test SubscriptionIntroductoryOffersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionIntroductoryOffersResponse`
        """
        model = SubscriptionIntroductoryOffersResponse()
        if include_optional:
            return SubscriptionIntroductoryOffersResponse(
                data = [
                    openapi_client.models.subscription_introductory_offer.SubscriptionIntroductoryOffer(
    ...
    def testSubscriptionIntroductoryOffersResponse(self):
        """Test SubscriptionIntroductoryOffersResponse"""
