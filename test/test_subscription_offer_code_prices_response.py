...
class TestSubscriptionOfferCodePricesResponse(unittest.TestCase):
    """SubscriptionOfferCodePricesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionOfferCodePricesResponse:
        """Test SubscriptionOfferCodePricesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionOfferCodePricesResponse`
        """
        model = SubscriptionOfferCodePricesResponse()
        if include_optional:
            return SubscriptionOfferCodePricesResponse(
                data = [
                    openapi_client.models.subscription_offer_code_price.SubscriptionOfferCodePrice(
    ...
    def testSubscriptionOfferCodePricesResponse(self):
        """Test SubscriptionOfferCodePricesResponse"""
