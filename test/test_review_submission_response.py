...
class TestReviewSubmissionResponse(unittest.TestCase):
    """ReviewSubmissionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewSubmissionResponse:
        """Test ReviewSubmissionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewSubmissionResponse`
        """
        model = ReviewSubmissionResponse()
        if include_optional:
            return ReviewSubmissionResponse(
                data = openapi_client.models.review_submission.ReviewSubmission(
    ...
    def testReviewSubmissionResponse(self):
        """Test ReviewSubmissionResponse"""
