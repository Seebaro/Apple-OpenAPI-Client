...
class TestSubscriptionAvailabilityCreateRequestDataRelationships(unittest.TestCase):
    """SubscriptionAvailabilityCreateRequestDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionAvailabilityCreateRequestDataRelationships:
        """Test SubscriptionAvailabilityCreateRequestDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionAvailabilityCreateRequestDataRelationships`
        """
        model = SubscriptionAvailabilityCreateRequestDataRelationships()
        if include_optional:
            return SubscriptionAvailabilityCreateRequestDataRelationships(
    ...
    def testSubscriptionAvailabilityCreateRequestDataRelationships(self):
        """Test SubscriptionAvailabilityCreateRequestDataRelationships"""
