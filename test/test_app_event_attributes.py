...
class TestAppEventAttributes(unittest.TestCase):
    """AppEventAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEventAttributes:
        """Test AppEventAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEventAttributes`
        """
        model = AppEventAttributes()
        if include_optional:
            return AppEventAttributes(
                reference_name = '',
                badge = 'LIVE_EVENT',
                event_state = 'DRAFT',
                deep_link = '',
    ...
    def testAppEventAttributes(self):
        """Test AppEventAttributes"""
