...
class TestGameCenterChallengeVersionReleasesResponse(unittest.TestCase):
    """GameCenterChallengeVersionReleasesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterChallengeVersionReleasesResponse:
        """Test GameCenterChallengeVersionReleasesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterChallengeVersionReleasesResponse`
        """
        model = GameCenterChallengeVersionReleasesResponse()
        if include_optional:
            return GameCenterChallengeVersionReleasesResponse(
                data = [
                    openapi_client.models.game_center_challenge_version_release.GameCenterChallengeVersionRelease(
    ...
    def testGameCenterChallengeVersionReleasesResponse(self):
        """Test GameCenterChallengeVersionReleasesResponse"""
