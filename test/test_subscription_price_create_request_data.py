...
class TestSubscriptionPriceCreateRequestData(unittest.TestCase):
    """SubscriptionPriceCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionPriceCreateRequestData:
        """Test SubscriptionPriceCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionPriceCreateRequestData`
        """
        model = SubscriptionPriceCreateRequestData()
        if include_optional:
            return SubscriptionPriceCreateRequestData(
    ...
    def testSubscriptionPriceCreateRequestData(self):
        """Test SubscriptionPriceCreateRequestData"""
