...
class TestCiWorkflowCreateRequestDataRelationships(unittest.TestCase):
    """CiWorkflowCreateRequestDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiWorkflowCreateRequestDataRelationships:
        """Test CiWorkflowCreateRequestDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiWorkflowCreateRequestDataRelationships`
        """
        model = CiWorkflowCreateRequestDataRelationships()
        if include_optional:
            return CiWorkflowCreateRequestDataRelationships(
    ...
    def testCiWorkflowCreateRequestDataRelationships(self):
        """Test CiWorkflowCreateRequestDataRelationships"""
