...
class TestCiMacOsVersionResponse(unittest.TestCase):
    """CiMacOsVersionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiMacOsVersionResponse:
        """Test CiMacOsVersionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiMacOsVersionResponse`
        """
        model = CiMacOsVersionResponse()
        if include_optional:
            return CiMacOsVersionResponse(
                data = openapi_client.models.ci_mac_os_version.CiMacOsVersion(
                    ...
                    links = openapi_client.models.resource_links.ResourceLinks(
                        self = '', ), ),
                included = [
                    openapi_client.models.ci_xcode_version.CiXcodeVersion(
                        type = 'ciXcodeVersions', 
                        id = '', 
    ...
    def testCiMacOsVersionResponse(self):
        """Test CiMacOsVersionResponse"""
