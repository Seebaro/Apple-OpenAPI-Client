...
class TestSubscriptionOfferCodeResponse(unittest.TestCase):
    """SubscriptionOfferCodeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionOfferCodeResponse:
        """Test SubscriptionOfferCodeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionOfferCodeResponse`
        """
        model = SubscriptionOfferCodeResponse()
        if include_optional:
            return SubscriptionOfferCodeResponse(
                data = openapi_client.models.subscription_offer_code.SubscriptionOfferCode(
    ...
    def testSubscriptionOfferCodeResponse(self):
        """Test SubscriptionOfferCodeResponse"""
