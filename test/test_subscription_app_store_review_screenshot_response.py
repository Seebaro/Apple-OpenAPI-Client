...
class TestSubscriptionAppStoreReviewScreenshotResponse(unittest.TestCase):
    """SubscriptionAppStoreReviewScreenshotResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionAppStoreReviewScreenshotResponse:
        """Test SubscriptionAppStoreReviewScreenshotResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionAppStoreReviewScreenshotResponse`
        """
        model = SubscriptionAppStoreReviewScreenshotResponse()
        if include_optional:
            return SubscriptionAppStoreReviewScreenshotResponse(
                data = openapi_client.models.subscription_app_store_review_screenshot.SubscriptionAppStoreReviewScreenshot(
    ...
    def testSubscriptionAppStoreReviewScreenshotResponse(self):
        """Test SubscriptionAppStoreReviewScreenshotResponse"""
