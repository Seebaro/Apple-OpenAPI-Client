...
class TestGameCenterLeaderboardSetReleaseCreateRequestData(unittest.TestCase):
    """GameCenterLeaderboardSetReleaseCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterLeaderboardSetReleaseCreateRequestData:
        """Test GameCenterLeaderboardSetReleaseCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterLeaderboardSetReleaseCreateRequestData`
        """
        model = GameCenterLeaderboardSetReleaseCreateRequestData()
        if include_optional:
            return GameCenterLeaderboardSetReleaseCreateRequestData(
    ...
    def testGameCenterLeaderboardSetReleaseCreateRequestData(self):
        """Test GameCenterLeaderboardSetReleaseCreateRequestData"""
