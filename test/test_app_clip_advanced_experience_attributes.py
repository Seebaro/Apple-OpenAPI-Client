...
class TestAppClipAdvancedExperienceAttributes(unittest.TestCase):
    """AppClipAdvancedExperienceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppClipAdvancedExperienceAttributes:
        """Test AppClipAdvancedExperienceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppClipAdvancedExperienceAttributes`
        """
        model = AppClipAdvancedExperienceAttributes()
        if include_optional:
            return AppClipAdvancedExperienceAttributes(
                link = '',
                version = 56,
                status = 'RECEIVED',
                action = 'OPEN',
    ...
    def testAppClipAdvancedExperienceAttributes(self):
        """Test AppClipAdvancedExperienceAttributes"""
