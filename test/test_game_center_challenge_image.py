...
class TestGameCenterChallengeImage(unittest.TestCase):
    """GameCenterChallengeImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterChallengeImage:
        """Test GameCenterChallengeImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterChallengeImage`
        """
        model = GameCenterChallengeImage()
        if include_optional:
            return GameCenterChallengeImage(
    ...
    def testGameCenterChallengeImage(self):
        """Test GameCenterChallengeImage"""
