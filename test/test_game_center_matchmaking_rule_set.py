...
class TestGameCenterMatchmakingRuleSet(unittest.TestCase):
    """GameCenterMatchmakingRuleSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterMatchmakingRuleSet:
        """Test GameCenterMatchmakingRuleSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterMatchmakingRuleSet`
        """
        model = GameCenterMatchmakingRuleSet()
        if include_optional:
            return GameCenterMatchmakingRuleSet(
    ...
    def testGameCenterMatchmakingRuleSet(self):
        """Test GameCenterMatchmakingRuleSet"""
