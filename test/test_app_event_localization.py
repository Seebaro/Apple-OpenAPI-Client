...
class TestAppEventLocalization(unittest.TestCase):
    """AppEventLocalization unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEventLocalization:
        """Test AppEventLocalization
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEventLocalization`
        """
        model = AppEventLocalization()
        if include_optional:
    ...
    def testAppEventLocalization(self):
        """Test AppEventLocalization"""
