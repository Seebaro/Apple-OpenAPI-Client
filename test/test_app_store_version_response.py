...
class TestAppStoreVersionResponse(unittest.TestCase):
    """AppStoreVersionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppStoreVersionResponse:
        """Test AppStoreVersionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppStoreVersionResponse`
        """
        model = AppStoreVersionResponse()
        if include_optional:
            return AppStoreVersionResponse(
                data = openapi_client.models.app_store_version.AppStoreVersion(
    ...
    def testAppStoreVersionResponse(self):
        """Test AppStoreVersionResponse"""
