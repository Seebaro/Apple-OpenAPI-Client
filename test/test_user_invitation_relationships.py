...
class TestUserInvitationRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserInvitationRelationships:
        """Test UserInvitationRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserInvitationRelationships`
        """
        model = UserInvitationRelationships()
        if include_optional:
