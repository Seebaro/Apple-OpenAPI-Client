...
class TestCiWorkflowAttributes(unittest.TestCase):
    """CiWorkflowAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiWorkflowAttributes:
        """Test CiWorkflowAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiWorkflowAttributes`
        """
        model = CiWorkflowAttributes()
        if include_optional:
            return CiWorkflowAttributes(
                name = '',
                description = '',
    ...
    def testCiWorkflowAttributes(self):
        """Test CiWorkflowAttributes"""
