...
class TestBetaTestersResponse(unittest.TestCase):
    """BetaTestersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaTestersResponse:
        """Test BetaTestersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaTestersResponse`
        """
        model = BetaTestersResponse()
        if include_optional:
    ...
    def testBetaTestersResponse(self):
        """Test BetaTestersResponse"""
