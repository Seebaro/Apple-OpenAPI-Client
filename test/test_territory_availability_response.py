...
class TestTerritoryAvailabilityResponse(unittest.TestCase):
    """TerritoryAvailabilityResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TerritoryAvailabilityResponse:
        """Test TerritoryAvailabilityResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TerritoryAvailabilityResponse`
        """
        model = TerritoryAvailabilityResponse()
        if include_optional:
            return TerritoryAvailabilityResponse(
                data = openapi_client.models.territory_availability.TerritoryAvailability(
    ...
    def testTerritoryAvailabilityResponse(self):
        """Test TerritoryAvailabilityResponse"""
