...
class TestAppInfosResponseIncludedInner(unittest.TestCase):
    """AppInfosResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppInfosResponseIncludedInner:
        """Test AppInfosResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppInfosResponseIncludedInner`
        """
        model = AppInfosResponseIncludedInner()
        if include_optional:
    ...
    def testAppInfosResponseIncludedInner(self):
        """Test AppInfosResponseIncludedInner"""
