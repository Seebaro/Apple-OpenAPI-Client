...
class TestDiagnosticLogsProductDataInner(unittest.TestCase):
    """DiagnosticLogsProductDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiagnosticLogsProductDataInner:
        """Test DiagnosticLogsProductDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiagnosticLogsProductDataInner`
        """
        model = DiagnosticLogsProductDataInner()
        if include_optional:
            return DiagnosticLogsProductDataInner(
                signature_id = '',
                diagnostic_insights = [
    ...
    def testDiagnosticLogsProductDataInner(self):
        """Test DiagnosticLogsProductDataInner"""
