...
class TestGameCenterAchievement(unittest.TestCase):
    """GameCenterAchievement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterAchievement:
        """Test GameCenterAchievement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterAchievement`
        """
        model = GameCenterAchievement()
        if include_optional:
    ...
    def testGameCenterAchievement(self):
        """Test GameCenterAchievement"""
