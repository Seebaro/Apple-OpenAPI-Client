...
class TestAppPricePointV3Relationships(unittest.TestCase):
    """AppPricePointV3Relationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPricePointV3Relationships:
        """Test AppPricePointV3Relationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPricePointV3Relationships`
        """
        model = AppPricePointV3Relationships()
        if include_optional:
            return AppPricePointV3Relationships(
    ...
    def testAppPricePointV3Relationships(self):
        """Test AppPricePointV3Relationships"""
