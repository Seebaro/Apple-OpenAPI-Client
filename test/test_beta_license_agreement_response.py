...
class TestBetaLicenseAgreementResponse(unittest.TestCase):
    """BetaLicenseAgreementResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaLicenseAgreementResponse:
        """Test BetaLicenseAgreementResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaLicenseAgreementResponse`
        """
        model = BetaLicenseAgreementResponse()
        if include_optional:
    ...
    def testBetaLicenseAgreementResponse(self):
        """Test BetaLicenseAgreementResponse"""
