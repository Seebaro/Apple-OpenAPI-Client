...
class TestSubscriptionImagesResponse(unittest.TestCase):
    """SubscriptionImagesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionImagesResponse:
        """Test SubscriptionImagesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionImagesResponse`
        """
        model = SubscriptionImagesResponse()
        if include_optional:
            return SubscriptionImagesResponse(
                data = [
                    openapi_client.models.subscription_image.SubscriptionImage(
    ...
    def testSubscriptionImagesResponse(self):
        """Test SubscriptionImagesResponse"""
