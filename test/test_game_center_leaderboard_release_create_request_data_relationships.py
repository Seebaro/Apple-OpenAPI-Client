...
class TestGameCenterLeaderboardReleaseCreateRequestDataRelationships(unittest.TestCase):
    """GameCenterLeaderboardReleaseCreateRequestDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterLeaderboardReleaseCreateRequestDataRelationships:
        """Test GameCenterLeaderboardReleaseCreateRequestDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterLeaderboardReleaseCreateRequestDataRelationships`
        """
        model = GameCenterLeaderboardReleaseCreateRequestDataRelationships()
        if include_optional:
            return GameCenterLeaderboardReleaseCreateRequestDataRelationships(
    ...
    def testGameCenterLeaderboardReleaseCreateRequestDataRelationships(self):
        """Test GameCenterLeaderboardReleaseCreateRequestDataRelationships"""
