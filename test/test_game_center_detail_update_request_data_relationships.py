...
class TestGameCenterDetailUpdateRequestDataRelationships(unittest.TestCase):
    """GameCenterDetailUpdateRequestDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterDetailUpdateRequestDataRelationships:
        """Test GameCenterDetailUpdateRequestDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterDetailUpdateRequestDataRelationships`
        """
        model = GameCenterDetailUpdateRequestDataRelationships()
        if include_optional:
            return GameCenterDetailUpdateRequestDataRelationships(
    ...
    def testGameCenterDetailUpdateRequestDataRelationships(self):
        """Test GameCenterDetailUpdateRequestDataRelationships"""
