...
class TestSubscriptionUpdateRequestIncludedInner(unittest.TestCase):
    """SubscriptionUpdateRequestIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionUpdateRequestIncludedInner:
        """Test SubscriptionUpdateRequestIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionUpdateRequestIncludedInner`
        """
        model = SubscriptionUpdateRequestIncludedInner()
        if include_optional:
    ...
    def testSubscriptionUpdateRequestIncludedInner(self):
        """Test SubscriptionUpdateRequestIncludedInner"""
