...
class TestReviewSubmissionsResponseIncludedInner(unittest.TestCase):
    """ReviewSubmissionsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewSubmissionsResponseIncludedInner:
        """Test ReviewSubmissionsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewSubmissionsResponseIncludedInner`
        """
        model = ReviewSubmissionsResponseIncludedInner()
        if include_optional:
    ...
    def testReviewSubmissionsResponseIncludedInner(self):
        """Test ReviewSubmissionsResponseIncludedInner"""
