...
class TestBuildIconsWithoutIncludesResponse(unittest.TestCase):
    """BuildIconsWithoutIncludesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuildIconsWithoutIncludesResponse:
        """Test BuildIconsWithoutIncludesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildIconsWithoutIncludesResponse`
        """
        model = BuildIconsWithoutIncludesResponse()
        if include_optional:
    ...
    def testBuildIconsWithoutIncludesResponse(self):
        """Test BuildIconsWithoutIncludesResponse"""
