...
class TestGameCenterMatchmakingRuleSetTestCreateRequest(unittest.TestCase):
    """GameCenterMatchmakingRuleSetTestCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterMatchmakingRuleSetTestCreateRequest:
        """Test GameCenterMatchmakingRuleSetTestCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterMatchmakingRuleSetTestCreateRequest`
        """
        model = GameCenterMatchmakingRuleSetTestCreateRequest()
        if include_optional:
            return GameCenterMatchmakingRuleSetTestCreateRequest(
                data = openapi_client.models.game_center_matchmaking_rule_set_test_create_request_data.GameCenterMatchmakingRuleSetTestCreateRequest_data(
    ...
    def testGameCenterMatchmakingRuleSetTestCreateRequest(self):
        """Test GameCenterMatchmakingRuleSetTestCreateRequest"""
