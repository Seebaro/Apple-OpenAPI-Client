...
class TestSubscriptionLocalizationResponse(unittest.TestCase):
    """SubscriptionLocalizationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionLocalizationResponse:
        """Test SubscriptionLocalizationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionLocalizationResponse`
        """
        model = SubscriptionLocalizationResponse()
        if include_optional:
            return SubscriptionLocalizationResponse(
                data = openapi_client.models.subscription_localization.SubscriptionLocalization(
    ...
    def testSubscriptionLocalizationResponse(self):
        """Test SubscriptionLocalizationResponse"""
