...
class TestGameCenterAchievementReleaseCreateRequestDataRelationships(unittest.TestCase):
    """GameCenterAchievementReleaseCreateRequestDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterAchievementReleaseCreateRequestDataRelationships:
        """Test GameCenterAchievementReleaseCreateRequestDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterAchievementReleaseCreateRequestDataRelationships`
        """
        model = GameCenterAchievementReleaseCreateRequestDataRelationships()
        if include_optional:
            return GameCenterAchievementReleaseCreateRequestDataRelationships(
    ...
    def testGameCenterAchievementReleaseCreateRequestDataRelationships(self):
        """Test GameCenterAchievementReleaseCreateRequestDataRelationships"""
