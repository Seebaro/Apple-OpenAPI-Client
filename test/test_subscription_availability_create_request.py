...
class TestSubscriptionAvailabilityCreateRequest(unittest.TestCase):
    """SubscriptionAvailabilityCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionAvailabilityCreateRequest:
        """Test SubscriptionAvailabilityCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionAvailabilityCreateRequest`
        """
        model = SubscriptionAvailabilityCreateRequest()
        if include_optional:
            return SubscriptionAvailabilityCreateRequest(
                data = openapi_client.models.subscription_availability_create_request_data.SubscriptionAvailabilityCreateRequest_data(
    ...
    def testSubscriptionAvailabilityCreateRequest(self):
        """Test SubscriptionAvailabilityCreateRequest"""
