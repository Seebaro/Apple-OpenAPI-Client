...
class TestAppEventLocalizationsResponseIncludedInner(unittest.TestCase):
    """AppEventLocalizationsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEventLocalizationsResponseIncludedInner:
        """Test AppEventLocalizationsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEventLocalizationsResponseIncludedInner`
        """
        model = AppEventLocalizationsResponseIncludedInner()
        if include_optional:
    ...
    def testAppEventLocalizationsResponseIncludedInner(self):
        """Test AppEventLocalizationsResponseIncludedInner"""
