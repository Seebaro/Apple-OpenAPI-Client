...
class TestSandboxTestersClearPurchaseHistoryRequestV2CreateRequestData(unittest.TestCase):
    """SandboxTestersClearPurchaseHistoryRequestV2CreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SandboxTestersClearPurchaseHistoryRequestV2CreateRequestData:
        """Test SandboxTestersClearPurchaseHistoryRequestV2CreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SandboxTestersClearPurchaseHistoryRequestV2CreateRequestData`
        """
        model = SandboxTestersClearPurchaseHistoryRequestV2CreateRequestData()
        if include_optional:
            return SandboxTestersClearPurchaseHistoryRequestV2CreateRequestData(
    ...
    def testSandboxTestersClearPurchaseHistoryRequestV2CreateRequestData(self):
        """Test SandboxTestersClearPurchaseHistoryRequestV2CreateRequestData"""
