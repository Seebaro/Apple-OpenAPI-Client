...
class TestSubscriptionOfferCodeCustomCodesResponse(unittest.TestCase):
    """SubscriptionOfferCodeCustomCodesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionOfferCodeCustomCodesResponse:
        """Test SubscriptionOfferCodeCustomCodesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionOfferCodeCustomCodesResponse`
        """
        model = SubscriptionOfferCodeCustomCodesResponse()
        if include_optional:
            return SubscriptionOfferCodeCustomCodesResponse(
                data = [
                    openapi_client.models.subscription_offer_code_custom_code.SubscriptionOfferCodeCustomCode(
    ...
    def testSubscriptionOfferCodeCustomCodesResponse(self):
        """Test SubscriptionOfferCodeCustomCodesResponse"""
