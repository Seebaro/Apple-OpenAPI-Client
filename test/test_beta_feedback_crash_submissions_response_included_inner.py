...
class TestBetaFeedbackCrashSubmissionsResponseIncludedInner(unittest.TestCase):
    """BetaFeedbackCrashSubmissionsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaFeedbackCrashSubmissionsResponseIncludedInner:
        """Test BetaFeedbackCrashSubmissionsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaFeedbackCrashSubmissionsResponseIncludedInner`
        """
        model = BetaFeedbackCrashSubmissionsResponseIncludedInner()
        if include_optional:
            return BetaFeedbackCrashSubmissionsResponseIncludedInner(
                type = 'builds',
                id = '',
    ...
    def testBetaFeedbackCrashSubmissionsResponseIncludedInner(self):
        """Test BetaFeedbackCrashSubmissionsResponseIncludedInner"""
