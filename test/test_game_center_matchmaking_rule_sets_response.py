...
class TestGameCenterMatchmakingRuleSetsResponse(unittest.TestCase):
    """GameCenterMatchmakingRuleSetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterMatchmakingRuleSetsResponse:
        """Test GameCenterMatchmakingRuleSetsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterMatchmakingRuleSetsResponse`
        """
        model = GameCenterMatchmakingRuleSetsResponse()
        if include_optional:
    ...
    def testGameCenterMatchmakingRuleSetsResponse(self):
        """Test GameCenterMatchmakingRuleSetsResponse"""
