...
class TestAppEventUpdateRequestDataAttributes(unittest.TestCase):
    """AppEventUpdateRequestDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEventUpdateRequestDataAttributes:
        """Test AppEventUpdateRequestDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEventUpdateRequestDataAttributes`
        """
        model = AppEventUpdateRequestDataAttributes()
        if include_optional:
            return AppEventUpdateRequestDataAttributes(
                reference_name = '',
                badge = 'LIVE_EVENT',
                deep_link = '',
    ...
    def testAppEventUpdateRequestDataAttributes(self):
        """Test AppEventUpdateRequestDataAttributes"""
