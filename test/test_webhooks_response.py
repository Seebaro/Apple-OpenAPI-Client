...
class TestWebhooksResponse(unittest.TestCase):
    """WebhooksResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhooksResponse:
        """Test WebhooksResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhooksResponse`
        """
        model = WebhooksResponse()
        if include_optional:
