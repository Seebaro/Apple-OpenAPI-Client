...
class TestSubscriptionPriceResponse(unittest.TestCase):
    """SubscriptionPriceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionPriceResponse:
        """Test SubscriptionPriceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionPriceResponse`
        """
        model = SubscriptionPriceResponse()
        if include_optional:
            return SubscriptionPriceResponse(
                data = openapi_client.models.subscription_price.SubscriptionPrice(
    ...
    def testSubscriptionPriceResponse(self):
        """Test SubscriptionPriceResponse"""
