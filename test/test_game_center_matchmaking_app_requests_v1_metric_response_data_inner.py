...
class TestGameCenterMatchmakingAppRequestsV1MetricResponseDataInner(unittest.TestCase):
    """GameCenterMatchmakingAppRequestsV1MetricResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterMatchmakingAppRequestsV1MetricResponseDataInner:
        """Test GameCenterMatchmakingAppRequestsV1MetricResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterMatchmakingAppRequestsV1MetricResponseDataInner`
        """
        model = GameCenterMatchmakingAppRequestsV1MetricResponseDataInner()
        if include_optional:
            return GameCenterMatchmakingAppRequestsV1MetricResponseDataInner(
    ...
    def testGameCenterMatchmakingAppRequestsV1MetricResponseDataInner(self):
        """Test GameCenterMatchmakingAppRequestsV1MetricResponseDataInner"""
