...
class TestGameCenterChallengeVersionsResponse(unittest.TestCase):
    """GameCenterChallengeVersionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterChallengeVersionsResponse:
        """Test GameCenterChallengeVersionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterChallengeVersionsResponse`
        """
        model = GameCenterChallengeVersionsResponse()
        if include_optional:
    ...
    def testGameCenterChallengeVersionsResponse(self):
        """Test GameCenterChallengeVersionsResponse"""
