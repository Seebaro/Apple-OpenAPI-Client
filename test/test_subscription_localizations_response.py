...
class TestSubscriptionLocalizationsResponse(unittest.TestCase):
    """SubscriptionLocalizationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionLocalizationsResponse:
        """Test SubscriptionLocalizationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionLocalizationsResponse`
        """
        model = SubscriptionLocalizationsResponse()
        if include_optional:
            return SubscriptionLocalizationsResponse(
                data = [
                    openapi_client.models.subscription_localization.SubscriptionLocalization(
    ...
    def testSubscriptionLocalizationsResponse(self):
        """Test SubscriptionLocalizationsResponse"""
