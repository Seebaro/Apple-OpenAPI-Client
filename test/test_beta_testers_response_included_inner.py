...
class TestBetaTestersResponseIncludedInner(unittest.TestCase):
    """BetaTestersResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaTestersResponseIncludedInner:
        """Test BetaTestersResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaTestersResponseIncludedInner`
        """
        model = BetaTestersResponseIncludedInner()
        if include_optional:
    ...
    def testBetaTestersResponseIncludedInner(self):
        """Test BetaTestersResponseIncludedInner"""
