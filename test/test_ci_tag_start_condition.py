...
class TestCiTagStartCondition(unittest.TestCase):
    """CiTagStartCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiTagStartCondition:
        """Test CiTagStartCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiTagStartCondition`
        """
        model = CiTagStartCondition()
        if include_optional:
    ...
    def testCiTagStartCondition(self):
        """Test CiTagStartCondition"""
