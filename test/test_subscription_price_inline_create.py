...
class TestSubscriptionPriceInlineCreate(unittest.TestCase):
    """SubscriptionPriceInlineCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionPriceInlineCreate:
        """Test SubscriptionPriceInlineCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionPriceInlineCreate`
        """
        model = SubscriptionPriceInlineCreate()
        if include_optional:
    ...
    def testSubscriptionPriceInlineCreate(self):
        """Test SubscriptionPriceInlineCreate"""
