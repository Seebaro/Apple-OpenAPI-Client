...
class TestCiBuildRun(unittest.TestCase):
    """CiBuildRun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiBuildRun:
        """Test CiBuildRun
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiBuildRun`
        """
        model = CiBuildRun()
        if include_optional:
            return CiBuildRun(
