...
class TestAppScreenshotSetsResponse(unittest.TestCase):
    """AppScreenshotSetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppScreenshotSetsResponse:
        """Test AppScreenshotSetsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppScreenshotSetsResponse`
        """
        model = AppScreenshotSetsResponse()
        if include_optional:
    ...
    def testAppScreenshotSetsResponse(self):
        """Test AppScreenshotSetsResponse"""
