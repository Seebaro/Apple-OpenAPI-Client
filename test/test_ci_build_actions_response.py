...
class TestCiBuildActionsResponse(unittest.TestCase):
    """CiBuildActionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiBuildActionsResponse:
        """Test CiBuildActionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiBuildActionsResponse`
        """
        model = CiBuildActionsResponse()
        if include_optional:
            return CiBuildActionsResponse(
                data = [
                    openapi_client.models.ci_build_action.CiBuildAction(
                        type = 'ciBuildActions', 
                        id = '', 
    ...
    def testCiBuildActionsResponse(self):
        """Test CiBuildActionsResponse"""
