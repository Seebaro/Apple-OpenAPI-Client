...
class TestSubscriptionOfferCodePriceRelationships(unittest.TestCase):
    """SubscriptionOfferCodePriceRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionOfferCodePriceRelationships:
        """Test SubscriptionOfferCodePriceRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionOfferCodePriceRelationships`
        """
        model = SubscriptionOfferCodePriceRelationships()
        if include_optional:
            return SubscriptionOfferCodePriceRelationships(
    ...
    def testSubscriptionOfferCodePriceRelationships(self):
        """Test SubscriptionOfferCodePriceRelationships"""
