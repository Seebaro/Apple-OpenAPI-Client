...
class TestCiBuildActionResponse(unittest.TestCase):
    """CiBuildActionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiBuildActionResponse:
        """Test CiBuildActionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiBuildActionResponse`
        """
        model = CiBuildActionResponse()
        if include_optional:
            return CiBuildActionResponse(
                data = openapi_client.models.ci_build_action.CiBuildAction(
                    type = 'ciBuildActions', 
                    id = '', 
    ...
    def testCiBuildActionResponse(self):
        """Test CiBuildActionResponse"""
