...
class TestBuildsResponseIncludedInner(unittest.TestCase):
    """BuildsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuildsResponseIncludedInner:
        """Test BuildsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildsResponseIncludedInner`
        """
        model = BuildsResponseIncludedInner()
        if include_optional:
    ...
    def testBuildsResponseIncludedInner(self):
        """Test BuildsResponseIncludedInner"""
