...
class TestBetaAppLocalizationRelationships(unittest.TestCase):
    """BetaAppLocalizationRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaAppLocalizationRelationships:
        """Test BetaAppLocalizationRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaAppLocalizationRelationships`
        """
        model = BetaAppLocalizationRelationships()
        if include_optional:
            return BetaAppLocalizationRelationships(
    ...
    def testBetaAppLocalizationRelationships(self):
        """Test BetaAppLocalizationRelationships"""
