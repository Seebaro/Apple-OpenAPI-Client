...
class TestGameCenterLeaderboardSetMemberLocalizationCreateRequestDataRelationships(unittest.TestCase):
    """GameCenterLeaderboardSetMemberLocalizationCreateRequestDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterLeaderboardSetMemberLocalizationCreateRequestDataRelationships:
        """Test GameCenterLeaderboardSetMemberLocalizationCreateRequestDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterLeaderboardSetMemberLocalizationCreateRequestDataRelationships`
        """
        model = GameCenterLeaderboardSetMemberLocalizationCreateRequestDataRelationships()
        if include_optional:
            return GameCenterLeaderboardSetMemberLocalizationCreateRequestDataRelationships(
    ...
    def testGameCenterLeaderboardSetMemberLocalizationCreateRequestDataRelationships(self):
        """Test GameCenterLeaderboardSetMemberLocalizationCreateRequestDataRelationships"""
