...
class TestInAppPurchaseLocalizationsResponse(unittest.TestCase):
    """InAppPurchaseLocalizationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InAppPurchaseLocalizationsResponse:
        """Test InAppPurchaseLocalizationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InAppPurchaseLocalizationsResponse`
        """
        model = InAppPurchaseLocalizationsResponse()
        if include_optional:
            return InAppPurchaseLocalizationsResponse(
                data = [
                    openapi_client.models.in_app_purchase_localization.InAppPurchaseLocalization(
    ...
    def testInAppPurchaseLocalizationsResponse(self):
        """Test InAppPurchaseLocalizationsResponse"""
