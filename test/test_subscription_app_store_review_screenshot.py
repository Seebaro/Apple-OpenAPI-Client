...
class TestSubscriptionAppStoreReviewScreenshot(unittest.TestCase):
    """SubscriptionAppStoreReviewScreenshot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionAppStoreReviewScreenshot:
        """Test SubscriptionAppStoreReviewScreenshot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionAppStoreReviewScreenshot`
        """
        model = SubscriptionAppStoreReviewScreenshot()
        if include_optional:
            return SubscriptionAppStoreReviewScreenshot(
    ...
    def testSubscriptionAppStoreReviewScreenshot(self):
        """Test SubscriptionAppStoreReviewScreenshot"""
