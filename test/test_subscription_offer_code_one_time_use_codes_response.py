...
class TestSubscriptionOfferCodeOneTimeUseCodesResponse(unittest.TestCase):
    """SubscriptionOfferCodeOneTimeUseCodesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionOfferCodeOneTimeUseCodesResponse:
        """Test SubscriptionOfferCodeOneTimeUseCodesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionOfferCodeOneTimeUseCodesResponse`
        """
        model = SubscriptionOfferCodeOneTimeUseCodesResponse()
        if include_optional:
            return SubscriptionOfferCodeOneTimeUseCodesResponse(
                data = [
                    openapi_client.models.subscription_offer_code_one_time_use_code.SubscriptionOfferCodeOneTimeUseCode(
    ...
    def testSubscriptionOfferCodeOneTimeUseCodesResponse(self):
        """Test SubscriptionOfferCodeOneTimeUseCodesResponse"""
