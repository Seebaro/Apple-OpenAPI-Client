...
class TestInAppPurchasePricePoint(unittest.TestCase):
    """InAppPurchasePricePoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InAppPurchasePricePoint:
        """Test InAppPurchasePricePoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InAppPurchasePricePoint`
        """
        model = InAppPurchasePricePoint()
        if include_optional:
    ...
    def testInAppPurchasePricePoint(self):
        """Test InAppPurchasePricePoint"""
