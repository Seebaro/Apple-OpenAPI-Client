...
class TestScmPullRequest(unittest.TestCase):
    """ScmPullRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScmPullRequest:
        """Test ScmPullRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScmPullRequest`
        """
        model = ScmPullRequest()
        if include_optional:
