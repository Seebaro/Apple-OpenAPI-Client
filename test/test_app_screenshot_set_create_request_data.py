...
class TestAppScreenshotSetCreateRequestData(unittest.TestCase):
    """AppScreenshotSetCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppScreenshotSetCreateRequestData:
        """Test AppScreenshotSetCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppScreenshotSetCreateRequestData`
        """
        model = AppScreenshotSetCreateRequestData()
        if include_optional:
            return AppScreenshotSetCreateRequestData(
    ...
    def testAppScreenshotSetCreateRequestData(self):
        """Test AppScreenshotSetCreateRequestData"""
