...
class TestScmPullRequestsResponse(unittest.TestCase):
    """ScmPullRequestsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScmPullRequestsResponse:
        """Test ScmPullRequestsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScmPullRequestsResponse`
        """
        model = ScmPullRequestsResponse()
        if include_optional:
            return ScmPullRequestsResponse(
                data = [
                    openapi_client.models.scm_pull_request.ScmPullRequest(
    ...
    def testScmPullRequestsResponse(self):
        """Test ScmPullRequestsResponse"""
