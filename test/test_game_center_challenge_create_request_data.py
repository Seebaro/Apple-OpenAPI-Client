...
class TestGameCenterChallengeCreateRequestData(unittest.TestCase):
    """GameCenterChallengeCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterChallengeCreateRequestData:
        """Test GameCenterChallengeCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterChallengeCreateRequestData`
        """
        model = GameCenterChallengeCreateRequestData()
        if include_optional:
            return GameCenterChallengeCreateRequestData(
    ...
    def testGameCenterChallengeCreateRequestData(self):
        """Test GameCenterChallengeCreateRequestData"""
