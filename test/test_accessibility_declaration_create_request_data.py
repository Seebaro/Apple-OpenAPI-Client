...
class TestAccessibilityDeclarationCreateRequestData(unittest.TestCase):
    """AccessibilityDeclarationCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessibilityDeclarationCreateRequestData:
        """Test AccessibilityDeclarationCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessibilityDeclarationCreateRequestData`
        """
        model = AccessibilityDeclarationCreateRequestData()
        if include_optional:
            return AccessibilityDeclarationCreateRequestData(
    ...
    def testAccessibilityDeclarationCreateRequestData(self):
        """Test AccessibilityDeclarationCreateRequestData"""
