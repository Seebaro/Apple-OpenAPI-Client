...
class TestProfilesWithoutIncludesResponse(unittest.TestCase):
    """ProfilesWithoutIncludesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfilesWithoutIncludesResponse:
        """Test ProfilesWithoutIncludesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfilesWithoutIncludesResponse`
        """
        model = ProfilesWithoutIncludesResponse()
        if include_optional:
    ...
    def testProfilesWithoutIncludesResponse(self):
        """Test ProfilesWithoutIncludesResponse"""
