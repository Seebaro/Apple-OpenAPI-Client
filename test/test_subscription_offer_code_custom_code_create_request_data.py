...
class TestSubscriptionOfferCodeCustomCodeCreateRequestData(unittest.TestCase):
    """SubscriptionOfferCodeCustomCodeCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionOfferCodeCustomCodeCreateRequestData:
        """Test SubscriptionOfferCodeCustomCodeCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionOfferCodeCustomCodeCreateRequestData`
        """
        model = SubscriptionOfferCodeCustomCodeCreateRequestData()
        if include_optional:
            return SubscriptionOfferCodeCustomCodeCreateRequestData(
    ...
    def testSubscriptionOfferCodeCustomCodeCreateRequestData(self):
        """Test SubscriptionOfferCodeCustomCodeCreateRequestData"""
