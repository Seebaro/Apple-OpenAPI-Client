...
class TestSubscriptionPromotionalOffer(unittest.TestCase):
    """SubscriptionPromotionalOffer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionPromotionalOffer:
        """Test SubscriptionPromotionalOffer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionPromotionalOffer`
        """
        model = SubscriptionPromotionalOffer()
        if include_optional:
            return SubscriptionPromotionalOffer(
    ...
    def testSubscriptionPromotionalOffer(self):
        """Test SubscriptionPromotionalOffer"""
