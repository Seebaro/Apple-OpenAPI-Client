...
class TestGameCenterAchievementReleaseCreateRequestData(unittest.TestCase):
    """GameCenterAchievementReleaseCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterAchievementReleaseCreateRequestData:
        """Test GameCenterAchievementReleaseCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterAchievementReleaseCreateRequestData`
        """
        model = GameCenterAchievementReleaseCreateRequestData()
        if include_optional:
            return GameCenterAchievementReleaseCreateRequestData(
    ...
    def testGameCenterAchievementReleaseCreateRequestData(self):
        """Test GameCenterAchievementReleaseCreateRequestData"""
