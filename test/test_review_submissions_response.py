...
class TestReviewSubmissionsResponse(unittest.TestCase):
    """ReviewSubmissionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewSubmissionsResponse:
        """Test ReviewSubmissionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewSubmissionsResponse`
        """
        model = ReviewSubmissionsResponse()
        if include_optional:
            return ReviewSubmissionsResponse(
                data = [
                    openapi_client.models.review_submission.ReviewSubmission(
    ...
    def testReviewSubmissionsResponse(self):
        """Test ReviewSubmissionsResponse"""
