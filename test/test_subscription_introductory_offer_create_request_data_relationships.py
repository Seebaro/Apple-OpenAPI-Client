...
class TestSubscriptionIntroductoryOfferCreateRequestDataRelationships(unittest.TestCase):
    """SubscriptionIntroductoryOfferCreateRequestDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionIntroductoryOfferCreateRequestDataRelationships:
        """Test SubscriptionIntroductoryOfferCreateRequestDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionIntroductoryOfferCreateRequestDataRelationships`
        """
        model = SubscriptionIntroductoryOfferCreateRequestDataRelationships()
        if include_optional:
            return SubscriptionIntroductoryOfferCreateRequestDataRelationships(
    ...
    def testSubscriptionIntroductoryOfferCreateRequestDataRelationships(self):
        """Test SubscriptionIntroductoryOfferCreateRequestDataRelationships"""
