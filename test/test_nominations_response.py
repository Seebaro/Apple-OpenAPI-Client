...
class TestNominationsResponse(unittest.TestCase):
    """NominationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NominationsResponse:
        """Test NominationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NominationsResponse`
        """
        model = NominationsResponse()
        if include_optional:
            return NominationsResponse(
                data = [
                    openapi_client.models.nomination.Nomination(
                        type = 'nominations', 
                        id = '', 
    ...
    def testNominationsResponse(self):
        """Test NominationsResponse"""
