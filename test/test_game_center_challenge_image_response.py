...
class TestGameCenterChallengeImageResponse(unittest.TestCase):
    """GameCenterChallengeImageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterChallengeImageResponse:
        """Test GameCenterChallengeImageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterChallengeImageResponse`
        """
        model = GameCenterChallengeImageResponse()
        if include_optional:
            return GameCenterChallengeImageResponse(
                data = openapi_client.models.game_center_challenge_image.GameCenterChallengeImage(
    ...
    def testGameCenterChallengeImageResponse(self):
        """Test GameCenterChallengeImageResponse"""
