...
class TestCiMacOsVersionsResponse(unittest.TestCase):
    """CiMacOsVersionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiMacOsVersionsResponse:
        """Test CiMacOsVersionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiMacOsVersionsResponse`
        """
        model = CiMacOsVersionsResponse()
        if include_optional:
    ...
    def testCiMacOsVersionsResponse(self):
        """Test CiMacOsVersionsResponse"""
