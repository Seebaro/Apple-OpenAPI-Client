...
class TestAppCustomProductPageLocalizationsResponseIncludedInner(unittest.TestCase):
    """AppCustomProductPageLocalizationsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppCustomProductPageLocalizationsResponseIncludedInner:
        """Test AppCustomProductPageLocalizationsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppCustomProductPageLocalizationsResponseIncludedInner`
        """
        model = AppCustomProductPageLocalizationsResponseIncludedInner()
        if include_optional:
    ...
    def testAppCustomProductPageLocalizationsResponseIncludedInner(self):
        """Test AppCustomProductPageLocalizationsResponseIncludedInner"""
