...
class TestAppPreviewSetResponse(unittest.TestCase):
    """AppPreviewSetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPreviewSetResponse:
        """Test AppPreviewSetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPreviewSetResponse`
        """
        model = AppPreviewSetResponse()
        if include_optional:
            return AppPreviewSetResponse(
                data = openapi_client.models.app_preview_set.AppPreviewSet(
                    type = 'appPreviewSets', 
                    id = '', 
    ...
    def testAppPreviewSetResponse(self):
        """Test AppPreviewSetResponse"""
