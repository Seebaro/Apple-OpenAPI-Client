...
class TestAppEventScreenshotAttributes(unittest.TestCase):
    """AppEventScreenshotAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEventScreenshotAttributes:
        """Test AppEventScreenshotAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEventScreenshotAttributes`
        """
        model = AppEventScreenshotAttributes()
        if include_optional:
            return AppEventScreenshotAttributes(
                file_size = 56,
                file_name = '',
    ...
    def testAppEventScreenshotAttributes(self):
        """Test AppEventScreenshotAttributes"""
