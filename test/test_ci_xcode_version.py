...
class TestCiXcodeVersion(unittest.TestCase):
    """CiXcodeVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiXcodeVersion:
        """Test CiXcodeVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiXcodeVersion`
        """
        model = CiXcodeVersion()
        if include_optional:
            return CiXcodeVersion(
