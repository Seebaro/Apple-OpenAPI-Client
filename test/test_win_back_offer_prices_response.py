...
class TestWinBackOfferPricesResponse(unittest.TestCase):
    """WinBackOfferPricesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WinBackOfferPricesResponse:
        """Test WinBackOfferPricesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WinBackOfferPricesResponse`
        """
        model = WinBackOfferPricesResponse()
        if include_optional:
    ...
    def testWinBackOfferPricesResponse(self):
        """Test WinBackOfferPricesResponse"""
