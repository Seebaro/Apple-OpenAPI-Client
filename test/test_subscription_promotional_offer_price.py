...
class TestSubscriptionPromotionalOfferPrice(unittest.TestCase):
    """SubscriptionPromotionalOfferPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionPromotionalOfferPrice:
        """Test SubscriptionPromotionalOfferPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionPromotionalOfferPrice`
        """
        model = SubscriptionPromotionalOfferPrice()
        if include_optional:
            return SubscriptionPromotionalOfferPrice(
    ...
    def testSubscriptionPromotionalOfferPrice(self):
        """Test SubscriptionPromotionalOfferPrice"""
