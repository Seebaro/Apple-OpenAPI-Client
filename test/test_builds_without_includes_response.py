...
class TestBuildsWithoutIncludesResponse(unittest.TestCase):
    """BuildsWithoutIncludesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuildsWithoutIncludesResponse:
        """Test BuildsWithoutIncludesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildsWithoutIncludesResponse`
        """
        model = BuildsWithoutIncludesResponse()
        if include_optional:
    ...
    def testBuildsWithoutIncludesResponse(self):
        """Test BuildsWithoutIncludesResponse"""
