...
class TestSubscriptionOfferCodePriceInlineCreate(unittest.TestCase):
    """SubscriptionOfferCodePriceInlineCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionOfferCodePriceInlineCreate:
        """Test SubscriptionOfferCodePriceInlineCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionOfferCodePriceInlineCreate`
        """
        model = SubscriptionOfferCodePriceInlineCreate()
        if include_optional:
    ...
    def testSubscriptionOfferCodePriceInlineCreate(self):
        """Test SubscriptionOfferCodePriceInlineCreate"""
