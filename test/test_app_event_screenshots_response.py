...
class TestAppEventScreenshotsResponse(unittest.TestCase):
    """AppEventScreenshotsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEventScreenshotsResponse:
        """Test AppEventScreenshotsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEventScreenshotsResponse`
        """
        model = AppEventScreenshotsResponse()
        if include_optional:
            return AppEventScreenshotsResponse(
                data = [
                    openapi_client.models.app_event_screenshot.AppEventScreenshot(
    ...
    def testAppEventScreenshotsResponse(self):
        """Test AppEventScreenshotsResponse"""
