...
class TestGameCenterLeaderboardLocalizationCreateRequest(unittest.TestCase):
    """GameCenterLeaderboardLocalizationCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterLeaderboardLocalizationCreateRequest:
        """Test GameCenterLeaderboardLocalizationCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterLeaderboardLocalizationCreateRequest`
        """
        model = GameCenterLeaderboardLocalizationCreateRequest()
        if include_optional:
            return GameCenterLeaderboardLocalizationCreateRequest(
                data = openapi_client.models.game_center_leaderboard_localization_create_request_data.GameCenterLeaderboardLocalizationCreateRequest_data(
    ...
    def testGameCenterLeaderboardLocalizationCreateRequest(self):
        """Test GameCenterLeaderboardLocalizationCreateRequest"""
