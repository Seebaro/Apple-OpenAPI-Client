...
class TestAppsBetaTesterUsagesV1MetricResponseDataInner(unittest.TestCase):
    """AppsBetaTesterUsagesV1MetricResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppsBetaTesterUsagesV1MetricResponseDataInner:
        """Test AppsBetaTesterUsagesV1MetricResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppsBetaTesterUsagesV1MetricResponseDataInner`
        """
        model = AppsBetaTesterUsagesV1MetricResponseDataInner()
        if include_optional:
            return AppsBetaTesterUsagesV1MetricResponseDataInner(
    ...
    def testAppsBetaTesterUsagesV1MetricResponseDataInner(self):
        """Test AppsBetaTesterUsagesV1MetricResponseDataInner"""
