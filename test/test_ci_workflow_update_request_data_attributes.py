...
class TestCiWorkflowUpdateRequestDataAttributes(unittest.TestCase):
    """CiWorkflowUpdateRequestDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CiWorkflowUpdateRequestDataAttributes:
        """Test CiWorkflowUpdateRequestDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CiWorkflowUpdateRequestDataAttributes`
        """
        model = CiWorkflowUpdateRequestDataAttributes()
        if include_optional:
            return CiWorkflowUpdateRequestDataAttributes(
                name = '',
                description = '',
    ...
    def testCiWorkflowUpdateRequestDataAttributes(self):
        """Test CiWorkflowUpdateRequestDataAttributes"""
