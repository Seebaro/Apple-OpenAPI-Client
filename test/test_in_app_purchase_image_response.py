...
class TestInAppPurchaseImageResponse(unittest.TestCase):
    """InAppPurchaseImageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InAppPurchaseImageResponse:
        """Test InAppPurchaseImageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InAppPurchaseImageResponse`
        """
        model = InAppPurchaseImageResponse()
        if include_optional:
            return InAppPurchaseImageResponse(
                data = openapi_client.models.in_app_purchase_image.InAppPurchaseImage(
    ...
    def testInAppPurchaseImageResponse(self):
        """Test InAppPurchaseImageResponse"""
