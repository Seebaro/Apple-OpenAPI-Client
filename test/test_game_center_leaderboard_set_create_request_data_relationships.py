...
class TestGameCenterLeaderboardSetCreateRequestDataRelationships(unittest.TestCase):
    """GameCenterLeaderboardSetCreateRequestDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameCenterLeaderboardSetCreateRequestDataRelationships:
        """Test GameCenterLeaderboardSetCreateRequestDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameCenterLeaderboardSetCreateRequestDataRelationships`
        """
        model = GameCenterLeaderboardSetCreateRequestDataRelationships()
        if include_optional:
            return GameCenterLeaderboardSetCreateRequestDataRelationships(
    ...
    def testGameCenterLeaderboardSetCreateRequestDataRelationships(self):
        """Test GameCenterLeaderboardSetCreateRequestDataRelationships"""
